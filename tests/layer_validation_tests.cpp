...
void ValidOwnershipTransferOp(ErrorMonitor *monitor, VkCommandBufferObj *cb,
...
BarrierQueueFamilyBase::Context::Context(VkLayerTest *test, const std::vector<uint32_t> &queue_family_indices)
    : layer_test(test) {
