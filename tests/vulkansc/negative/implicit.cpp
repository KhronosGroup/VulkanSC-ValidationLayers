...
TEST_F(VkSCNegativeImplicit, ResetCommandPoolReleaseResourcesNotAllowed) {
    ...
    m_errorMonitor->SetDesiredError("VUID-vkResetCommandPool-flags-zerobitmask");
...
TEST_F(VkSCNegativeImplicit, PipelineCacheInitialDataSizeNotZero) {
    ...
    m_errorMonitor->SetDesiredError("VUID-VkPipelineCacheCreateInfo-initialDataSize-arraylength");
