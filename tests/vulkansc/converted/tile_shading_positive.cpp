...
TEST_F(PositiveTileShading, DISABLED_LaunchDebugMarkerOutsidePerTileExecutionModelScope) {
...
TEST_F(PositiveTileShading, DispatchReadImageBackingOfTileAttachmentAfterDrawWrite) {
    TEST_DESCRIPTION(
        "Launch a dispatch read via tile attachment api after a tile-shading draw write "
