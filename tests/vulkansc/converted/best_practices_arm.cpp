...
TEST_F(NegativeBestPracticesARM, DISABLED_TooManySamples) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_NonTransientMSImage) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_SamplerCreation) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_MultisampledBlending) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_AttachmentNeedsReadback) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_ManySmallIndexedDrawcalls) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableArmValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_SuboptimalDescriptorReuseTest) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_SparseIndexBufferTest) {
    TEST_DESCRIPTION(
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_PostTransformVertexCacheThrashingIndicesTest) {
    TEST_DESCRIPTION(
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_PresentModeTest) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_PipelineDepthBiasZeroTest) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_RobustBufferAccessTest) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_DepthPrePassUsage) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableArmValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_ComputeShaderBadWorkGroupThreadAlignmentTest) {
    TEST_DESCRIPTION(
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_ComputeShaderBadWorkGroupThreadCountTest) {
    TEST_DESCRIPTION(
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_ComputeShaderBadSpatialLocality) {
    TEST_DESCRIPTION(
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_ComputeShaderBadSpatialLocalityMultiEntrypoint) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_RedundantRenderPassStore) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_RedundantRenderPassClear) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_InefficientRenderPassClear) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_DescriptorTracking) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_BlitImageLoadOpLoad) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesARM, DISABLED_RedundantAttachment) {
