...
// Not supported in Vulkan SC: VK_KHR_get_memory_requirements2
TEST_F(NegativeYcbcr, DISABLED_BindMemoryDisjoint) {
    AddRequiredExtensions(VK_KHR_SAMPLER_YCBCR_CONVERSION_EXTENSION_NAME);
...
// Not supported in Vulkan SC: VK_KHR_get_memory_requirements2
TEST_F(NegativeYcbcr, DISABLED_BindMemoryNoDisjoint) {
    AddRequiredExtensions(VK_KHR_SAMPLER_YCBCR_CONVERSION_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_BIND_MEMORY_2_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::samplerYcbcrConversion);
...
// Not supported in Vulkan SC: VK_KHR_get_memory_requirements2
TEST_F(NegativeYcbcr, DISABLED_BindMemory2Disjoint) {
...
// Not supported in Vulkan SC: VK_KHR_get_memory_requirements2
TEST_F(NegativeYcbcr, DISABLED_BindMemory2DisjointUnsupported) {
    TEST_DESCRIPTION("These tests deal with VK_KHR_bind_memory_2 and disjoint memory being bound");
    AddRequiredExtensions(VK_KHR_SAMPLER_YCBCR_CONVERSION_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_BIND_MEMORY_2_EXTENSION_NAME);
