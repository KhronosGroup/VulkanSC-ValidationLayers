...
TEST_F(NegativeDebugPrintf, DISABLED_Float) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntUnsigned) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntUnsignedUnderflow) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntSignedOverflow) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_TwoFloats) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatPrecision) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_TextBeforeAndAfter) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntOctal) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntOctalNegative) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntNegative) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatVector2) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatVector3) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatVector4) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatVectorPrecision) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatVectorPrecisionZeroPad) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatVectorZeroPad) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatVectorScientificNotation) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntVector) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntVectorUnsigned) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntVectorHex) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_IntVectorZeroPad) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ScientificNotation) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ScientificNotationPrecision) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatShortest) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DISABLED_FloatHex) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FloatHexPrecision) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int64) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int64Vector) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int64Hex) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DISABLED_Int64VectorHexPrecision) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Float16) {
    AddRequiredExtensions(VK_KHR_SHADER_FLOAT16_INT8_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderFloat16);
    const char* shader_source = R"glsl(
        #version 450
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Float16Vector) {
    AddRequiredExtensions(VK_KHR_SHADER_FLOAT16_INT8_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderFloat16);
    const char* shader_source = R"glsl(
        #version 450
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Float16Precision) {
    AddRequiredExtensions(VK_KHR_SHADER_FLOAT16_INT8_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderFloat16);
    const char* shader_source = R"glsl(
        #version 450
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int8Hex) {
    AddRequiredExtensions(VK_KHR_SHADER_FLOAT16_INT8_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderInt8);
    const char* shader_source = R"glsl(
        #version 450
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_BoolAsHex) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_BoolVector) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_BoolNonConstant) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int32Before) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int32After) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int64Before) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int64After) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int64Signed) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Int64SignedMix) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_FunctionParam) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        int foo(int x, int y) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Pointers) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Empty) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MultipleFunctions) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Fragment) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
    InitRenderTarget();
    const char* shader_source = R"glsl(
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_HLSL) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MultiDraw) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MeshTaskShadersNV) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MeshShaders) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_TaskShaders) {
    TEST_DESCRIPTION("Test debug printf in mesh shaders.");
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_MESH_SHADER_EXTENSION_NAME);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MeshTaskIndirect) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_GPLMultiDraw) {
    AddRequiredExtensions(VK_EXT_MULTI_DRAW_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::multiDraw);
    AddRequiredFeature(vkt::Feature::graphicsPipelineLibrary);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_GPLInt64) {
    AddRequiredExtensions(VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::graphicsPipelineLibrary);
    AddRequiredFeature(vkt::Feature::shaderInt64);
    RETURN_IF_SKIP(InitDebugPrintfFramework());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ShaderObjectsGraphics) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ShaderObjects) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ShaderObjectsInt64) {
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderObject);
    AddRequiredFeature(vkt::Feature::shaderInt64);
    RETURN_IF_SKIP(InitDebugPrintfFramework());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ShaderObjectsMultiDraw) {
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_DYNAMIC_RENDERING_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_MULTI_DRAW_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderObject);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_VertexFragmentSeparateShader) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
    InitRenderTarget();
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ShaderObjectFragment) {
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_DYNAMIC_RENDERING_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::dynamicRendering);
    AddRequiredFeature(vkt::Feature::shaderObject);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ShaderObjectCompute) {
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderObject);
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_SetupErrorVersion) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_LocalSizeId) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredFeature(vkt::Feature::maintenance4);
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_UseAllDescriptorSlotsPipelineReserved) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_UseAllDescriptorSlotsPipelineNotReserved) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_UseAllDescriptorSlotsPipelineGraphics) {
    TEST_DESCRIPTION("Do not reserve a descriptor slot and proceed to use them all anyway so debug printf can't");
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
    InitRenderTarget();
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_UseAllDescriptorSlotsPipelineGPL) {
    TEST_DESCRIPTION("Do not reserve a descriptor slot and proceed to use them all anyway so debug printf can't");
    AddRequiredExtensions(VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::graphicsPipelineLibrary);
    RETURN_IF_SKIP(InitDebugPrintfFramework());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ShaderObjectBoundDescriptor) {
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderObject);
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ShaderObjectUnusedBoundDescriptor) {
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderObject);
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_OverflowBuffer) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_OverflowBufferLoop) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNoVectorSize) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedLargeVectorSize) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedSmallVectorSize) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNoSpecifier1) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNoSpecifier2) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedUnknown1) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedUnknown2) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedUnknown3) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedExtraArguments) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNoModifiers) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedIsloatedPercent) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNotEnoughArguments) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNoArguments) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNotVectorArg) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNotVectorParam) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedVectorSmall) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedVectorLarge) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedFloat1) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedFloat2) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedFloatVector1) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedFloatVector2) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Misformatted64Int1) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Misformatted64Int2) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Misformatted64IntVector1) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Misformatted64IntVector2) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_Misformatted64Bool) {
    AddRequiredFeature(vkt::Feature::shaderInt64);
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedEmptyString) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNewLine) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedVectorNewLine) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        void main() {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedPointer) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        #extension GL_EXT_buffer_reference : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MisformattedNotPointer) {
    const char* shader_source = R"glsl(
        #version 450
        #extension GL_EXT_debug_printf : enable
        #extension GL_ARB_gpu_shader_int64 : enable
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_ValidationAbort) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DualPipelines) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DualCommandBufferHalfPrint) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DualCommandBufferBothPrint) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DualCommandBufferEmpty) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DispatchIndirect) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DispatchBase) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DrawIndexed) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
    InitRenderTarget();
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DrawIndexedIndirect) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
    InitRenderTarget();
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DrawIndirectCount) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DrawIndexedIndirectCount) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredFeature(vkt::Feature::drawIndirectCount);
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DeviceGeneratedCommandsCompute) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DeviceGeneratedCommandsGraphics) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_EXT_DEVICE_GENERATED_COMMANDS_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::deviceGeneratedCommands);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DISABLED_DeviceGeneratedCommandsIES) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_EXT_DEVICE_GENERATED_COMMANDS_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::deviceGeneratedCommands);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MultipleComputePasses) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_SpecConstant) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_InlineUniformBlock) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_StorageBufferLength) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_StorageBufferLengthUpdateAfterBind) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_SCALAR_BLOCK_LAYOUT_EXTENSION_NAME);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_PushDescriptor) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorTemplates) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_PushDescriptorTemplates) {
    AddRequiredExtensions(VK_KHR_PUSH_DESCRIPTOR_EXTENSION_NAME);
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DuplicateMessageLimit) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DuplicateMessageLimitExplicit) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorBuffer) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorBufferGPL) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::graphicsPipelineLibrary);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorBufferShaderObject) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderObject);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorBufferPushConstantOnly) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorBuffer);
    AddRequiredFeature(vkt::Feature::bufferDeviceAddress);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_NoPipelineLayout) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderObject);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorBufferMixClassic) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorBuffer);
    AddRequiredFeature(vkt::Feature::bufferDeviceAddress);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorBufferMultipleCommandBuffers) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorBuffer);
    AddRequiredFeature(vkt::Feature::bufferDeviceAddress);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DrawMeshTasksIndirectCountEXT) {
    TEST_DESCRIPTION("Test debug printf in mesh shaders.");
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_MESH_SHADER_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_DYNAMIC_RENDERING_EXTENSION_NAME);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DisableShaderValidation) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_KHR_SHADER_NON_SEMANTIC_INFO_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::fragmentStoresAndAtomics);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DisableShaderValidationShaderObject) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_KHR_SHADER_NON_SEMANTIC_INFO_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::shaderObject);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_MidCommandBuffer) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_SecondaryCommandBuffer) {
    RETURN_IF_SKIP(InitDebugPrintfFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorHeap) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorHeapGraphics) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
    AddRequiredFeature(vkt::Feature::bufferDeviceAddress);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorHeapUntypedPointers) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorHeapGPL) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorHeapShaderObjects) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorHeapPushConstantOnly) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
    AddRequiredFeature(vkt::Feature::bufferDeviceAddress);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DeviceLocalHeap) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
    AddRequiredFeature(vkt::Feature::bufferDeviceAddress);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DeviceLocalHeapGraphics) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
    AddRequiredFeature(vkt::Feature::bufferDeviceAddress);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DeviceLocalHeapMesh) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_MESH_SHADER_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_DescriptorHeapRebindHeap) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
    AddRequiredFeature(vkt::Feature::bufferDeviceAddress);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_CoopMat2PerElementOp) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_CoopMat2Reduce) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_CoopMat2LoadTensorDecode) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeDebugPrintf, DISABLED_CoopMat2LoadTensorDecodeWithView) {
