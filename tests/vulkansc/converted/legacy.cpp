...
TEST_F(NegativeLegacy, DISABLED_RenderPass2Extension) {
...
// Not supported in Vulkan SC: legacy/deprecation messages
TEST_F(NegativeLegacy, DISABLED_MultipleDifferentWarnings) {
    AddRequiredExtensions(VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME);
...
// Not supported in Vulkan SC: legacy/deprecation messages
TEST_F(NegativeLegacy, DISABLED_GetPhysicalDeviceProperties2Extension) {
...
// Not supported in Vulkan SC: legacy/deprecation messages
TEST_F(NegativeLegacy, DISABLED_GetPhysicalDeviceProperties2Version) {
...
// Not supported in Vulkan SC: legacy/deprecation messages
TEST_F(NegativeLegacy, DISABLED_UseDeprecatedInstanceExtensions) {
...
// Not supported in Vulkan SC: legacy/deprecation messages
TEST_F(NegativeLegacy, DISABLED_UseDeprecatedDeviceExtensions) {
...
// Not supported in Vulkan SC: legacy/deprecation messages
TEST_F(NegativeLegacy, DISABLED_LoadDeprecatedExtension) {
