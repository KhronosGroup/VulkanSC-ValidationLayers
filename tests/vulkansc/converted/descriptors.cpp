...
TEST_F(NegativeDescriptors, DISABLED_DescriptorIndexingSetLayoutWithoutExtension) {
...
TEST_F(NegativeDescriptors, DISABLED_ImageSubresourceOverlapBetweenAttachmentsAndDescriptorSets) {
    ...
    m_errorMonitor->SetDesiredFailureMsg(kErrorBit, "VUID-vkCmdDraw-None-08753");
