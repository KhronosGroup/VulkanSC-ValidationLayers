...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_CombinedShaderSubsets) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_MultipleIndependentSetsUsed) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_FSIgnoredPointerGPLDynamicRendering2) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_MultisampleStateSampleMaskArray) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_VertexInputIgnoreVertexInputState) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_VertexInputIgnoreAllState) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_RasterizerDiscardEnable) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_LegacyDitheringEnable) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_LinkWithNonIndependent) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_LinkWithIndependent) {
    TEST_DESCRIPTION("https://github.com/KhronosGroup/Vulkan-ValidationLayers/issues/9870");
    RETURN_IF_SKIP(InitBasicGraphicsLibrary());
    InitRenderTarget();
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_DestroyImmutableSampler) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_Mesh) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_CustomResolve) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_DescriptorHeapSetLayoutCount) {
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_DescriptorHeapSetLayoutCountLinking) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
    RETURN_IF_SKIP(InitBasicGraphicsLibrary());
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_DescriptorHeapPushConstantStages) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
    RETURN_IF_SKIP(InitBasicGraphicsLibrary());
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_DescriptorHeapUnusedPipelineLayouts) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME);
    AddRequiredFeature(vkt::Feature::descriptorHeap);
    RETURN_IF_SKIP(InitBasicGraphicsLibrary());
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_MultiViewDraw) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
...
// Not supported in Vulkan SC: VK_EXT_graphics_pipeline_library
TEST_F(PositiveGraphicsLibrary, DISABLED_MultiViewDraw2) {
