...
TEST_F(PositiveGpuAVShaderObject, DISABLED_RestoreUserPushConstants) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(PositiveGpuAVShaderObject, DISABLED_RestoreUserPushConstants2) {
    TEST_DESCRIPTION(
...
// Not supported in Vulkan SC: GPU AV
TEST_F(PositiveGpuAVShaderObject, DISABLED_DispatchShaderObjectAndPipeline) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(PositiveGpuAVShaderObject, DISABLED_GetShaderBinaryDataSimple) {
    InitBasicShaderObject();
    RETURN_IF_SKIP(InitGpuAvFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(PositiveGpuAVShaderObject, DISABLED_GetShaderBinaryData) {
    InitBasicShaderObject();
    RETURN_IF_SKIP(InitGpuAvFramework());
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: GPU AV
TEST_F(PositiveGpuAVShaderObject, DISABLED_BinaryShaderObjects) {
    InitBasicShaderObject();
    RETURN_IF_SKIP(InitGpuAvFramework());
    RETURN_IF_SKIP(InitState());
    InitDynamicRenderTarget();
