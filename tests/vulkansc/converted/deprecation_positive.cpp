...
TEST_F(PositiveDeprecation, DISABLED_SettingExplicitOff) {
...
// Not supported in Vulkan SC: deprecation messages
TEST_F(PositiveDeprecation, DISABLED_SettingDefault) {
...
// Not supported in Vulkan SC: deprecation messages
TEST_F(PositiveDeprecation, DISABLED_MuteMultipleWarnings) {
...
// Not supported in Vulkan SC: deprecation messages
TEST_F(PositiveDeprecation, DISABLED_GetPhysicalDeviceProperties2Extension) {
