...
TEST_F(PositiveLegacy, DISABLED_SettingExplicitOff) {
...
// Not supported in Vulkan SC: legacy/deprecation messages
TEST_F(PositiveLegacy, DISABLED_SettingDefault) {
...
// Not supported in Vulkan SC: legacy/deprecation messages
TEST_F(PositiveLegacy, DISABLED_GetPhysicalDeviceProperties2Extension) {
