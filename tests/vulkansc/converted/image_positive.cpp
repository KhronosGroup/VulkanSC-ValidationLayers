...
TEST_F(PositiveImage, ImageBlockMatchInstruction) {
    TEST_DESCRIPTION(
        "Launch a compute pass with an OpImageBlockMatchSADQCOM instruction and "
...
TEST_F(PositiveImage, ImageBlockMatchWindowWithClampToEdge) {
    TEST_DESCRIPTION(
        "Launch OpImageBlockMatchWindow*QCOM with both addressModeU and addressModeV set to "
...
TEST_F(PositiveImage, ImageBlockMatchWindowInstruction) {
    TEST_DESCRIPTION(
        "Launch a compute pass with an opImageBlockMatchWindowSSDQCOM instruction and "
