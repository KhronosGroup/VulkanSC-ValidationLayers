...
// Not supported in Vulkan SC: deprecation messages
TEST_F(NegativeDeprecation, DISABLED_RenderPass2Extension) {
...
// Not supported in Vulkan SC: deprecation messages
TEST_F(NegativeDeprecation, DISABLED_MultipleDifferentWarnings) {
    AddRequiredExtensions(VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME);
...
// Not supported in Vulkan SC: deprecation messages
TEST_F(NegativeDeprecation, DISABLED_MuteSingleWarning) {
...
// Not supported in Vulkan SC: deprecation messages
TEST_F(NegativeDeprecation, DISABLED_GetPhysicalDeviceProperties2Extension) {
...
// Not supported in Vulkan SC: deprecation messages
TEST_F(NegativeDeprecation, DISABLED_GetPhysicalDeviceProperties2Version) {
