...
TEST_F(NegativeSparseImage, DISABLED_ResidencyImageCreateUnsupportedTypes) {
    ...
    image_create_info.format = VK_FORMAT_R8G8B8A8_UNORM;
    image_create_info.extent = {512, 1, 1};
    image_create_info.mipLevels = 1;
    image_create_info.arrayLayers = 1;
    image_create_info.samples = VK_SAMPLE_COUNT_1_BIT;
    image_create_info.tiling = VK_IMAGE_TILING_OPTIMAL;
...
// Not supported in Vulkan SC: sparse resources
TEST_F(NegativeSparseImage, DISABLED_ImageMemoryBindInvalidMemory) {
    TEST_DESCRIPTION("Try to bind sparse resident image with invalid VkSparseImageMemoryBind");
...
// Not supported in Vulkan SC: sparse resources
TEST_F(NegativeSparseImage, DISABLED_ImageMemoryBindInvalidAlignment) {
    TEST_DESCRIPTION("Try to bind sparse resident image with invalid VkSparseImageMemoryBind");
...
// Not supported in Vulkan SC: sparse resources
TEST_F(NegativeSparseImage, DISABLED_UnalignedBindOffsets) {
