...
// Not supported in Vulkan SC: assumes availability of pre-Vulkan 1.2 functionality, although it's only due to incorrect spec
TEST_F(NegativeShaderLimits, DISABLED_MaxFragmentCombinedOutputResources) {
    RETURN_IF_SKIP(Init());
