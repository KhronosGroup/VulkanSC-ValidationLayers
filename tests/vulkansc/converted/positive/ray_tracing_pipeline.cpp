...
TEST_F(VkCompatiblePositiveLayerTest, RayTracingPipelineShaderGroupsKHR) {
...
TEST_F(VkCompatiblePositiveLayerTest, RayTracingPipelineCacheControl) {
...
TEST_F(VkCompatiblePositiveLayerTest, NVRayTracingPipeline) {
