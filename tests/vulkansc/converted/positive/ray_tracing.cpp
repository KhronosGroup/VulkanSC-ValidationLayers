...
TEST_F(VkCompatiblePositiveLayerTest, RayTracingValidateGetAccelerationStructureBuildSizes) {
...
TEST_F(VkCompatiblePositiveLayerTest, RayTracingAccelerationStructureReference) {
...
TEST_F(VkCompatiblePositiveLayerTest, RayTracingHostAccelerationStructureReference) {
    TEST_DESCRIPTION("Test host side accelerationStructureReference");
