...
TEST_F(VkCompatiblePositiveLayerTest, AndroidHardwareBufferMemoryRequirements) {
...
TEST_F(VkCompatiblePositiveLayerTest, AndroidHardwareBufferDepthStencil) {
...
TEST_F(VkCompatiblePositiveLayerTest, AndroidHardwareBufferBindBufferMemory) {
...
TEST_F(VkCompatiblePositiveLayerTest, AndroidHardwareBufferExportBuffer) {
...
TEST_F(VkCompatiblePositiveLayerTest, AndroidHardwareBufferExportImage) {
...
TEST_F(VkCompatiblePositiveLayerTest, AndroidHardwareBufferExternalImage) {
...
TEST_F(VkCompatiblePositiveLayerTest, AndroidHardwareBufferExternalCameraFormat) {
    TEST_DESCRIPTION("Verify AndroidHardwareBuffer can import AHB with external format");
