...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingDraw) {
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingDrawMultiBind) {
...
TEST_F(VkCompatiblePositiveLayerTest, TestBeginQueryInDynamicRendering) {
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingPipeWithDiscard) {
...
TEST_F(VkCompatiblePositiveLayerTest, UseStencilAttachmentWithIntegerFormatAndDepthStencilResolve) {
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingFragmentDensityMapSubsampledBit) {
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingSuspendResumeDraw) {
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingCreateGraphicsPipeline) {
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingCreateGraphicsPipelineNoInfo) {
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingWithDualSourceBlending) {
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingSuspendPrimaryResumeInSecondary) {
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicRenderingSuspendSecondaryResumeInPrimary) {
