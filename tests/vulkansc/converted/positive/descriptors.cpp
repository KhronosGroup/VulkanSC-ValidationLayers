...
TEST_F(VkCompatiblePositiveLayerTest, CopyNonupdatedDescriptors) {
...
TEST_F(VkCompatiblePositiveLayerTest, DeleteDescriptorSetLayoutsBeforeDescriptorSets) {
...
TEST_F(VkCompatiblePositiveLayerTest, IgnoreUnrelatedDescriptor) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatiblePositiveLayerTest, ImmutableSamplerOnlyDescriptor) {
...
// This is a positive test. No failures are expected.
TEST_F(VkCompatiblePositiveLayerTest, EmptyDescriptorUpdateTest) {
...
// This is a positive test. No failures are expected.
TEST_F(VkCompatiblePositiveLayerTest, PushDescriptorNullDstSetTest) {
...
// This is a positive test. No failures are expected.
TEST_F(VkCompatiblePositiveLayerTest, PushDescriptorUnboundSetTest) {
...
// This is a positive test. No failures are expected.
TEST_F(VkCompatiblePositiveLayerTest, BindingPartiallyBound) {
...
TEST_F(VkCompatiblePositiveLayerTest, PushDescriptorSetUpdatingSetNumber) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatiblePositiveLayerTest, DynamicOffsetWithInactiveBinding) {
...
TEST_F(VkCompatiblePositiveLayerTest, CreateDescriptorSetBindingWithIgnoredSamplers) {
...
TEST_F(VkCompatiblePositiveLayerTest, PushingDescriptorSetWithImmutableSampler) {
...
TEST_F(VkCompatiblePositiveLayerTest, BindVertexBuffers2EXTNullDescriptors) {
...
TEST_F(VkCompatiblePositiveLayerTest, CopyMutableDescriptors) {
...
TEST_F(VkCompatiblePositiveLayerTest, TestImageViewAsDescriptorReadAndInputAttachment) {
...
TEST_F(VkCompatiblePositiveLayerTest, UpdateImageDescriptorSetThatHasImageViewUsage) {
...
TEST_F(VkCompatiblePositiveLayerTest, MultipleThreadsUsingHostOnlyDescriptorSet) {
...
TEST_F(VkCompatiblePositiveLayerTest, BindingEmptyDescriptorSets) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatiblePositiveLayerTest, DrawingWithUnboundUnusedSetWithInputAttachments) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatiblePositiveLayerTest, UpdateDescritorSetsNoLongerInUse) {
