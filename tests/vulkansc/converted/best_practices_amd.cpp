...
TEST_F(NegativeBestPracticesAMD, DISABLED_TooManyPipelines) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_UseMutableRT) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_UsageConcurentRT) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_UsageStorageRT) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_PrimitiveRestart) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
    InitRenderTarget();
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_NumDynamicStates) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
    InitRenderTarget();
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_KeepLayoutSmall) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_CopyingDescriptors) {
    // TODO: add dynamic buffer check as well
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_ClearImage) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_ImageToImageCopy) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_GeneralLayout) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_RobustAccessOn) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_Barriers) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_NumberOfSubmissions) {
    AddSurfaceExtension();
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_NumSyncPrimitives) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_SecondaryCmdBuffer) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableAMDValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_ComputeWorkgroupSize) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesAMD, DISABLED_ComputeWorkgroupSizeMaintenance5) {
