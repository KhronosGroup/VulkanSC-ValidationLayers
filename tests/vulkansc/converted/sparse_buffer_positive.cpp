...
// Not supported in Vulkan SC: sparse resources
TEST_F(PositiveSparseBuffer, DISABLED_NonOverlappingBufferCopy5) {
...
// Not supported in Vulkan SC: sparse resources
TEST_F(PositiveSparseBuffer, DISABLED_BufferCopiesValidationStressTest) {
...
// Not supported in Vulkan SC: sparse resources
TEST_F(PositiveSparseBuffer, DISABLED_BufferCopiesValidationStressTest2) {
