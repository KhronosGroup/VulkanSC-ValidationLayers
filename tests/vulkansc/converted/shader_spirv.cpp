...
TEST_F(NegativeShaderSpirv, SpecializationSizeZero) {
    ...
    CreateComputePipelineHelper pipe(*this);
    pipe.cs_ = VkShaderObj(this, cs_src, VK_SHADER_STAGE_COMPUTE_BIT, SPV_ENV_VULKAN_1_0, SPV_SOURCE_GLSL, &specialization_info);
...
// Not supported in Vulkan SC: shader module
TEST_F(NegativeShaderSpirv, DISABLED_NullShaderModuleCreateInfo) {
    RETURN_IF_SKIP(Init());
    VkShaderModule module;
