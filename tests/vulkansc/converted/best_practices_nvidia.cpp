...
TEST_F(NegativeBestPracticesNV, DISABLED_PageableDeviceLocalMemory) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_TilingLinear) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_Depth32Format) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_QueueBindSparse_NotAsync) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_AccelerationStructure_NotAsync) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_AllocateMemory_SetPriority) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_AllocateMemory_ReuseAllocations) {
    AddRequiredExtensions(VK_EXT_MEMORY_PRIORITY_EXTENSION_NAME);
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_BindMemory_NoPriority) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_EXT_PAGEABLE_DEVICE_LOCAL_MEMORY_EXTENSION_NAME);
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_BindMemory_StaticPriority) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_EXT_PAGEABLE_DEVICE_LOCAL_MEMORY_EXTENSION_NAME);
    AddRequiredExtensions(VK_KHR_MAINTENANCE_4_EXTENSION_NAME);
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_CreatePipelineLayout_SeparateSampler) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_CreatePipelineLayout_LargePipelineLayout) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_BindPipelineSwitchTessGeometryMesh) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_BindPipelineZcullDirection) {
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_BindPipelineZcullDirectionDepth) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredFeature(vkt::Feature::dynamicRendering);
    AddRequiredFeature(vkt::Feature::synchronization2);
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_BindPipelineZcullDirectionSubresource) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredFeature(vkt::Feature::dynamicRendering);
    AddRequiredFeature(vkt::Feature::synchronization2);
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_ClearColorNotCompressed) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    AddRequiredFeature(vkt::Feature::dynamicRendering);
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
    RETURN_IF_SKIP(InitState());
...
// Not supported in Vulkan SC: best practices layers
TEST_F(NegativeBestPracticesNV, DISABLED_BeginCommandBuffer_OneTimeSubmit) {
    RETURN_IF_SKIP(InitBestPracticesFramework(kEnableNVIDIAValidation));
    RETURN_IF_SKIP(InitState());
