...
TEST_F(PositiveGpuAssistedLayer, DISABLED_SetSSBOBindDescriptor) {
...
TEST_F(PositiveGpuAssistedLayer, DISABLED_SetSSBOPushDescriptor) {
...
TEST_F(PositiveGpuAssistedLayer, DISABLED_GpuBufferDeviceAddress) {
...
TEST_F(PositiveGpuAssistedLayer, DISABLED_GetCounterFromSignaledSemaphoreAfterSubmit) {
...
TEST_F(PositiveGpuAssistedLayer, DISABLED_MutableBuffer) {
    TEST_DESCRIPTION("Makes sure we can use vkCmdBindDescriptorSets()");
...
TEST_F(PositiveGpuAssistedLayer, DISABLED_MaxDescriptorsClamp) {
...
TEST_F(PositiveGpuAssistedLayer, DISABLED_MaxDescriptorsClamp13) {
    TEST_DESCRIPTION("Make sure maxUpdateAfterBindDescriptorsInAllPools is clamped");
    SetTargetApiVersion(VK_API_VERSION_1_3);
    RETURN_IF_SKIP(InitGpuAvFramework());
    RETURN_IF_SKIP(InitState());
...
TEST_F(PositiveGpuAssistedLayer, DISABLED_GpuValidationUnInitImage) {
...
TEST_F(PositiveGpuAssistedLayer, DISABLED_SelectInstrumentedShaders) {
...
TEST_F(PositiveGpuAssistedLayer, DISABLED_BindingPartiallyBound) {
