...
TEST_F(VkCompatibleLayerTest, RayTracingPipelineCreateInfoKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingPipelineShaderGroupsKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingLibraryFlags) {
...
TEST_F(VkCompatibleLayerTest, RayTracingValidateGetCaptureReplayShaderGroupHandlesKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingPipelineDeferredOp) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, RayTracingPipelineWrongBindPoint) {
...
TEST_F(VkCompatibleLayerTest, RayTracingPipelineMaxResources) {
...
TEST_F(VkCompatibleLayerTest, RayTracingInvalidPipelineFlags) {
...
TEST_F(VkCompatibleLayerTest, RayTracingTestWrongPipelineType) {
...
TEST_F(VkCompatibleLayerTest, RayTracingPipelineLibraryGroupHandlesEXT) {
...
TEST_F(VkCompatibleLayerTest, NVRayTracingValidatePipeline) {
...
TEST_F(VkCompatibleLayerTest, NVRayTracingPipelineShaderGroups) {
    TEST_DESCRIPTION("Validate shader groups during ray-tracing pipeline creation");
...
TEST_F(VkCompatibleLayerTest, NVRayTracingPipelineStageCreationFeedbackCount) {
...
TEST_F(VkCompatibleLayerTest, NVRayTracingMissingEntrypoint) {
