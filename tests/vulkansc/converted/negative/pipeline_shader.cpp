...
#include "../../framework/vksc_compatible_layer_validation_tests.h"
...
TEST_F(VkCompatibleLayerTest, PSOPolygonModeInvalid) {
...
TEST_F(VkCompatibleLayerTest, PipelineNotBound) {
...
TEST_F(VkCompatibleLayerTest, PipelineWrongBindPointGraphics) {
...
TEST_F(VkCompatibleLayerTest, PipelineBasicCompute) {
...
TEST_F(VkCompatibleLayerTest, PipelineWrongBindPointCompute) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineBadVertexAttributeFormat) {
...
TEST_F(VkCompatibleLayerTest, DisabledIndependentBlend) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, BlendingOnFormatWithoutBlendingSupport) {
...
TEST_F(VkCompatibleLayerTest, PipelineRenderpassCompatibility) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_PointSizeFailure) {
...
TEST_F(VkCompatibleLayerTest, InvalidTopology) {
...
TEST_F(VkCompatibleLayerTest, PrimitiveTopologyListRestart) {
...
TEST_F(VkLayerTest, DISABLED_PointSizeGeomShaderDontWrite) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_PointSizeGeomShaderWrite) {
    TEST_DESCRIPTION(
        "Create a pipeline using TOPOLOGY_POINT_LIST, set PointSize vertex shader, but not in the final geometry stage.");
...
TEST_F(VkLayerTest, DISABLED_BuiltinBlockOrderMismatchVsGs) {
...
TEST_F(VkLayerTest, DISABLED_BuiltinBlockSizeMismatchVsGs) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineLayoutExceedsSetLimit) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineExcessSubsampledPerStageDescriptors) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineLayoutExcessPerStageDescriptors) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineLayoutExcessDescriptorsOverall) {
...
TEST_F(VkCompatibleLayerTest, InvalidCmdBufferPipelineDestroyed) {
...
TEST_F(VkCompatibleLayerTest, InvalidPipeline) {
...
TEST_F(VkCompatibleLayerTest, CmdDispatchExceedLimits) {
...
TEST_F(VkCompatibleLayerTest, InvalidPipelineCreateState) {
...
TEST_F(VkCompatibleLayerTest, InvalidPipelineCreateStateBadStageBit) {
    TEST_DESCRIPTION("Create Pipelines with invalid state set");
...
TEST_F(VkLayerTest, DISABLED_DispatchWithUnboundSet) {
...
TEST_F(VkLayerTest, DISABLED_MissingStorageImageFormatRead) {
...
TEST_F(VkLayerTest, DISABLED_MissingStorageImageFormatWrite) {
...
TEST_F(VkCompatibleLayerTest, MissingStorageImageFormatReadForFormat) {
    TEST_DESCRIPTION("Create a shader reading a storage image without an image format");
...
TEST_F(VkCompatibleLayerTest, MissingStorageImageFormatWriteForFormat) {
    TEST_DESCRIPTION("Create a shader writing a storage image without an image format");
...
TEST_F(VkCompatibleLayerTest, MissingStorageTexelBufferFormatWriteForFormat) {
...
TEST_F(VkLayerTest, DISABLED_MissingNonReadableDecorationStorageImageFormatRead) {
...
TEST_F(VkLayerTest, DISABLED_MissingNonWritableDecorationStorageImageFormatWrite) {
...
TEST_F(VkLayerTest, DISABLED_SubpassInputWithoutFormat) {
...
TEST_F(VkCompatibleLayerTest, MissingSampledImageDepthComparisonForFormat) {
...
TEST_F(VkCompatibleLayerTest, InvalidPipelineSampleRateFeatureDisable) {
...
TEST_F(VkCompatibleLayerTest, InvalidPipelineSampleRateFeatureEnable) {
    // Enable sample shading in pipeline when the feature is disabled.
    ASSERT_NO_FATAL_FAILURE(InitFramework(m_errorMonitor));
...
TEST_F(VkCompatibleLayerTest, InvalidPipelineDepthClipControlFeatureDisable) {
...
TEST_F(VkCompatibleLayerTest, InvalidPipelineSamplePNext) {
    // Enable sample shading in pipeline when the feature is disabled.
    AddRequiredExtensions(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME);
...
TEST_F(VkCompatibleLayerTest, InvalidSubpassRasterizationSamples) {
...
TEST_F(VkCompatibleLayerTest, InvalidPipelineRenderPassShaderResolveQCOM) {
...
TEST_F(VkLayerTest, DISABLED_CreateGraphicsPipelineWithBadBasePointer) {
...
TEST_F(VkCompatibleLayerTest, SetDepthRangeUnrestricted) {
...
TEST_F(VkCompatibleLayerTest, VertexAttributeDivisorExtension) {
...
TEST_F(VkCompatibleLayerTest, VertexAttributeDivisorDisabled) {
...
TEST_F(VkCompatibleLayerTest, VertexAttributeDivisorInstanceRateZero) {
...
TEST_F(VkCompatibleLayerTest, InvalidPatchControlPoints)
{
    // Attempt to Create Gfx Pipeline w/o a VS
    VkResult        err;
...
TEST_F(VkCompatibleLayerTest, PSOViewportStateTests) {
...
TEST_F(VkCompatibleLayerTest, ExtensionDynamicStatesSetWOExtensionEnabled) {
...
TEST_F(VkCompatibleLayerTest, PSOViewportStateMultiViewportTests) {
...
TEST_F(VkCompatibleLayerTest, DynamicViewportAndScissorUndefinedDrawState) {
...
TEST_F(VkCompatibleLayerTest, PSOLineWidthInvalid) {
...
TEST_F(VkCompatibleLayerTest, PipelineCreationCacheControl) {
...
TEST_F(VkCompatibleLayerTest, VUID_VkVertexInputBindingDescription_binding_00618) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, VUID_VkVertexInputBindingDescription_stride_00619) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, VUID_VkVertexInputAttributeDescription_location_00620) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, VUID_VkVertexInputAttributeDescription_binding_00621) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, VertexInputAttributeDescriptionOffset) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, NumSamplesMismatch) {
...
TEST_F(VkCompatibleLayerTest, NumBlendAttachMismatch) {
...
TEST_F(VkCompatibleLayerTest, CmdClearAttachmentTests) {
...
TEST_F(VkCompatibleLayerTest, InvalidVertexBindingDescriptions) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, InvalidVertexAttributeDescriptions) {
    TEST_DESCRIPTION(
        "Attempt to create a graphics pipeline where:"
...
TEST_F(VkCompatibleLayerTest, ColorBlendInvalidLogicOp) {
...
TEST_F(VkCompatibleLayerTest, ColorBlendUnsupportedLogicOp) {
...
TEST_F(VkCompatibleLayerTest, ColorBlendUnsupportedDualSourceBlend) {
...
TEST_F(VkLayerTest, DISABLED_InvalidSPIRVCodeSize) {
...
TEST_F(VkLayerTest, DISABLED_InvalidSPIRVMagic) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineVertexOutputNotConsumed) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineCheckShaderSpecializationApplied) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineCheckShaderBadSpecializationOffsetOutOfBounds) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineCheckShaderBadSpecializationSizeOutOfBounds) {
    TEST_DESCRIPTION("Challenge core_validation with shader validation issues related to vkCreateGraphicsPipelines.");
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineCheckShaderDescriptorTypeMismatch) {
    TEST_DESCRIPTION("Challenge core_validation with shader validation issues related to vkCreateGraphicsPipelines.");
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineCheckShaderDescriptorNotAccessible) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineCheckShaderPushConstantNotDeclared) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, InvalidPushConstantRange) {
...
TEST_F(VkCompatibleLayerTest, InvalidCmdPushConstantRange) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineCheckShaderNotEnabled) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreateShaderModuleCheckBadCapability) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineFragmentInputNotProvided) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineFragmentInputNotProvidedInBlock) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineVsFsTypeMismatch) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineVsFsTypeMismatchInBlock) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineVsFsMismatchByLocation) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineVsFsMismatchByComponent) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineAttribNotConsumed) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineAttribLocationMismatch) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineAttribNotProvided) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineAttribTypeMismatch) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, CreatePipelineDuplicateStage) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineMissingEntrypoint) {
    ASSERT_NO_FATAL_FAILURE(Init());
    ASSERT_NO_FATAL_FAILURE(InitRenderTarget());
...
TEST_F(VkCompatibleLayerTest, CreatePipelineDepthStencilRequired) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineTessPatchDecorationMismatch) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, CreatePipelineTessErrors) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineAttribBindingConflict) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineFragmentOutputNotWritten) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineFragmentOutputNotConsumed) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineFragmentOutputTypeMismatch) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, CreatePipelineExceedVertexMaxComponentsWithBuiltins) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineExceedFragmentMaxComponentsWithBuiltins) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineExceedMaxVertexOutputComponents) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineExceedMaxComponentsBlocks) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineExceedMaxTessellationControlInputOutputComponents) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineExceedMaxTessellationEvaluationInputOutputComponents) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineExceedMaxGeometryInputOutputComponents) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineExceedMaxFragmentInputComponents) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineExceedMaxGeometryInstanceVertexCount) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineUniformBlockNotProvided) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, CreatePipelineNullStagepName) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelinePushConstantsNotInLayout) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineInputAttachmentMissing) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineInputAttachmentMissingArray) {
    TEST_DESCRIPTION(
        "Test that an error is produced for a shader consuming an input attachment which is not included in the subpass "
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineInputAttachmentSharingVariable) {
...
TEST_F(VkLayerTest, DISABLED_CreateComputePipelineMissingDescriptor) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreateComputePipelineDescriptorTypeMismatch) {
...
TEST_F(VkCompatibleLayerTest, MultiplePushDescriptorSets) {
...
TEST_F(VkCompatibleLayerTest, AMDMixedAttachmentSamplesValidateGraphicsPipeline) {
...
TEST_F(VkCompatibleLayerTest, FramebufferMixedSamplesNV) {
...
TEST_F(VkCompatibleLayerTest, FramebufferMixedSamples) {
...
TEST_F(VkCompatibleLayerTest, FramebufferMixedSamplesCoverageReduction) {
...
TEST_F(VkCompatibleLayerTest, FragmentCoverageToColorNV) {
...
TEST_F(VkCompatibleLayerTest, ViewportSwizzleNV) {
...
TEST_F(VkCompatibleLayerTest, CooperativeMatrixNV) {
...
TEST_F(VkLayerTest, DISABLED_SubgroupSupportedProperties) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, SubgroupRequired) {
...
TEST_F(VkCompatibleLayerTest, SubgroupExtendedTypesEnabled) {
...
TEST_F(VkCompatibleLayerTest, SubgroupExtendedTypesDisabled) {
    TEST_DESCRIPTION("Test VK_KHR_shader_subgroup_extended_types.");
    SetTargetApiVersion(VK_API_VERSION_1_1);
...
TEST_F(VkCompatibleLayerTest, NonSemanticInfoEnabled) {
...
TEST_F(VkCompatibleLayerTest, GraphicsPipelineStageCreationFeedbackCount) {
...
TEST_F(VkCompatibleLayerTest, ComputePipelineStageCreationFeedbackCount) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineCheckShaderImageFootprintEnabled) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineCheckFragmentShaderBarycentricEnabled) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineCheckComputeShaderDerivativesEnabled) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineCheckFragmentShaderInterlockEnabled) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineCheckDemoteToHelperInvocation) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineCheckLineRasterization) {
...
TEST_F(VkCompatibleLayerTest, FillRectangleNV) {
...
TEST_F(VkLayerTest, DISABLED_NotCompatibleForSet) {
...
TEST_F(VkCompatibleLayerTest, PipelineStageConditionalRenderingWithWrongQueue) {
...
TEST_F(VkLayerTest, DISABLED_CreatePipelineDynamicUniformIndex) {
...
TEST_F(VkLayerTest, DISABLED_VertexStoresAndAtomicsFeatureDisable) {
...
TEST_F(VkLayerTest, DISABLED_FragmentStoresAndAtomicsFeatureDisable) {
...
TEST_F(VkCompatibleLayerTest, DuplicateDynamicStates) {
...
TEST_F(VkCompatibleLayerTest, NonGraphicsDynamicStates) {
...
TEST_F(VkCompatibleLayerTest, PipelineMaxPerStageResources) {
...
TEST_F(VkCompatibleLayerTest, ValidatePipelineExecutablePropertiesFeature) {
...
TEST_F(VkCompatibleLayerTest, LimitsMaxSampleMaskWords) {
...
TEST_F(VkCompatibleLayerTest, InvalidFragmentShadingRatePipeline) {
...
TEST_F(VkCompatibleLayerTest, InvalidFragmentShadingRatePipelineFeatureUsage) {
...
TEST_F(VkCompatibleLayerTest, InvalidFragmentShadingRatePipelineCombinerOpsLimit) {
...
TEST_F(VkCompatibleLayerTest, InvalidPrimitiveFragmentShadingRateWriteMultiViewportLimit) {
...
TEST_F(VkCompatibleLayerTest, SampledInvalidImageViews) {
...
TEST_F(VkLayerTest, DISABLED_ShaderDrawParametersNotEnabled10) {
...
TEST_F(VkLayerTest, DISABLED_ShaderDrawParametersNotEnabled11) {
...
TEST_F(VkCompatibleLayerTest, ShaderFloatControl) {
...
TEST_F(VkCompatibleLayerTest, Storage8and16bitCapability) {
...
TEST_F(VkCompatibleLayerTest, Storage8and16bitFeatures) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_WorkgroupMemoryExplicitLayout) {
...
TEST_F(VkCompatibleLayerTest, ReadShaderClock) {
...
TEST_F(VkCompatibleLayerTest, GraphicsPipelineInvalidFlags) {
...
TEST_F(VkCompatibleLayerTest, ComputePipelineInvalidFlags) {
...
TEST_F(VkCompatibleLayerTest, UsingProvokingVertexModeLastVertexExtWithoutEnabled) {
...
TEST_F(VkCompatibleLayerTest, NotSupportProvokingVertexModePerPipeline) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_SpecializationInvalidSizeZero) {
...
TEST_F(VkLayerTest, DISABLED_MergePipelineCachesInvalidDst) {
...
TEST_F(VkLayerTest, DISABLED_ValidateGeometryShaderEnabled) {
...
TEST_F(VkLayerTest, DISABLED_ValidateTessellationShaderEnabled) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CreateComputesPipelineWithBadBasePointer) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineWithDuplicatedSpecializationConstantID) {
...
TEST_F(VkCompatibleLayerTest, PipelineSubgroupSizeControl) {
...
TEST_F(VkCompatibleLayerTest, SubgroupSizeControlFeaturesNotEnabled) {
...
TEST_F(VkCompatibleLayerTest, ShaderAtomicInt64) {
...
TEST_F(VkCompatibleLayerTest, PipelineInvalidAdvancedBlend) {
...
TEST_F(VkCompatibleLayerTest, PipelineAdvancedBlendInvalidBlendOps) {
...
TEST_F(VkCompatibleLayerTest, PipelineAdvancedBlendMaxBlendAttachment) {
    TEST_DESCRIPTION("Advanced blending with invalid VkBlendOps");
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddRequiredExtensions(VK_EXT_BLEND_OPERATION_ADVANCED_EXTENSION_NAME);
    ASSERT_NO_FATAL_FAILURE(InitFramework());
...
TEST_F(VkCompatibleLayerTest, InvalidPipelineDiscardRectangle) {
...
TEST_F(VkLayerTest, DISABLED_ShaderImageAtomicInt64) {
...
TEST_F(VkCompatibleLayerTest, ShaderImageAtomicInt64Drawtime64) {
...
TEST_F(VkCompatibleLayerTest, ShaderImageAtomicInt64Drawtime32) {
...
TEST_F(VkCompatibleLayerTest, ShaderAtomicFloat) {
...
TEST_F(VkLayerTest, DISABLED_ShaderAtomicFloat2) {
...
TEST_F(VkCompatibleLayerTest, BindLibraryPipeline) {
...
TEST_F(VkCompatibleLayerTest, PipelineColorWriteCreateInfoEXT) {
...
TEST_F(VkCompatibleLayerTest, PipelineColorWriteCreateInfoEXTDynaimcState3) {
...
TEST_F(VkCompatibleLayerTest, ColorBlendAdvanced) {
...
TEST_F(VkCompatibleLayerTest, ValidateVariableSampleLocations) {
...
TEST_F(VkLayerTest, DISABLED_ComputeSharedMemoryOverLimit) {
...
TEST_F(VkLayerTest, DISABLED_ComputeSharedMemoryBooleanOverLimit) {
...
TEST_F(VkCompatibleLayerTest, ComputeSharedMemoryOverLimitWorkgroupMemoryExplicitLayout) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_ComputeSharedMemorySpecConstantDefault) {
...
TEST_F(VkLayerTest, DISABLED_ComputeSharedMemorySpecConstantSet) {
...
TEST_F(VkCompatibleLayerTest, SpecializationInvalidSizeMismatch) {
...
TEST_F(VkLayerTest, DISABLED_ComputeWorkGroupSizeSpecConstant) {
...
TEST_F(VkLayerTest, DISABLED_ComputeWorkGroupSizeConstantDefault) {
...
TEST_F(VkLayerTest, DISABLED_ComputeWorkGroupSizeSpecConstantDefault) {
...
TEST_F(VkCompatibleLayerTest, ComputeWorkGroupSizeLocalSizeId) {
...
TEST_F(VkCompatibleLayerTest, ComputeWorkGroupSizeLocalSizeIdSpecConstantDefault) {
...
TEST_F(VkCompatibleLayerTest, ComputeWorkGroupSizeLocalSizeIdSpecConstantSet) {
...
TEST_F(VkCompatibleLayerTest, UsingRasterizationStateStreamExtWithoutEnabled) {
...
TEST_F(VkCompatibleLayerTest, TestPipelineRasterizationStateStreamCreateInfoEXT) {
...
TEST_F(VkLayerTest, DISABLED_NoUniformBufferStandardLayout10) {
...
TEST_F(VkLayerTest, DISABLED_NoUniformBufferStandardLayout12) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_NoScalarBlockLayout10) {
...
TEST_F(VkLayerTest, DISABLED_NoScalarBlockLayout12) {
...
TEST_F(VkLayerTest, DISABLED_TestPipelineRasterizationConservativeStateCreateInfo) {
...
TEST_F(VkLayerTest, DISABLED_TestShaderZeroInitializeWorkgroupMemory) {
...
TEST_F(VkCompatibleLayerTest, TestRuntimeSpirvTransformFeedback) {
...
TEST_F(VkLayerTest, DISABLED_TestMinAndMaxTexelGatherOffset) {
...
TEST_F(VkLayerTest, DISABLED_TestMinAndMaxTexelOffset) {
...
TEST_F(VkCompatibleLayerTest, DeviceMemoryScope) {
...
TEST_F(VkCompatibleLayerTest, QueueFamilyMemoryScope) {
...
TEST_F(VkCompatibleLayerTest, CreatePipelineLayoutWithInvalidSetLayoutFlags) {
...
TEST_F(VkLayerTest, DISABLED_TestUsingDisabledMultiviewFeatures) {
...
TEST_F(VkCompatibleLayerTest, ComputeImageLayout) {
...
TEST_F(VkLayerTest, DISABLED_ComputeImageLayout_1_1) {
...
TEST_F(VkCompatibleLayerTest, CreateGraphicsPipelineNullRenderPass) {
...
TEST_F(VkCompatibleLayerTest, CreateGraphicsPipelineRasterizationOrderAttachmentAccessWithoutFeature) {
...
TEST_F(VkCompatibleLayerTest, CreateGraphicsPipelineRasterizationOrderAttachmentAccessNoSubpassFlags) {
    TEST_DESCRIPTION("Test for a creating a pipeline with VK_ARM_rasterization_order_attachment_access enabled");
...
TEST_F(VkCompatibleLayerTest, TestMismatchedRenderPassAndPipelineAttachments) {
...
TEST_F(VkCompatibleLayerTest, IncompatibleScissorCountAndViewportCount) {
...
TEST_F(VkCompatibleLayerTest, TestCreatingPipelineWithScissorWithCount) {
...
TEST_F(VkCompatibleLayerTest, DynamicSampleLocations) {
...
TEST_F(VkLayerTest, DISABLED_TestShaderInputOutputMismatch) {
...
TEST_F(VkCompatibleLayerTest, InvalidFragmentShadingRateOps) {
    TEST_DESCRIPTION("Specify invalid fsr pipeline settings for the enabled features");
...
TEST_F(VkCompatibleLayerTest, DISABLED_MaxFragmentDualSrcAttachments) {
...
// https://github.com/KhronosGroup/Vulkan-ValidationLayers/issues/5208
TEST_F(VkCompatibleLayerTest, DISABLED_MaxFragmentDualSrcAttachmentsDynamicBlendEnable) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, TestSubgroupUniformControlFlow) {
...
TEST_F(VkCompatibleLayerTest, TestLocalSizeIdExecutionMode) {
...
TEST_F(VkCompatibleLayerTest, ComputeLocalWorkgroupSize) {
...
TEST_F(VkCompatibleLayerTest, MissingSubgroupSizeControlFeature) {
...
TEST_F(VkCompatibleLayerTest, ShaderModuleIdentifier) {
...
TEST_F(VkCompatibleLayerTest, ShaderModuleIdentifierFeatures) {
...
TEST_F(VkCompatibleLayerTest, InvalidViewportCountWithExtendedDynamicState) {
...
TEST_F(VkCompatibleLayerTest, PipelineColorBlendStateCreateInfoValidArrayNonDynamic) {
...
TEST_F(VkCompatibleLayerTest, PipelineColorBlendStateCreateInfoValidArrayDynamic) {
...
TEST_F(VkLayerTest, DISABLED_StorageImageWriteLessComponent) {
...
TEST_F(VkLayerTest, DISABLED_StorageImageWriteSpecConstantLessComponent) {
...
TEST_F(VkLayerTest, DISABLED_StorageTexelBufferWriteLessComponent) {
...
TEST_F(VkLayerTest, DISABLED_StorageImageUnknownWriteLessComponent) {
...
TEST_F(VkCompatibleLayerTest, StorageTexelBufferUnkownWriteLessComponent) {
...
TEST_F(VkCompatibleLayerTest, PipelineProtectedAccess) {
...
TEST_F(VkCompatibleLayerTest, MeshShaderEXT) {
...
TEST_F(VkCompatibleLayerTest, MeshShaderEXTDisabled) {
...
TEST_F(VkCompatibleLayerTest, MeshShaderEXTRuntimeSpirv) {
...
TEST_F(VkCompatibleLayerTest, MeshShaderNVRuntimeSpirv) {
...
TEST_F(VkLayerTest, DISABLED_ConservativeRasterizationPostDepthCoverage) {
