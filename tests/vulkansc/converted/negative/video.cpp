...
TEST_F(VkCompatibleVideoLayerTest, VideoCodingScope) {
...
TEST_F(VkCompatibleVideoLayerTest, VideoProfileInvalidLumaChromaSubsampling) {
...
TEST_F(VkCompatibleVideoLayerTest, VideoProfileMissingCodecInfo) {
...
TEST_F(VkCompatibleVideoLayerTest, CapabilityQueryMissingChain) {
...
TEST_F(VkCompatibleVideoLayerTest, VideoFormatQueryMissingProfile) {
...
TEST_F(VkCompatibleVideoLayerTest, InUseDestroyed) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionProtectedMemoryNotEnabled) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionProtectedContentUnsupported) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionUnsupportedProfile) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionInvalidReferencePictureCounts) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionInvalidMaxCodedExtent) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionInvalidDecodeReferencePictureFormat) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionInvalidDecodePictureFormat) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionInvalidStdHeaderVersion) {
...
TEST_F(VkCompatibleVideoLayerTest, BindVideoSessionMemory) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionParamsIncompatibleTemplate) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionParamsMissingCodecInfo) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionParamsH264ExceededCapacity) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateSessionParamsH265ExceededCapacity) {
...
TEST_F(VkCompatibleVideoLayerTest, H264ParametersAddInfoUniqueness) {
...
TEST_F(VkCompatibleVideoLayerTest, H265ParametersAddInfoUniqueness) {
...
TEST_F(VkCompatibleVideoLayerTest, UpdateSessionParamsIncorrectSequenceCount) {
...
TEST_F(VkCompatibleVideoLayerTest, UpdateSessionParamsH264ConflictingKeys) {
...
TEST_F(VkCompatibleVideoLayerTest, UpdateSessionParamsH265ConflictingKeys) {
...
TEST_F(VkCompatibleVideoLayerTest, UpdateSessionParamsH264ExceededCapacity) {
...
TEST_F(VkCompatibleVideoLayerTest, UpdateSessionParamsH265ExceededCapacity) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingUnsupportedCodecOp) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingActiveQueriesNotAllowed) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingProtectedNoFaultSession) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingProtectedNoFaultSlots) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingSessionMemoryNotBound) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingSessionUninitialized) {
    TEST_DESCRIPTION("vkCmdBeginVideoCodingKHR - session uninitialized");
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingInvalidSessionParams) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingDecodeH264RequiresParams) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingDecodeH265RequiresParams) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingIncompatRefPicProfile) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingInvalidResourceLayer) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingDecodeSlotInactive) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingDecodeInvalidSlotResourceAssociation) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingInvalidSlotIndex) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingResourcesNotUnique) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingReferenceFormatMismatch) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingInvalidCodedOffset) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingInvalidCodedExtent) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingInvalidSeparateReferenceImages) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginCodingMissingDecodeDpbUsage) {
...
TEST_F(VkCompatibleVideoLayerTest, EndCodingActiveQueriesNotAllowed) {
    TEST_DESCRIPTION("vkCmdBeginVideoCodingKHR - there must be no active query");
...
TEST_F(VkCompatibleVideoLayerTest, DecodeSessionUninitialized) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeProtectedNoFaultBitstreamBuffer) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeProtectedNoFaultDecodeOutput) {
    TEST_DESCRIPTION("vkCmdDecodeVideoKHR - protectedNoFault tests for bitstream buffer");
...
TEST_F(VkCompatibleVideoLayerTest, DecodeImageLayouts) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeInvalidResourceLayer) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeQueryTooManyOperations) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeIncompatBufferProfile) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeBufferMissingDecodeSrcUsage) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeBufferOffsetOutOfBounds) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeBufferOffsetAlignment) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeBufferRangeOutOfBounds) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeBufferRangeAlignment) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeInvalidOutputAndSetupCoincide) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleVideoLayerTest, DecodeInvalidOutputAndSetupDistinct) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleVideoLayerTest, DecodeInvalidSetupSlotIndex) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeInvalidRefSlotIndex) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeSetupResourceNull) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeReferenceResourceNull) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeIncompatOutputPicProfile) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeOutputFormatMismatch) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeOutputMissingDecodeDstUsage) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeOutputCodedOffsetExtent) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeSetupAndRefCodedOffset) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeSetupResourceNotBound) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeRefResourceNotBoundToDPBSlot) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleVideoLayerTest, DecodeTooManyReferences) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeTooManyReferencesH264Interlaced) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleVideoLayerTest, DecodeDuplicateRefResource) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeDuplicateRefResourceH264Interlaced) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleVideoLayerTest, DecodeDuplicateFrame) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeDuplicateFrameFieldH264Interlaced) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeRefPictureKindMismatch) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleVideoLayerTest, DecodeInvalidCodecInfoH264) {
...
TEST_F(VkCompatibleVideoLayerTest, DecodeFieldFrameMismatchH264) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleVideoLayerTest, DecodeInvalidCodecInfoH265) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateBufferInvalidProfileList) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateImageInvalidProfileList) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateImageIncompatibleProfile) {
...
TEST_F(VkCompatibleVideoLayerTest, CreateImageViewInvalidViewType) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginQueryIncompatibleQueueFamily) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginQueryVideoCodingScopeQueryAlreadyActive) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginQueryResultStatusProfileMismatch) {
...
TEST_F(VkCompatibleVideoLayerTest, BeginQueryVideoCodingScopeIncompatibleQueryType) {
...
TEST_F(VkCompatibleVideoLayerTest, GetQueryPoolResultsStatusBit) {
...
TEST_F(VkCompatibleVideoLayerTest, CopyQueryPoolResultsStatusBit) {
...
TEST_F(VkCompatibleVideoLayerTest, ImageLayoutUsageMismatch) {
...
TEST_F(VkVideoBestPracticesLayerTest, DISABLED_GetVideoSessionMemoryRequirements) {
...
TEST_F(VkVideoBestPracticesLayerTest, DISABLED_BindVideoSessionMemory) {
