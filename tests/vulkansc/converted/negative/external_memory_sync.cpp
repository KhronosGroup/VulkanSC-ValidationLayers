...
TEST_F(VkCompatibleLayerTest, CreateBufferIncompatibleExternalHandleTypes) {
...
TEST_F(VkCompatibleLayerTest, CreateImageIncompatibleExternalHandleTypes) {
...
TEST_F(VkCompatibleLayerTest, CreateImageIncompatibleExternalHandleTypesNV) {
...
TEST_F(VkCompatibleLayerTest, InvalidExportExternalImageHandleType) {
...
TEST_F(VkCompatibleLayerTest, BufferMemoryWithUnsupportedExternalHandleType) {
...
TEST_F(VkCompatibleLayerTest, BufferMemoryWithIncompatibleExternalHandleTypes) {
...
TEST_F(VkCompatibleLayerTest, ImageMemoryWithUnsupportedExternalHandleType) {
...
TEST_F(VkCompatibleLayerTest, ImageMemoryWithIncompatibleExternalHandleTypes) {
...
TEST_F(VkCompatibleLayerTest, InvalidExportExternalBufferHandleType) {
    TEST_DESCRIPTION("Test exporting memory with mismatching handleTypes.");
    SetTargetApiVersion(VK_API_VERSION_1_1);
    ASSERT_NO_FATAL_FAILURE(InitFramework());
    if (DeviceValidationVersion() < VK_API_VERSION_1_1) {
...
TEST_F(VkCompatibleLayerTest, ExternalTimelineSemaphore) {
...
TEST_F(VkCompatibleLayerTest, ExternalSyncFdSemaphore) {
...
TEST_F(VkCompatibleLayerTest, TemporaryExternalFence) {
#ifdef VK_USE_PLATFORM_WIN32_KHR
...
TEST_F(VkCompatibleLayerTest, InvalidExternalFence) {
#ifdef VK_USE_PLATFORM_WIN32_KHR
    const auto extension_name = VK_KHR_EXTERNAL_FENCE_WIN32_EXTENSION_NAME;
...
TEST_F(VkCompatibleLayerTest, ExternalSyncFdFence) {
...
TEST_F(VkCompatibleLayerTest, TemporaryExternalSemaphore) {
#ifdef VK_USE_PLATFORM_WIN32_KHR
    const auto extension_name = VK_KHR_EXTERNAL_SEMAPHORE_WIN32_EXTENSION_NAME;
    const auto handle_type = VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHR;
#else
...
TEST_F(VkCompatibleLayerTest, InvalidExternalSemaphore) {
...
TEST_F(VkCompatibleLayerTest, ValidateImportMemoryHandleType) {
...
TEST_F(VkCompatibleLayerTest, FenceExportWithUnsupportedHandleType) {
...
TEST_F(VkCompatibleLayerTest, FenceExportWithIncompatibleHandleType) {
...
TEST_F(VkCompatibleLayerTest, SemaphoreExportWithUnsupportedHandleType) {
...
TEST_F(VkCompatibleLayerTest, SemaphoreExportWithIncompatibleHandleType) {
...
TEST_F(VkCompatibleLayerTest, ExternalMemoryAndExternalMemoryNV) {
...
TEST_F(VkCompatibleLayerTest, ValidateExternalMemoryImageLayout) {
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
TEST_F(VkCompatibleLayerTest, InvalidD3D12FenceSubmitInfo) {
