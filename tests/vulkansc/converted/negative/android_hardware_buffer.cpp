...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferImageCreate) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferFetchUnboundImageInfo) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferGpuDataBuffer) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferAllocationSize) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferDedicatedUsageColor) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferDedicatedUsageDS) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferMipmapChain) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferImageDimensions) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferUnknownFormat) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferGpuUsage) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferExportMemoryAllocate) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferCreateYCbCrSampler) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferPhysDevImageFormatProp2) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferCreateImageView) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferImportBuffer) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferExportBufferHandleType) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferExportImageNonBound) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferInvalidBindBufferMemory) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferImportBufferHandleType) {
...
TEST_F(VkCompatibleLayerTest, AndroidHardwareBufferImportImageHandleType) {
