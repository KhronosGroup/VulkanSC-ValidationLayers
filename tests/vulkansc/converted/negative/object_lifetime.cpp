...
TEST_F(VkCompatibleLayerTest, InvalidCmdBufferBufferDestroyed) {
...
TEST_F(VkLayerTest, DISABLED_InvalidCmdBarrierBufferDestroyed) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkLayerTest, DISABLED_InvalidCmdBarrierImageDestroyed) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkLayerTest, DISABLED_Sync2InvalidCmdBarrierBufferDestroyed) {
...
TEST_F(VkLayerTest, DISABLED_Sync2InvalidCmdBarrierImageDestroyed) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME);
    ASSERT_NO_FATAL_FAILURE(InitFramework());
    if (!AreRequiredExtensionsEnabled()) {
...
TEST_F(VkLayerTest, DISABLED_InvalidCmdBufferBufferViewDestroyed) {
...
TEST_F(VkCompatibleLayerTest, InvalidCmdBufferImageDestroyed) {
...
TEST_F(VkCompatibleLayerTest, InvalidCmdBufferFramebufferImageDestroyed) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_FramebufferAttachmentMemoryFreed) {
