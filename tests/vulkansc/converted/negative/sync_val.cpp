...
TEST_F(VkCompatibleSyncValTest, SyncBufferCopyHazards) {
...
TEST_F(VkCompatibleSyncValTest, Sync2BufferCopyHazards) {
...
TEST_F(VkCompatibleSyncValTest, SyncCopyOptimalImageHazards) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
...
TEST_F(VkCompatibleSyncValTest, Sync2CopyOptimalImageHazards) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME);
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    if (!AreRequiredExtensionsEnabled()) {
...
TEST_F(VkCompatibleSyncValTest, SyncCopyOptimalMultiPlanarHazards) {
...
TEST_F(VkCompatibleSyncValTest, SyncCopyLinearImageHazards) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState());
...
TEST_F(VkCompatibleSyncValTest, SyncCopyLinearMultiPlanarHazards) {
    AddRequiredExtensions(VK_KHR_SAMPLER_YCBCR_CONVERSION_EXTENSION_NAME);
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    if (!AreRequiredExtensionsEnabled()) {
        GTEST_SKIP() << RequiredExtensionsNotSupported() << " not supported";
...
TEST_F(VkCompatibleSyncValTest, SyncCopyBufferImageHazards) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState());
...
TEST_F(VkCompatibleSyncValTest, SyncBlitImageHazards) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState());
...
TEST_F(VkCompatibleSyncValTest, SyncRenderPassBeginTransitionHazard) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState());
...
TEST_F(VkSyncValTest, DISABLED_SyncCmdDispatchDrawHazards) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
...
TEST_F(VkCompatibleSyncValTest, SyncCmdClear) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
    // CmdClearColorImage
    VkImageUsageFlags usage = VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT;
...
TEST_F(VkCompatibleSyncValTest, SyncCmdQuery) {
...
TEST_F(VkCompatibleSyncValTest, SyncCmdDrawDepthStencil) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
...
TEST_F(VkCompatibleSyncValTest, RenderPassLoadHazardVsInitialLayout) {
...
TEST_F(VkCompatibleSyncValTest, SyncRenderPassWithWrongDepthStencilInitialLayout) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState());
    if (IsPlatform(kNexusPlayer)) {
        GTEST_SKIP() << "This test should not run on Nexus Player";
...
TEST_F(VkCompatibleSyncValTest, SyncLayoutTransition) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState());
    if (IsPlatform(kNexusPlayer)) {
        GTEST_SKIP() << "This test should not run on Nexus Player";
...
TEST_F(VkCompatibleSyncValTest, SyncSubpassMultiDep) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState());
    if (IsPlatform(kNexusPlayer)) {
        GTEST_SKIP() << "This test should not run on Nexus Player";
...
TEST_F(VkSyncValTest, DISABLED_RenderPassAsyncHazard) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState());
...
TEST_F(VkCompatibleSyncValTest, SyncEventsBufferCopy) {
...
TEST_F(VkCompatibleSyncValTest, SyncEventsCopyImageHazards) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework());
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
...
TEST_F(VkCompatibleSyncValTest, SyncEventsCommandHazards) {
...
TEST_F(VkCompatibleLayerTest, CmdWaitEvents2KHRUsedButSynchronizaion2Disabled) {
...
TEST_F(VkCompatibleLayerTest, Sync2FeatureDisabled) {
...
TEST_F(VkCompatibleSyncValTest, DestroyedUnusedDescriptors) {
...
TEST_F(VkCompatibleSyncValTest, TestInvalidExternalSubpassDependency) {
...
TEST_F(VkCompatibleSyncValTest, TestCopyingToCompressedImage) {
...
TEST_F(VkSyncValTest, DISABLED_StageAccessExpansion) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
...
TEST_F(VkCompatibleSyncValTest, SyncQSBufferCopyHazards) {
...
TEST_F(VkCompatibleSyncValTest, SyncQSSubmit2) {
    SetTargetApiVersion(VK_API_VERSION_1_3);
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework(true));  // Enable QueueSubmit validation
...
TEST_F(VkCompatibleSyncValTest, SyncQSBufferCopyVsIdle) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework(true));  // Enable QueueSubmit validation
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
...
TEST_F(VkCompatibleSyncValTest, SyncQSBufferCopyVsFence) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework(true));  // Enable QueueSubmit validation
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
...
TEST_F(VkCompatibleSyncValTest, SyncQSBufferCopyQSORules) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework(true));  // Enable QueueSubmit validation
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
...
TEST_F(VkCompatibleSyncValTest, SyncQSBufferEvents) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework(true));  // Enable QueueSubmit validation
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
...
TEST_F(VkCompatibleSyncValTest, SyncQSOBarrierHazard) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework(true));  // Enable QueueSubmit validation
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
...
TEST_F(VkCompatibleSyncValTest, SyncQSRenderPass) {
    ASSERT_NO_FATAL_FAILURE(InitSyncValFramework(true));  // Enable QueueSubmit validation
    ASSERT_NO_FATAL_FAILURE(InitState(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
    if (IsPlatform(kNexusPlayer)) {
        GTEST_SKIP() << "This test should not run on Nexus Player";
...
TEST_F(VkSyncValTest, DISABLED_SyncQSPresentAcquire) {
