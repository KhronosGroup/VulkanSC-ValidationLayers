...
TEST_F(VkGpuAssistedLayerTest, DISABLED_RayTracingGpuValidationArrayOOBRayTracingShaders) {
    TEST_DESCRIPTION(
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_NVRayTracingGpuBuildAccelerationStructureValidationInvalidHandle) {
    TEST_DESCRIPTION(
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_NVRayTracingGpuBuildAccelerationStructureValidationBottomLevelNotYetBuilt) {
    TEST_DESCRIPTION(
        "Acceleration structure gpu validation should report an invalid handle when trying to build a top level "
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_NVRayTracingGpuBuildAccelerationStructureValidationBottomLevelDestroyed) {
    TEST_DESCRIPTION(
        "Acceleration structure gpu validation should report an invalid handle when trying to build a top level "
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_NVRayTracingGpuBuildAccelerationStructureValidationRestoresState) {
