...
TEST_F(VkLayerTest, DISABLED_ViewportInheritance) {
...
TEST_F(VkLayerTest, DISABLED_ViewportInheritanceMissingFeature) {
...
TEST_F(VkLayerTest, DISABLED_ViewportInheritanceMultiViewport) {
...
TEST_F(VkLayerTest, DISABLED_ViewportInheritanceScissorMissingFeature) {
...
TEST_F(VkCompatibleLayerTest, PipelineMissingDynamicStateDiscardRectangle) {
