...
TEST_F(VkCompatibleLayerTest, RayTracingTestBarrierAccessAccelerationStructure) {
...
TEST_F(VkCompatibleLayerTest, RayTracingValidateDescriptorBindingUpdateAfterBindWithAccelerationStructure) {
...
TEST_F(VkCompatibleLayerTest, RayTracingAccelerationStructureBindings) {
...
TEST_F(VkCompatibleLayerTest, RayTracingValidateBeginQueryQueryPoolType) {
...
TEST_F(VkCompatibleLayerTest, RayTracingCopyUnboundAccelerationStructure) {
...
TEST_F(VkCompatibleLayerTest, RayTracingCmdCopyUnboundAccelerationStructure) {
...
TEST_F(VkCompatibleLayerTest, RayTracingTestCmdCopyMemoryToAccelerationStructureKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingBuildAccelerationStructureKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingTestWriteAccelerationStructureMemory) {
    ...
    vkWriteAccelerationStructuresPropertiesKHR(device(), 1, &build_geometry_info.GetDstAS()->handle(),
                                               VK_QUERY_TYPE_ACCELERATION_STRUCTURE_COMPACTED_SIZE_KHR, data.size(), data.data(),
                                               data.size());
    m_errorMonitor->VerifyFound();
}

TEST_F(VkCompatibleLayerTest, RayTracingTestCopyMemoryToAsBuffer) {
...
TEST_F(VkCompatibleLayerTest, RayTracingValidationArrayOOBRayTracingShaders) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, RayTracingValidateCreateAccelerationStructureKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingValidateCreateAccelerationStructureKHRReplayFeature) {
...
TEST_F(VkCompatibleLayerTest, RayTracingValidateCmdTraceRaysKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingValidateCmdTraceRaysIndirectKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingValidateVkAccelerationStructureVersionInfoKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingValidateCmdBuildAccelerationStructuresKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingObjInUseCmdBuildAccelerationStructureKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingCmdCopyAccelerationStructureToMemoryKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingUpdateAccelerationStructureKHR) {
...
TEST_F(VkCompatibleLayerTest, RayTracingBuffersAndBufferDeviceAddressesMapping) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, WriteAccelerationStructuresProperties) {
...
TEST_F(VkCompatibleLayerTest, WriteAccelerationStructuresPropertiesMaintenance1) {
    TEST_DESCRIPTION("Test queryType validation in vkCmdWriteAccelerationStructuresPropertiesKHR");
...
TEST_F(VkCompatibleLayerTest, NVRayTracingAccelerationStructureBindings) {
...
TEST_F(VkCompatibleLayerTest, NVRayTracingValidateGeometry) {
...
TEST_F(VkCompatibleLayerTest, NVRayTracingValidateCreateAccelerationStructure) {
    TEST_DESCRIPTION("Validate acceleration structure creation.");
...
TEST_F(VkCompatibleLayerTest, NVRayTracingValidateBindAccelerationStructure) {
...
TEST_F(VkCompatibleLayerTest, NVRayTracingValidateWriteDescriptorSetAccelerationStructure) {
    TEST_DESCRIPTION("Validate acceleration structure descriptor writing.");
...
TEST_F(VkCompatibleLayerTest, NVRayTracingValidateCmdBuildAccelerationStructure) {
    TEST_DESCRIPTION("Validate acceleration structure building.");
...
TEST_F(VkCompatibleLayerTest, NVRayTracingObjInUseCmdBuildAccelerationStructure) {
    TEST_DESCRIPTION("Validate acceleration structure building tracks the objects used.");
...
TEST_F(VkCompatibleLayerTest, NVRayTracingValidateGetAccelerationStructureHandle) {
...
TEST_F(VkCompatibleLayerTest, NVRayTracingValidateCmdCopyAccelerationStructure) {
