...
TEST_F(VkCompatibleLayerTest, MirrorClampToEdgeNotEnabled) {
...
TEST_F(VkCompatibleLayerTest, MirrorClampToEdgeNotEnabled12) {
...
TEST_F(VkCompatibleLayerTest, AnisotropyFeatureDisabled) {
...
TEST_F(VkCompatibleLayerTest, AnisotropyFeatureEnabled) {
...
TEST_F(VkCompatibleLayerTest, UnnormalizedCoordinatesEnabled) {
...
TEST_F(VkCompatibleLayerTest, InvalidSamplerCreateInfo) {
...
TEST_F(VkCompatibleLayerTest, ExceedSamplerAllocationCount) {
...
TEST_F(VkCompatibleLayerTest, SamplerImageViewFormatUnsupportedFilter) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, IllegalAddressModeWithCornerSampledNV) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, MultiplaneImageSamplerConversionMismatch) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, InvalidSamplerFilterMinmax) {
...
TEST_F(VkCompatibleLayerTest, CustomBorderColor) {
...
TEST_F(VkCompatibleLayerTest, CustomBorderColorFormatUndefined) {
...
TEST_F(VkLayerTest, DISABLED_UnnormalizedCoordinatesCombinedSampler) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_UnnormalizedCoordinatesSeparateSampler) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_UnnormalizedCoordinatesSeparateSamplerSharedImage) {
...
TEST_F(VkLayerTest, DISABLED_UnnormalizedCoordinatesSeparateSamplerSharedSampler) {
...
TEST_F(VkLayerTest, DISABLED_UnnormalizedCoordinatesInBoundsAccess) {
...
TEST_F(VkCompatibleLayerTest, TestSamplerReductionMode) {
...
TEST_F(VkCompatibleLayerTest, TestInvalidSamplerReductionMode) {
...
TEST_F(VkCompatibleLayerTest, NonSeamlessCubeMapNotEnabled) {
