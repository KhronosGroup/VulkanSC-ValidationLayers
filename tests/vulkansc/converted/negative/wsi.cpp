...
TEST_F(VkCompatibleLayerTest, InitSwapchainPotentiallyIncompatibleFlag) {
...
TEST_F(VkCompatibleLayerTest, BindImageMemorySwapchain) {
...
TEST_F(VkCompatibleLayerTest, ValidSwapchainImage) {
...
TEST_F(VkCompatibleLayerTest, TransferImageToSwapchainWithInvalidLayoutDeviceGroup) {
...
TEST_F(VkCompatibleLayerTest, ValidSwapchainImageParams) {
...
TEST_F(VkLayerTest, DISABLED_SwapchainAcquireImageNoSync) {
...
TEST_F(VkLayerTest, DISABLED_SwapchainAcquireImageNoSync2KHR) {
...
TEST_F(VkCompatibleLayerTest, SwapchainAcquireImageNoBinarySemaphore) {
...
TEST_F(VkCompatibleLayerTest, SwapchainAcquireImageNoBinarySemaphore2KHR) {
...
TEST_F(VkLayerTest, DISABLED_SwapchainAcquireTooManyImages) {
...
TEST_F(VkLayerTest, DISABLED_GetSwapchainImageAndTryDestroy) {
...
TEST_F(VkCompatibleLayerTest, SwapchainNotSupported) {
...
TEST_F(VkLayerTest, DISABLED_SwapchainAcquireTooManyImages2KHR) {
...
TEST_F(VkCompatibleLayerTest, InvalidSwapchainImageFormatList) {
...
TEST_F(VkCompatibleLayerTest, SwapchainMinImageCountNonShared) {
...
TEST_F(VkCompatibleLayerTest, SwapchainMinImageCountShared) {
...
TEST_F(VkCompatibleLayerTest, SwapchainInvalidUsageNonShared) {
...
TEST_F(VkCompatibleLayerTest, SwapchainInvalidUsageShared) {
...
TEST_F(VkCompatibleLayerTest, InvalidDeviceMask) {
...
TEST_F(VkCompatibleLayerTest, DisplayPlaneSurface) {
...
TEST_F(VkLayerTest, DISABLED_WarningSwapchainCreateInfoPreTransform) {
...
TEST_F(VkCompatibleLayerTest, DeviceGroupSubmitInfoSemaphoreCount) {
...
TEST_F(VkCompatibleLayerTest, SwapchainAcquireImageWithSignaledSemaphore) {
...
TEST_F(VkCompatibleLayerTest, DisplayPresentInfoSrcRect) {
...
TEST_F(VkLayerTest, DISABLED_LeakASwapchain) {
...
TEST_F(VkCompatibleLayerTest, PresentIdWait) {
    ...
    VkSwapchainKHR swapchain3 = VK_NULL_HANDLE;
    // Retire swapchain2
...
TEST_F(VkCompatibleLayerTest, PresentIdWaitFeatures) {
    TEST_DESCRIPTION("Test present wait extension");
    SetTargetApiVersion(VK_API_VERSION_1_1);
    AddSurfaceExtension();
    AddRequiredExtensions(VK_KHR_PRESENT_WAIT_EXTENSION_NAME);
...
TEST_F(VkLayerTest, DISABLED_GetSwapchainImagesCountButNotImages) {
...
TEST_F(VkLayerTest, DISABLED_TestSurfaceSupportByPhysicalDevice) {
...
TEST_F(VkCompatibleLayerTest, SwapchainMaintenance1ExtensionTestsAcquire) {
...
TEST_F(VkCompatibleLayerTest, SwapchainMaintenance1ExtensionTestsCaps) {
...
TEST_F(VkCompatibleLayerTest, SwapchainMaintenance1ExtensionTestsRelease) {
...
TEST_F(VkCompatibleLayerTest, TestvkAcquireFullScreenExclusiveModeEXT) {
...
TEST_F(VkLayerTest, DISABLED_TestCreatingWin32Surface) {
...
TEST_F(VkCompatibleLayerTest, CreatingWaylandSurface) {
...
TEST_F(VkCompatibleLayerTest, CreatingXcbSurface) {
...
TEST_F(VkCompatibleLayerTest, CreatingX11Surface) {
...
TEST_F(VkCompatibleLayerTest, UseSwapchainImageBeforeWait) {
...
TEST_F(VkCompatibleLayerTest, TestCreatingSwapchainWithInvalidExtent) {
...
TEST_F(VkCompatibleLayerTest, TestSurfaceQueryImageCompressionControlWithoutExtension) {
...
TEST_F(VkCompatibleLayerTest, PhysicalDeviceSurfaceCapabilities) {
    ...
    m_errorMonitor->VerifyFound();
        ...
        //
TEST_F(VkLayerTest, DISABLED_QueuePresentWaitingSameSemaphore) {
...
TEST_F(VkLayerTest, DISABLED_QueuePresentBinarySemaphoreNotSignaled) {
