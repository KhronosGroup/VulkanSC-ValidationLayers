...
TEST_F(VkCompatibleLayerTest, InvalidDescriptorPoolConsistency) {
...
TEST_F(VkCompatibleLayerTest, BadSubpassIndices) {
...
TEST_F(VkCompatibleLayerTest, DrawWithPipelineIncompatibleWithSubpass) {
...
TEST_F(VkCompatibleLayerTest, ImageBarrierSubpassConflict) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateAttachmentIndexOutOfRange) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateAttachmentReadOnlyButCleared) {
    AddRequiredExtensions(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME);
    AddOptionalExtensions(VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME);
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateAttachmentMismatchingLayoutsColor) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateAttachmentDescriptionInvalidFinalLayout) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateAttachmentsMisc) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, InvalidRenderPassCreateRenderPassShaderResolveQCOM) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateAttachmentReferenceInvalidLayout) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateAttachmentReferenceInvalidSync2Layout) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateOverlappingCorrelationMasks) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateInvalidViewMasks) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateInvalidInputAttachmentReferences) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateInvalidFragmentDensityMapReferences) {
...
TEST_F(VkCompatibleLayerTest, InvalidFragmentDensityMapLayerCount) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateSubpassNonGraphicsPipeline) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateSubpassMissingAttributesBitMultiviewNVX) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreate2SubpassInvalidInputAttachmentParameters) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateInvalidSubpassDependencies) {
    AddRequiredExtensions(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME);
    AddOptionalExtensions(VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME);
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateInvalidMixedAttachmentSamplesAMD) {
...
TEST_F(VkCompatibleLayerTest, RenderPassBeginInvalidRenderArea) {
...
TEST_F(VkCompatibleLayerTest, RenderPassBeginWithinRenderPass) {
    AddRequiredExtensions(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME);
    AddOptionalExtensions(VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME);
    ASSERT_NO_FATAL_FAILURE(InitFramework());
    const bool rp2Supported = IsExtensionsEnabled(VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME);
...
TEST_F(VkCompatibleLayerTest, RenderPassBeginIncompatibleFramebufferRenderPass) {
...
TEST_F(VkCompatibleLayerTest, RenderPassBeginLayoutsFramebufferImageUsageMismatches) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, RenderPassBeginClearOpMismatch) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, RenderPassBeginSampleLocationsInvalidIndicesEXT) {
...
TEST_F(VkLayerTest, DISABLED_InvalidSampleLocations) {
...
TEST_F(VkCompatibleLayerTest, RenderPassNextSubpassExcessive) {
...
TEST_F(VkCompatibleLayerTest, RenderPassEndBeforeFinalSubpass) {
...
TEST_F(VkCompatibleLayerTest, InvalidRenderPassEndFragmentDensityMapOffsetQCOM) {
...
TEST_F(VkCompatibleLayerTest, RenderPassDestroyWhileInUse) {
...
TEST_F(VkCompatibleLayerTest, FramebufferCreateErrors) {
...
TEST_F(VkCompatibleLayerTest, AllocDescriptorFromEmptyPool) {
...
TEST_F(VkCompatibleLayerTest, FreeDescriptorFromOneShotPool) {
    ASSERT_NO_FATAL_FAILURE(Init());
    ASSERT_NO_FATAL_FAILURE(InitRenderTarget());
...
TEST_F(VkCompatibleLayerTest, InvalidDescriptorPool) {
...
TEST_F(VkCompatibleLayerTest, InvalidDescriptorSet) {
...
TEST_F(VkCompatibleLayerTest, InvalidDescriptorSetLayout) {
...
TEST_F(VkCompatibleLayerTest, WriteDescriptorSetIntegrityCheck) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, WriteDescriptorSetIdentitySwizzle) {
...
TEST_F(VkLayerTest, DISABLED_WriteDescriptorSetConsecutiveUpdates) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_InvalidCmdBufferDescriptorSetBufferDestroyed) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_InvalidDrawDescriptorSetBufferDestroyed) {
...
TEST_F(VkLayerTest, DISABLED_InvalidCmdBufferDescriptorSetImageSamplerDestroyed) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_InvalidDescriptorSetSamplerDestroyed) {
...
TEST_F(VkLayerTest, DISABLED_ImageDescriptorLayoutMismatch) {
...
TEST_F(VkLayerTest, DISABLED_DescriptorPoolInUseResetSignaled) {
...
TEST_F(VkLayerTest, DISABLED_DescriptorImageUpdateNoMemoryBound) {
...
TEST_F(VkCompatibleLayerTest, InvalidDynamicOffsetCases) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferUpdateNoMemoryBound) {
...
TEST_F(VkCompatibleLayerTest, InvalidDynamicDescriptorSet) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkLayerTest, DISABLED_DynamicOffsetWithNullBuffer) {
...
TEST_F(VkCompatibleLayerTest, UpdateDescriptorSetMismatchType) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkLayerTest, DISABLED_DescriptorSetCompatibility) {
...
TEST_F(VkCompatibleLayerTest, NullRenderPass) {
...
TEST_F(VkCompatibleLayerTest, EndCommandBufferWithinRenderPass) {
...
TEST_F(VkCompatibleLayerTest, DSUsageBitsErrors) {
...
TEST_F(VkCompatibleLayerTest, DSBufferInfoErrors) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DSBufferLimitErrors) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DSAspectBitsErrors) {
...
TEST_F(VkCompatibleLayerTest, DSTypeMismatch) {
...
TEST_F(VkCompatibleLayerTest, DSUpdateOutOfBounds) {
...
TEST_F(VkCompatibleLayerTest, InvalidDSUpdateIndex) {
...
TEST_F(VkCompatibleLayerTest, DSUpdateEmptyBinding) {
...
TEST_F(VkCompatibleLayerTest, InvalidDSUpdateStruct) {
...
TEST_F(VkCompatibleLayerTest, SampleDescriptorUpdateError) {
...
TEST_F(VkCompatibleLayerTest, ImageViewDescriptorUpdateError) {
...
TEST_F(VkCompatibleLayerTest, InputAttachmentDescriptorUpdateError) {
    ASSERT_NO_FATAL_FAILURE(Init());
    OneOffDescriptorSet descriptor_set(m_device,
                                       {
                                           {0, VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT, 1, VK_SHADER_STAGE_FRAGMENT_BIT, nullptr},
...
TEST_F(VkCompatibleLayerTest, CopyDescriptorUpdateErrors) {
...
TEST_F(VkCompatibleLayerTest, DrawWithPipelineIncompatibleWithRenderPass) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DrawWithPipelineIncompatibleWithRenderPassFragmentDensityMap) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DrawWithPipelineIncompatibleWithRenderPassMultiview) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, Maint1BindingSliceOf3DImage) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, UpdateDestroyDescriptorSetLayout) {
...
TEST_F(VkCompatibleLayerTest, FramebufferIncompatible) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, RenderPassMissingAttachment) {
...
TEST_F(VkCompatibleLayerTest, AttachmentDescriptionUndefinedFormat) {
...
TEST_F(VkCompatibleLayerTest, InvalidCreateDescriptorPool) {
...
TEST_F(VkCompatibleLayerTest, DuplicateDescriptorBinding) {
...
TEST_F(VkCompatibleLayerTest, InvalidPushDescriptorSetLayout) {
...
TEST_F(VkCompatibleLayerTest, InvalidPushDescriptorImageLayout) {
...
TEST_F(VkCompatibleLayerTest, PushDescriptorSetLayoutWithoutExtension) {
...
TEST_F(VkLayerTest, DISABLED_DescriptorIndexingSetLayoutWithoutExtension) {
...
TEST_F(VkCompatibleLayerTest, DescriptorIndexingSetLayout) {
...
TEST_F(VkCompatibleLayerTest, DescriptorIndexingUpdateAfterBind) {
...
TEST_F(VkCompatibleLayerTest, DescriptorIndexingSetNonIdenticalWrite) {
...
TEST_F(VkCompatibleLayerTest, AllocatePushDescriptorSet) {
...
TEST_F(VkLayerTest, DISABLED_CreateDescriptorUpdateTemplate) {
...
TEST_F(VkCompatibleLayerTest, InlineUniformBlockEXT) {
...
TEST_F(VkCompatibleLayerTest, InlineUniformBlockEXTFeature) {
...
TEST_F(VkCompatibleLayerTest, WrongdstArrayElement) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, DescriptorSetLayoutMisc) {
...
TEST_F(VkCompatibleLayerTest, NullDescriptorsDisabled) {
    ASSERT_NO_FATAL_FAILURE(InitFramework(m_errorMonitor));
...
TEST_F(VkCompatibleLayerTest, NullDescriptorsEnabled) {
    AddRequiredExtensions(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME);
...
TEST_F(VkCompatibleRenderPassCreatePotentialFormatFeaturesTest, Core) {
    TEST_DESCRIPTION("Validate PotentialFormatFeatures in renderpass create");

    Test(false);
}

TEST_F(VkCompatibleRenderPassCreatePotentialFormatFeaturesTest, LinearColorAttachment) {
    TEST_DESCRIPTION("Validate PotentialFormatFeatures in renderpass create with linearColorAttachment");

    Test(true);
}

TEST_F(VkLayerTest, DISABLED_SubpassInputNotBoundDescriptorSet) {
...
TEST_F(VkLayerTest, DISABLED_ImageSubresourceOverlapBetweenAttachmentsAndDescriptorSets) {
...
TEST_F(VkCompatibleLayerTest, InvalidFragmentShadingRateFramebufferUsage) {
...
TEST_F(VkCompatibleLayerTest, InvalidFragmentShadingRateFramebufferDimensions) {
...
TEST_F(VkCompatibleLayerTest, InvalidFragmentShadingRateAttachments) {
    TEST_DESCRIPTION("Specify a fragment shading rate attachment with too small dimensions");
...
TEST_F(VkCompatibleLayerTest, FramebufferDepthStencilResolveAttachmentTests) {
...
TEST_F(VkCompatibleLayerTest, DepthStencilResolveMode) {
...
TEST_F(VkCompatibleLayerTest, RenderPassCreateInvalidInputAttachmentLayout) {
...
TEST_F(VkCompatibleLayerTest, RenderPassMultiViewCreateInvalidViewMasks) {
...
TEST_F(VkCompatibleLayerTest, InvalidCreateDescriptorPoolFlags) {
...
TEST_F(VkCompatibleLayerTest, MissingMutableDescriptorTypeFeature) {
...
TEST_F(VkCompatibleLayerTest, MutableDescriptorPoolsWithPartialOverlap) {
...
TEST_F(VkCompatibleLayerTest, InvalidCreateDescriptorPoolAllocateFlags) {
    TEST_DESCRIPTION("Create descriptor pool with invalid flags.");
...
TEST_F(VkLayerTest, DISABLED_InvalidRenderArea) {
...
TEST_F(VkCompatibleLayerTest, InvalidCmdNextSubpassDuringTransformFeedback) {
...
TEST_F(VkCompatibleLayerTest, SwapchainAcquireImageRetired) {
...
TEST_F(VkCompatibleLayerTest, InvalidDeviceGroupRenderArea) {
...
TEST_F(VkCompatibleLayerTest, RenderPassBeginNullValues) {
...
TEST_F(VkCompatibleLayerTest, DepthStencilResolveAttachmentInvalidFormat) {
...
TEST_F(VkCompatibleLayerTest, DescriptorUpdateOfMultipleBindingWithOneUpdateCall) {
...
TEST_F(VkCompatibleLayerTest, InvalidWriteMutableDescriptorSet) {
...
TEST_F(VkCompatibleLayerTest, MutableDescriptors) {
...
TEST_F(VkCompatibleLayerTest, DescriptorUpdateTemplate) {
...
TEST_F(VkCompatibleLayerTest, MutableDescriptorSetLayout) {
...
TEST_F(VkCompatibleLayerTest, MutableDescriptorSetLayoutMissingFeature) {
...
TEST_F(VkLayerTest, DISABLED_ImageSubresourceOverlapBetweenRenderPassAndDescriptorSets) {
...
TEST_F(VkLayerTest, DISABLED_TestDescriptorReadFromWriteAttachment) {
...
TEST_F(VkLayerTest, DISABLED_TestDescriptorWriteFromReadAttachment) {
...
TEST_F(VkCompatibleLayerTest, RenderPassMultiViewCreateInvalidViewOffsets) {
...
TEST_F(VkCompatibleLayerTest, RenderPassMultiViewCreateInvalidViewMask) {
...
TEST_F(VkCompatibleLayerTest, InvalidRenderPassAttachmentFormat) {
...
TEST_F(VkCompatibleLayerTest, SamplingFromReadOnlyDepthStencilAttachment) {
...
TEST_F(VkCompatibleLayerTest, TestColorAttachmentImageViewUsage) {
...
TEST_F(VkCompatibleLayerTest, CreateRenderPassWithInvalidStencilLoadOp) {
...
TEST_F(VkCompatibleLayerTest, CreateRenderPassWithViewMask) {
...
TEST_F(VkCompatibleLayerTest, InvalidSubpassDescriptionViewMask) {
...
TEST_F(VkCompatibleLayerTest, TestAllocatingVariableDescriptorSets) {
...
TEST_F(VkCompatibleLayerTest, TestPipelineSubpassIndex) {
...
TEST_F(VkCompatibleLayerTest, TestAllViewMasksZero) {
...
TEST_F(VkCompatibleLayerTest, FragmentDensityMappAttachmentCount) {
...
TEST_F(VkCompatibleLayerTest, InvalidRenderPassAttachmentUndefinedLayout) {
...
TEST_F(VkCompatibleLayerTest, ImagelessFramebufferWith3DImage) {
...
TEST_F(VkCompatibleLayerTest, MultisampledRenderToSingleSampled) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferSetLayout) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferNotEnabled) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferBindingAndOffsets) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferInconsistentBuffer) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferInconsistentSet) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferInvalidBindPoint) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferDescriptorGetInfo) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferVarious) {
...
TEST_F(VkCompatibleLayerTest, InvalidDescriptorSetLayoutBindings) {
...
TEST_F(VkCompatibleLayerTest, InvalidDescriptorSetLayoutBinding) {
...
TEST_F(VkCompatibleLayerTest, TestBindingDescriptorSetFromHostOnlyPool) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, CopyMutableDescriptors) {
...
TEST_F(VkCompatibleLayerTest, ValidateUpdatingMutableDescriptors) {
...
TEST_F(VkCompatibleLayerTest, DescriptorBufferInvalidExtensionCombination) {
...
TEST_F(VkCompatibleLayerTest, IgnoreSubpassDependencyMasksSync2) {
