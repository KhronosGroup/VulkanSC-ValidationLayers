...
TEST_F(VkCompatibleLayerTest, InvalidCommandPoolConsistency) {
...
TEST_F(VkCompatibleLayerTest, InvalidSecondaryCommandBufferBarrier) {
...
TEST_F(VkCompatibleLayerTest, DynamicDepthBiasNotBound) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DynamicLineWidthNotBound) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DynamicLineStippleNotBound) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DynamicViewportNotBound) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DynamicScissorNotBound) {
...
TEST_F(VkCompatibleLayerTest, DynamicBlendConstantsNotBound) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DynamicDepthBoundsNotBound) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DynamicStencilReadNotBound) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DynamicStencilWriteNotBound) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DynamicStencilRefNotBound) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, IndexBufferNotBound) {
...
TEST_F(VkCompatibleLayerTest, IndexBufferBadSize) {
...
TEST_F(VkCompatibleLayerTest, IndexBufferBadOffset) {
...
TEST_F(VkCompatibleLayerTest, IndexBufferBadBindSize) {
...
TEST_F(VkCompatibleLayerTest, IndexBufferBadBindOffset) {
...
TEST_F(VkCompatibleLayerTest, MissingClearAttachment) {
...
TEST_F(VkCompatibleLayerTest, SecondaryCommandbufferAsPrimary) {
...
TEST_F(VkCompatibleLayerTest, Sync2SecondaryCommandbufferAsPrimary) {
...
TEST_F(VkCompatibleLayerTest, CommandBufferTwoSubmits) {
...
TEST_F(VkCompatibleLayerTest, Sync2CommandBufferTwoSubmits) {
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME);
    ASSERT_NO_FATAL_FAILURE(InitFramework());
    if (!AreRequiredExtensionsEnabled()) {
...
TEST_F(VkCompatibleLayerTest, InvalidPushConstants) {
    ASSERT_NO_FATAL_FAILURE(Init());
    ASSERT_NO_FATAL_FAILURE(InitViewport());
    ASSERT_NO_FATAL_FAILURE(InitRenderTarget());
...
TEST_F(VkCompatibleLayerTest, NoBeginCommandBuffer) {
...
TEST_F(VkCompatibleLayerTest, SecondaryCommandBufferRerecordedExplicitReset) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, SecondaryCommandBufferRerecordedNoReset) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, CascadedInvalidation) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, CommandBufferResetErrors) {
...
TEST_F(VkCompatibleLayerTest, CommandBufferPrimaryFlags) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, ClearColorAttachmentsOutsideRenderPass) {
...
TEST_F(VkCompatibleLayerTest, ClearColorAttachmentsZeroLayercount) {
...
TEST_F(VkCompatibleLayerTest, ClearColorAttachmentsZeroExtent) {
...
TEST_F(VkCompatibleLayerTest, ClearAttachmentsInvalidAspectMasks) {
...
TEST_F(VkCompatibleLayerTest, ClearAttachmentsImplicitCheck) {
...
TEST_F(VkCompatibleLayerTest, ClearAttachmentsDepth) {
...
TEST_F(VkCompatibleLayerTest, ClearAttachmentsStencil) {
...
TEST_F(VkCompatibleLayerTest, ExecuteCommandsPrimaryCB) {
...
TEST_F(VkCompatibleLayerTest, ExecuteCommandsToSecondaryCB) {
...
TEST_F(VkCompatibleLayerTest, InvalidVertexAttributeAlignment) {
...
TEST_F(VkCompatibleLayerTest, NonSimultaneousSecondaryMarksPrimary) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, SimultaneousUseSecondaryTwoExecutes) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, SimultaneousUseSecondarySingleExecute) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, SimultaneousUseOneShot) {
...
TEST_F(VkLayerTest, DISABLED_DrawTimeImageViewTypeMismatchWithPipeline) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_DrawTimeImageMultisampleMismatchWithPipeline) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_DrawTimeImageComponentTypeMismatchWithPipeline) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_CopyImageLayerCountMismatch) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, CompressedImageMipCopyTests) {
...
TEST_F(VkCompatibleLayerTest, ImageBufferCopyTests) {
...
TEST_F(VkCompatibleLayerTest, MiscImageLayerTests) {
...
TEST_F(VkCompatibleLayerTest, CopyImageTypeExtentMismatch) {
...
TEST_F(VkCompatibleLayerTest, CopyImageTypeExtentMismatchMaintenance1) {
...
TEST_F(VkCompatibleLayerTest, CopyImageCompressedBlockAlignment) {
...
TEST_F(VkCompatibleLayerTest, CopyImageSrcSizeExceeded) {
...
TEST_F(VkCompatibleLayerTest, CopyImageDstSizeExceeded) {
...
TEST_F(VkCompatibleLayerTest, CopyImageZeroSize) {
...
TEST_F(VkCompatibleLayerTest, CopyImageMultiPlaneSizeExceeded) {
...
TEST_F(VkCompatibleLayerTest, CopyImageFormatSizeMismatch) {
...
TEST_F(VkLayerTest, DISABLED_CopyImageDepthStencilFormatMismatch) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, CopyImageSampleCountMismatch) {
...
TEST_F(VkCompatibleLayerTest, CopyImageAspectMismatch) {
...
TEST_F(VkCompatibleLayerTest, ResolveImageLowSampleCount) {
...
TEST_F(VkCompatibleLayerTest, ResolveImageHighSampleCount) {
...
TEST_F(VkCompatibleLayerTest, ResolveImageFormatMismatch) {
...
TEST_F(VkCompatibleLayerTest, ResolveImageLayoutMismatch) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, ResolveInvalidSubresource) {
    AddOptionalExtensions(VK_KHR_COPY_COMMANDS_2_EXTENSION_NAME);
    ASSERT_NO_FATAL_FAILURE(Init());
    const bool copy_commands2 = IsExtensionsEnabled(VK_KHR_COPY_COMMANDS_2_EXTENSION_NAME);
...
TEST_F(VkCompatibleLayerTest, ResolveImageImageType) {
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkCompatibleLayerTest, ResolveImageSizeExceeded) {
...
TEST_F(VkCompatibleLayerTest, ClearImageErrors) {
...
TEST_F(VkCompatibleLayerTest, CommandQueueFlags) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, DepthStencilImageCopyNoGraphicsQueueFlags) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, ImageCopyTransferQueueFlags) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, ExecuteDiffertQueueFlagsSecondaryCB) {
...
TEST_F(VkCompatibleLayerTest, ExecuteUnrecordedSecondaryCB) {
...
TEST_F(VkCompatibleLayerTest, ExecuteSecondaryCBWithLayoutMismatch) {
...
TEST_F(VkCompatibleLayerTest, SetDynViewportParamTests) {
...
TEST_F(VkCompatibleLayerTest, SetDynViewportParamMaintenance1Tests) {
...
TEST_F(VkCompatibleLayerTest, SetDynViewportParamMultiviewportTests) {
...
TEST_F(VkCompatibleLayerTest, BadRenderPassScopeSecondaryCmdBuffer) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, SecondaryCommandBufferClearColorAttachmentsRenderArea) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, PushDescriptorSetCmdPushBadArgs) {
...
TEST_F(VkCompatibleLayerTest, PushDescriptorSetCmdBufferOffsetUnaligned) {
...
TEST_F(VkCompatibleLayerTest, SetDynScissorParamTests) {
...
TEST_F(VkCompatibleLayerTest, SetDynScissorParamMultiviewportTests) {
...
TEST_F(VkCompatibleLayerTest, MultiDrawTests) {
...
TEST_F(VkCompatibleLayerTest, MultiDrawFeatures) {
...
TEST_F(VkCompatibleLayerTest, IndirectDrawTests) {
...
TEST_F(VkCompatibleLayerTest, DrawIndirectByteCountEXT) {
...
TEST_F(VkCompatibleLayerTest, DrawIndirectCountKHR) {
...
TEST_F(VkCompatibleLayerTest, DrawIndexedIndirectCountKHR) {
...
TEST_F(VkCompatibleLayerTest, DrawIndirectCountFeature) {
...
TEST_F(VkCompatibleLayerTest, ExclusiveScissorNV) {
    ...
    if (m_device->phy().properties().limits.maxViewports) {
        GTEST_SKIP() << "Device doesn't support the necessary number of viewports";
    }
...
TEST_F(VkCompatibleLayerTest, MeshShaderNV) {
...
TEST_F(VkCompatibleLayerTest, MeshShaderDisabledNV) {
...
TEST_F(VkCompatibleLayerTest, ViewportWScalingNV) {
...
TEST_F(VkCompatibleLayerTest, TransformFeedbackFeatureEnabled) {
...
TEST_F(VkCompatibleLayerTest, TransformFeedbackNoBoundPipeline) {
...
TEST_F(VkCompatibleLayerTest, TransformFeedbackCmdBindTransformFeedbackBuffersEXT) {
...
TEST_F(VkCompatibleLayerTest, TransformFeedbackCmdBeginTransformFeedbackEXT) {
...
TEST_F(VkCompatibleLayerTest, TransformFeedbackCmdEndTransformFeedbackEXT) {
...
TEST_F(VkCompatibleLayerTest, InvalidUnprotectedCommands) {
...
TEST_F(VkCompatibleLayerTest, InvalidMixingProtectedResources) {
...
TEST_F(VkCompatibleLayerTest, InvalidStorageAtomicOperation) {
    TEST_DESCRIPTION(
...
TEST_F(VkLayerTest, DISABLED_DrawWithoutUpdatePushConstants) {
...
TEST_F(VkCompatibleLayerTest, VerifyVertextBinding) {
...
TEST_F(VkCompatibleLayerTest, VerifyDynamicStateSettingCommands) {
...
TEST_F(VkCompatibleLayerTest, VerifyFilterCubicSamplerInCmdDraw) {
...
TEST_F(VkCompatibleLayerTest, VerifyImgFilterCubicSamplerInCmdDraw) {
...
TEST_F(VkCompatibleLayerTest, VerifyMaxMultiviewInstanceIndex) {
...
TEST_F(VkCompatibleLayerTest, InvalidSetFragmentShadingRateValues) {
...
TEST_F(VkCompatibleLayerTest, InvalidSetFragmentShadingRateValuesNoFeatures) {
...
TEST_F(VkCompatibleLayerTest, InvalidSetFragmentShadingRateCombinerOpsNoFeatures) {
...
TEST_F(VkCompatibleLayerTest, InvalidSetFragmentShadingRateCombinerOpsNoPipelineRate) {
...
TEST_F(VkCompatibleLayerTest, InvalidSetFragmentShadingRateCombinerOpsLimit) {
    TEST_DESCRIPTION("Specify invalid fsr pipeline settings for the enabled features");
...
TEST_F(VkCompatibleLayerTest, InvalidPrimitiveFragmentShadingRateWriteMultiViewportLimitDynamic) {
...
TEST_F(VkCompatibleLayerTest, InvalidCmdUpdateBufferSize) {
...
TEST_F(VkCompatibleLayerTest, InvalidCmdUpdateBufferDstOffset) {
...
TEST_F(VkCompatibleLayerTest, InvalidDescriptorSetPipelineBindPoint) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, CmdClearColorImageNullColor) {
...
TEST_F(VkCompatibleLayerTest, InvalidClearColorAttachmentsWithMultiview) {
...
TEST_F(VkCompatibleLayerTest, TestEndCommandBufferWithConditionalRendering) {
...
TEST_F(VkCompatibleLayerTest, ExecuteSecondaryCommandBuffersDuringTransformFeedback) {
...
TEST_F(VkCompatibleLayerTest, BindPipelineDuringTransformFeedback) {
...
TEST_F(VkCompatibleLayerTest, DrawBlendEnabledFormatFeatures) {
...
TEST_F(VkCompatibleLayerTest, InvalidEndConditionalRendering) {
...
TEST_F(VkCompatibleLayerTest, InvalidBeginTransformFeedbackInMultiviewRenderPass) {
...
TEST_F(VkCompatibleLayerTest, BadRenderPassContentsWhenCallingCmdExecuteCommandsWithBeginRenderPass) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, BadExecuteCommandsSubpassIndices) {
...
TEST_F(VkCompatibleLayerTest, IncompatibleRenderPassesInExecuteCommands) {
    TEST_DESCRIPTION("Test invalid subpass when calling CmdExecuteCommands");
...
TEST_F(VkCompatibleLayerTest, CopyCommands2V13) {
...
TEST_F(VkCompatibleLayerTest, ValidateMultiviewUnboundResourcesAfterBeginRenderPassAndNextSubpass) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, ResolveInvalidUsage) {
...
TEST_F(VkLayerTest, DISABLED_IncompatibleFragmentRateShadingAttachmentInExecuteCommands) {
    TEST_DESCRIPTION(
...
TEST_F(VkCompatibleLayerTest, CopyImageRemainingLayers) {
...
TEST_F(VkCompatibleLayerTest, MeshShaderEXTDrawCmds) {
...
%_ptr_TaskPayloadWorkgroupEXT_Task = OpTypePointer TaskPayloadWorkgroupEXT %Task
    ...
    vkCmdDrawMeshTasksEXT(m_commandBuffer->handle(), max_group_count_X, max_group_count_Y, max_group_count_Z);
    m_errorMonitor->VerifyFound();
    ...
    vkCmdDrawMeshTasksIndirectEXT(m_commandBuffer->handle(), buffer.handle(), sizeof(VkDrawMeshTasksIndirectCommandEXT) * 2, 1,
    ...
    vkCmdDrawMeshTasksIndirectEXT(m_commandBuffer->handle(), buffer.handle(), 0, 1, sizeof(VkDrawMeshTasksIndirectCommandEXT));
    m_errorMonitor->VerifyFound();
    ...
    vkCmdDrawMeshTasksIndirectCountEXT(m_commandBuffer->handle(), buffer.handle(), 0, count_buffer.handle(), 0, 1,
                                       sizeof(VkDrawMeshTasksIndirectCommandEXT));
    m_errorMonitor->VerifyFound();
...
TEST_F(VkCompatibleLayerTest, MeshShaderEXTMultiDrawIndirect) {
...
%_ptr_TaskPayloadWorkgroupEXT_Task = OpTypePointer TaskPayloadWorkgroupEXT %Task
    ...
    vkCmdDrawMeshTasksIndirectEXT(m_commandBuffer->handle(), buffer.handle(), 0, 2, sizeof(VkDrawMeshTasksIndirectCommandEXT) - 2);
    m_errorMonitor->VerifyFound();

    m_errorMonitor->SetDesiredFailureMsg(kErrorBit, "VUID-vkCmdDrawMeshTasksIndirectEXT-drawCount-07090");
    vkCmdDrawMeshTasksIndirectEXT(m_commandBuffer->handle(), buffer.handle(), 0, 4, sizeof(VkDrawMeshTasksIndirectCommandEXT));
    m_errorMonitor->VerifyFound();
    ...
    vkCmdDrawMeshTasksIndirectCountEXT(m_commandBuffer->handle(), draw_buffer.handle(), 0, count_buffer_unbound.handle(), 0, 1,
                                       sizeof(VkDrawMeshTasksIndirectCommandEXT));
    m_errorMonitor->VerifyFound();

    m_errorMonitor->SetDesiredFailureMsg(kErrorBit, "VUID-vkCmdDrawMeshTasksIndirectCountEXT-countBuffer-02715");
    vkCmdDrawMeshTasksIndirectCountEXT(m_commandBuffer->handle(), draw_buffer.handle(), 0, count_buffer_wrong_usage.handle(), 0, 1,
                                       sizeof(VkDrawMeshTasksIndirectCommandEXT));
    m_errorMonitor->VerifyFound();

    m_errorMonitor->SetDesiredFailureMsg(kErrorBit, "VUID-vkCmdDrawMeshTasksIndirectCountEXT-stride-07096");
    vkCmdDrawMeshTasksIndirectCountEXT(m_commandBuffer->handle(), draw_buffer.handle(), 0, count_buffer.handle(), 0, 1,
    ...
    vkCmdDrawMeshTasksIndirectCountEXT(m_commandBuffer->handle(), draw_buffer.handle(),
...
TEST_F(VkCompatibleLayerTest, MeshShaderNVDrawCmds) {
    ...
    vkCmdDrawMeshTasksIndirectNV(m_commandBuffer->handle(), buffer.handle(), sizeof(VkDrawMeshTasksIndirectCommandNV) * 2, 1,
    ...
    vkCmdDrawMeshTasksIndirectNV(m_commandBuffer->handle(), buffer.handle(), 0, 1, sizeof(VkDrawMeshTasksIndirectCommandNV));
    m_errorMonitor->VerifyFound();
    ...
    vkCmdDrawMeshTasksIndirectCountNV(m_commandBuffer->handle(), buffer.handle(), 0, count_buffer.handle(), 0, 1,
                                      sizeof(VkDrawMeshTasksIndirectCommandNV));
    m_errorMonitor->VerifyFound();
...
TEST_F(VkCompatibleLayerTest, EndRenderPassWithActiveTransformFeedback) {
...
TEST_F(VkCompatibleLayerTest, InvalidDepthStencilStateForReadOnlyLayout) {
...
TEST_F(VkCompatibleLayerTest, ClearColorImageWithBadRange) {
...
TEST_F(VkCompatibleLayerTest, ClearDepthStencilWithBadAspect) {
...
TEST_F(VkCompatibleLayerTest, ClearDepthStencilWithBadRange) {
...
TEST_F(VkCompatibleLayerTest, ClearColorImageWithinRenderPass) {
...
TEST_F(VkCompatibleLayerTest, ClearDepthStencilImageErrors) {
...
TEST_F(VkCompatibleLayerTest, ClearDepthRangeUnrestricted) {
...
TEST_F(VkCompatibleLayerTest, ClearColorImageInvalidImageLayout) {
