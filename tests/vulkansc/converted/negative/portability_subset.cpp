...
TEST_F(VkCompatiblePortabilitySubsetTest, ValidatePortabilityCreateDevice) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, PortabilityCreateEvent) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, CreateImage) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, CreateImageView) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, CreateSampler) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, CreateGraphicsPipelinesTriangleFans) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, CreateGraphicsPipelinesVertexInputStride) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, CreateGraphicsPipelinesVertexAttributes) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, CreateGraphicsPipelinesRasterizationState) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, CreateGraphicsPipelinesDepthStencilState) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, CreateGraphicsPipelinesColorBlendAttachmentState) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, UpdateDescriptorSets) {
...
TEST_F(VkCompatiblePortabilitySubsetTest, ShaderValidation) {
