...
TEST_F(VkCompatibleLayerTest, InvalidMemoryMapping) {
...
TEST_F(VkCompatibleLayerTest, MapMemory2) {
    TEST_DESCRIPTION("Attempt to map memory in a number of incorrect ways");
...
TEST_F(VkCompatibleLayerTest, MapMemWithoutHostVisibleBit) {
...
TEST_F(VkCompatibleLayerTest, RebindMemoryMultiObjectDebugUtils) {
    VkResult err;
    bool pass;
...
TEST_F(VkCompatibleLayerTest, QueryMemoryCommitmentWithoutLazyProperty) {
...
TEST_F(VkCompatibleLayerTest, BindImageInvalidMemoryType) {
    VkResult err;
...
TEST_F(VkLayerTest, DISABLED_BindInvalidMemory) {
    VkResult err;
    bool pass;
...
TEST_F(VkCompatibleLayerTest, BindInvalidMemoryNoCheck) {
...
TEST_F(VkCompatibleLayerTest, BindInvalidMemory2BindInfos) {
...
TEST_F(VkCompatibleLayerTest, BindMemoryToDestroyedObject) {
    VkResult err;
    bool pass;
...
TEST_F(VkCompatibleLayerTest, ExceedMemoryAllocationCount) {
...
TEST_F(VkCompatibleLayerTest, ImageMemoryNotBound) {
...
TEST_F(VkCompatibleLayerTest, BufferMemoryNotBound) {
...
TEST_F(VkCompatibleLayerTest, DedicatedAllocationBinding) {
...
TEST_F(VkCompatibleLayerTest, DedicatedAllocationImageAliasing) {
...
TEST_F(VkCompatibleLayerTest, BufferDeviceAddressEXT) {
...
TEST_F(VkCompatibleLayerTest, BufferDeviceAddressEXTDisabled) {
    TEST_DESCRIPTION("Test VK_EXT_buffer_device_address.");
    AddRequiredExtensions(VK_EXT_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME);
    ASSERT_NO_FATAL_FAILURE(InitFramework());
    if (!AreRequiredExtensionsEnabled()) {
...
TEST_F(VkCompatibleLayerTest, BufferDeviceAddressKHR) {
...
TEST_F(VkCompatibleLayerTest, BufferDeviceAddressKHRDisabled) {
    TEST_DESCRIPTION("Test VK_KHR_buffer_device_address.");
    SetTargetApiVersion(VK_API_VERSION_1_2);
    AddRequiredExtensions(VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME);
    ASSERT_NO_FATAL_FAILURE(InitFramework());
...
TEST_F(VkCompatibleLayerTest, InvalidMemoryType) {
...
TEST_F(VkCompatibleLayerTest, AllocationBeyondHeapSize) {
...
TEST_F(VkCompatibleLayerTest, DeviceCoherentMemoryDisabledAMD) {
...
TEST_F(VkCompatibleLayerTest, DedicatedAllocation) {
...
TEST_F(VkCompatibleLayerTest, InvalidMemoryRequirements) {
...
TEST_F(VkCompatibleLayerTest, InvalidMemoryAllocatepNextChain) {
...
TEST_F(VkCompatibleLayerTest, DeviceImageMemoryRequirementsSwapchain) {
...
TEST_F(VkCompatibleLayerTest, DeviceImageMemoryRequirementsDrmFormatModifier) {
    TEST_DESCRIPTION("Validate usage of VkDeviceImageMemoryRequirementsKHR.");
...
TEST_F(VkCompatibleLayerTest, DeviceImageMemoryRequirementsDisjoint) {
    TEST_DESCRIPTION("Validate usage of VkDeviceImageMemoryRequirementsKHR.");
...
TEST_F(VkCompatibleLayerTest, TestBindBufferMemoryDeviceGroup) {
