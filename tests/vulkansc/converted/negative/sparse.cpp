...
TEST_F(VkCompatibleLayerTest, SparseBindingImageBufferCreate) {
...
TEST_F(VkCompatibleLayerTest, SparseResidencyImageCreateUnsupportedTypes) {
...
TEST_F(VkCompatibleLayerTest, SparseResidencyImageCreateUnsupportedSamples) {
...
TEST_F(VkCompatibleLayerTest, SparseResidencyFlagMissing) {
...
TEST_F(VkCompatibleLayerTest, InvalidSparseImageUsageBits) {
...
TEST_F(VkCompatibleLayerTest, SparseMemoryBindOffset) {
...
TEST_F(VkCompatibleLayerTest, InvalidQueueBindSparseMemoryType) {
...
TEST_F(VkCompatibleLayerTest, QueueBindSparseInvalidSparseMemoryBindSize) {
...
TEST_F(VkCompatibleLayerTest, QueueBindSparseInvalidSparseMemoryBindResourceOffset) {
...
TEST_F(VkCompatibleLayerTest, QueueBindSparseInvalidSparseMemoryBindSizeResourceOffset) {
...
TEST_F(VkCompatibleLayerTest, QueueBindSparseInvalidSparseMemoryBindSizeMemoryOffset) {
...
TEST_F(VkCompatibleLayerTest, InvalidVkSparseImageMemoryBind) {
...
TEST_F(VkCompatibleLayerTest, OverlappingSparseBufferCopy) {
