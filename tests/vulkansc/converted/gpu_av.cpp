...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuValidationArrayOOBGraphicsShaders) {
    TEST_DESCRIPTION(
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuValidationArrayEarlyDelete) {
    TEST_DESCRIPTION(
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuValidationArrayEarlySamplerDelete) {
    TEST_DESCRIPTION(
        "GPU validation: Verify detection descriptors where resources have been deleted while in use.");
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuRobustBufferOOB) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DISABLED_GpuBufferOOB) {
    AddRequiredExtensions(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME);
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DrawTimeShaderUniformBufferTooSmall) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DrawTimeShaderStorageBufferTooSmall) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DrawTimeShaderUniformBufferTooSmallArray) {
    TEST_DESCRIPTION(
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DrawTimeShaderUniformBufferTooSmallNestedStruct) {
    TEST_DESCRIPTION(
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DISABLED_GpuBufferDeviceAddressOOB) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuDrawIndirectCountDeviceLimit) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuDrawIndexedIndirectCountDeviceLimitSubmit2) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuDrawIndirectCount) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuDrawMeshIndirect) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuDrawIndirectFirstInstance) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuValidationInlineUniformBlockAndMiscGpu) {
    TEST_DESCRIPTION(
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuValidationAbort) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_ValidationFeatures) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DrawingWithUnboundUnusedSet) {
    TEST_DESCRIPTION(
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DispatchIndirectWorkgroupSize) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuBufferOOBGPL) {
    AddRequiredExtensions(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_ROBUSTNESS_2_EXTENSION_NAME);
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_GpuBufferOOBGPLIndependentSets) {
    AddRequiredExtensions(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_ROBUSTNESS_2_EXTENSION_NAME);
    AddRequiredExtensions(VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME);
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DrawTimeShaderObjectUniformBufferTooSmall) {
    TEST_DESCRIPTION("Test that an error is produced when trying to access uniform buffer outside the bound region.");
    char const *fsSource = R"glsl(
        #version 450
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DispatchIndirectWorkgroupSizeShaderObjects) {
    TEST_DESCRIPTION("GPU validation: Validate VkDispatchIndirectCommand");
    AddRequiredExtensions(VK_EXT_SHADER_OBJECT_EXTENSION_NAME);
    RETURN_IF_SKIP(InitGpuAvFramework());
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_SelectInstrumentedShaders) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_ImageArrayDynamicIndexing) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DISABLED_InvalidAtomicStorageOperation) {
    TEST_DESCRIPTION(
...
// https://github.com/KhronosGroup/Vulkan-ValidationLayers/issues/6944
TEST_F(VkGpuAssistedLayerTest, DISABLED_DISABLED_UnnormalizedCoordinatesInBoundsAccess) {
...
// TODO: The SPIRV-Tools instrumentation doesn't work correctly for this shader
// https://github.com/KhronosGroup/Vulkan-ValidationLayers/issues/6944
TEST_F(VkGpuAssistedLayerTest, DISABLED_DISABLED_UnnormalizedCoordinatesCopyObject) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_UnnormalizedCoordinatesSeparateSamplerSharedSampler) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DISABLED_YcbcrDrawFetchIndexed) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_UpdateAfterBind) {
...
TEST_F(VkGpuAssistedLayerTest, DISABLED_DrawTimeImageViewTypeMismatchWithPipelineUpdateAfterBind) {
    TEST_DESCRIPTION(
