...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_SelectInstrumentedShadersRegex) {
    TEST_DESCRIPTION(
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_SelectInstrumentedShadersShaderObject) {
    TEST_DESCRIPTION("GPU validation: Validate selection of which shaders get instrumented for GPU-AV");
    SetTargetApiVersion(VK_API_VERSION_1_2);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_UseAllDescriptorSlotsPipelineReserved) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_ForceUniformAndStorageBuffer8BitAccess) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_UseAllDescriptorSlotsPipelineLayout) {
    SetTargetApiVersion(VK_API_VERSION_1_1);
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_RemoveGpuAvInPresenceOfSyncVal) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_BadDestroy) {
    TEST_DESCRIPTION(
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_LeakedResource) {
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_ValidationAbortAndLeakedResource) {
    // GPU Shader Instrumentation requires Vulkan 1.1 or later
    SetTargetApiVersion(VK_API_VERSION_1_0);
    VkValidationFeaturesEXT validation_features = GetGpuAvValidationFeatures();
    RETURN_IF_SKIP(InitFramework(&validation_features));
...
// Not supported in Vulkan SC: GPU AV
TEST_F(NegativeGpuAV, DISABLED_LeakDeviceMemory) {
    RETURN_IF_SKIP(InitGpuAvFramework());
    RETURN_IF_SKIP(InitState());
