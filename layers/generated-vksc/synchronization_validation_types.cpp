...
const std::map<VkAccessFlags2KHR, SyncStageAccessFlags> syncStageAccessMaskByAccessBit {
    ...
    { VK_ACCESS_2_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT, SYNC_DRAW_INDIRECT_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT},
    { VK_ACCESS_2_SHADER_SAMPLED_READ_BIT_KHR, (
        SYNC_VERTEX_SHADER_SHADER_SAMPLED_READ_BIT |
        SYNC_TESSELLATION_CONTROL_SHADER_SHADER_SAMPLED_READ_BIT |
        SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_SAMPLED_READ_BIT |
...
const std::map<VkPipelineStageFlags2KHR, int> syncStageOrder {
    ...
    { VK_PIPELINE_STAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR, 8},
    { VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT_KHR, 9},
    { VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT_KHR, 10},
    { VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT_KHR, 11},
    { VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR, 12},
    { VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT_KHR, 13},
    { VK_PIPELINE_STAGE_2_COPY_BIT_KHR, 14},
    { VK_PIPELINE_STAGE_2_RESOLVE_BIT_KHR, 15},
    { VK_PIPELINE_STAGE_2_BLIT_BIT_KHR, 16},
    { VK_PIPELINE_STAGE_2_CLEAR_BIT_KHR, 17},
    { VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT_KHR, 18},
    { VK_PIPELINE_STAGE_2_HOST_BIT_KHR, 19},
};
