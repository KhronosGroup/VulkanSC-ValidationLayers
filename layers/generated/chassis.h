...
class ValidationObject {
    public:
        ...
        std::vector<ValidationObject*> disp_pre_val_GetDeviceQueue;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceQueue;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceQueue;
        std::vector<ValidationObject*> disp_pre_val_QueueSubmit;
        std::vector<ValidationObject*> disp_pre_rec_QueueSubmit;
        std::vector<ValidationObject*> disp_post_rec_QueueSubmit;
        std::vector<ValidationObject*> disp_pre_val_QueueWaitIdle;
        std::vector<ValidationObject*> disp_pre_rec_QueueWaitIdle;
        std::vector<ValidationObject*> disp_post_rec_QueueWaitIdle;
        std::vector<ValidationObject*> disp_pre_val_DeviceWaitIdle;
        std::vector<ValidationObject*> disp_pre_rec_DeviceWaitIdle;
        std::vector<ValidationObject*> disp_post_rec_DeviceWaitIdle;
        std::vector<ValidationObject*> disp_pre_val_AllocateMemory;
        std::vector<ValidationObject*> disp_pre_rec_AllocateMemory;
        std::vector<ValidationObject*> disp_post_rec_AllocateMemory;
        std::vector<ValidationObject*> disp_pre_val_FreeMemory;
        std::vector<ValidationObject*> disp_pre_rec_FreeMemory;
        std::vector<ValidationObject*> disp_post_rec_FreeMemory;
        std::vector<ValidationObject*> disp_pre_val_MapMemory;
        std::vector<ValidationObject*> disp_pre_rec_MapMemory;
        std::vector<ValidationObject*> disp_post_rec_MapMemory;
        std::vector<ValidationObject*> disp_pre_val_UnmapMemory;
        std::vector<ValidationObject*> disp_pre_rec_UnmapMemory;
        std::vector<ValidationObject*> disp_post_rec_UnmapMemory;
        std::vector<ValidationObject*> disp_pre_val_FlushMappedMemoryRanges;
        std::vector<ValidationObject*> disp_pre_rec_FlushMappedMemoryRanges;
        std::vector<ValidationObject*> disp_post_rec_FlushMappedMemoryRanges;
        std::vector<ValidationObject*> disp_pre_val_InvalidateMappedMemoryRanges;
        std::vector<ValidationObject*> disp_pre_rec_InvalidateMappedMemoryRanges;
        std::vector<ValidationObject*> disp_post_rec_InvalidateMappedMemoryRanges;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceMemoryCommitment;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceMemoryCommitment;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceMemoryCommitment;
        std::vector<ValidationObject*> disp_pre_val_BindBufferMemory;
        std::vector<ValidationObject*> disp_pre_rec_BindBufferMemory;
        std::vector<ValidationObject*> disp_post_rec_BindBufferMemory;
        std::vector<ValidationObject*> disp_pre_val_BindImageMemory;
        std::vector<ValidationObject*> disp_pre_rec_BindImageMemory;
        std::vector<ValidationObject*> disp_post_rec_BindImageMemory;
        std::vector<ValidationObject*> disp_pre_val_GetBufferMemoryRequirements;
        std::vector<ValidationObject*> disp_pre_rec_GetBufferMemoryRequirements;
        std::vector<ValidationObject*> disp_post_rec_GetBufferMemoryRequirements;
        std::vector<ValidationObject*> disp_pre_val_GetImageMemoryRequirements;
        std::vector<ValidationObject*> disp_pre_rec_GetImageMemoryRequirements;
        std::vector<ValidationObject*> disp_post_rec_GetImageMemoryRequirements;
        std::vector<ValidationObject*> disp_pre_val_GetImageSparseMemoryRequirements;
        std::vector<ValidationObject*> disp_pre_rec_GetImageSparseMemoryRequirements;
        std::vector<ValidationObject*> disp_post_rec_GetImageSparseMemoryRequirements;
        std::vector<ValidationObject*> disp_pre_val_QueueBindSparse;
        std::vector<ValidationObject*> disp_pre_rec_QueueBindSparse;
        std::vector<ValidationObject*> disp_post_rec_QueueBindSparse;
        std::vector<ValidationObject*> disp_pre_val_CreateFence;
        std::vector<ValidationObject*> disp_pre_rec_CreateFence;
        std::vector<ValidationObject*> disp_post_rec_CreateFence;
        std::vector<ValidationObject*> disp_pre_val_DestroyFence;
        std::vector<ValidationObject*> disp_pre_rec_DestroyFence;
        std::vector<ValidationObject*> disp_post_rec_DestroyFence;
        std::vector<ValidationObject*> disp_pre_val_ResetFences;
        std::vector<ValidationObject*> disp_pre_rec_ResetFences;
        std::vector<ValidationObject*> disp_post_rec_ResetFences;
        std::vector<ValidationObject*> disp_pre_val_GetFenceStatus;
        std::vector<ValidationObject*> disp_pre_rec_GetFenceStatus;
        std::vector<ValidationObject*> disp_post_rec_GetFenceStatus;
        std::vector<ValidationObject*> disp_pre_val_WaitForFences;
        std::vector<ValidationObject*> disp_pre_rec_WaitForFences;
        std::vector<ValidationObject*> disp_post_rec_WaitForFences;
        std::vector<ValidationObject*> disp_pre_val_CreateSemaphore;
        std::vector<ValidationObject*> disp_pre_rec_CreateSemaphore;
        std::vector<ValidationObject*> disp_post_rec_CreateSemaphore;
        std::vector<ValidationObject*> disp_pre_val_DestroySemaphore;
        std::vector<ValidationObject*> disp_pre_rec_DestroySemaphore;
        std::vector<ValidationObject*> disp_post_rec_DestroySemaphore;
        std::vector<ValidationObject*> disp_pre_val_CreateEvent;
        std::vector<ValidationObject*> disp_pre_rec_CreateEvent;
        std::vector<ValidationObject*> disp_post_rec_CreateEvent;
        std::vector<ValidationObject*> disp_pre_val_DestroyEvent;
        std::vector<ValidationObject*> disp_pre_rec_DestroyEvent;
        std::vector<ValidationObject*> disp_post_rec_DestroyEvent;
        std::vector<ValidationObject*> disp_pre_val_GetEventStatus;
        std::vector<ValidationObject*> disp_pre_rec_GetEventStatus;
        std::vector<ValidationObject*> disp_post_rec_GetEventStatus;
        std::vector<ValidationObject*> disp_pre_val_SetEvent;
        std::vector<ValidationObject*> disp_pre_rec_SetEvent;
        std::vector<ValidationObject*> disp_post_rec_SetEvent;
        std::vector<ValidationObject*> disp_pre_val_ResetEvent;
        std::vector<ValidationObject*> disp_pre_rec_ResetEvent;
        std::vector<ValidationObject*> disp_post_rec_ResetEvent;
        std::vector<ValidationObject*> disp_pre_val_CreateQueryPool;
        std::vector<ValidationObject*> disp_pre_rec_CreateQueryPool;
        std::vector<ValidationObject*> disp_post_rec_CreateQueryPool;
        std::vector<ValidationObject*> disp_pre_val_DestroyQueryPool;
        std::vector<ValidationObject*> disp_pre_rec_DestroyQueryPool;
        std::vector<ValidationObject*> disp_post_rec_DestroyQueryPool;
        std::vector<ValidationObject*> disp_pre_val_GetQueryPoolResults;
        std::vector<ValidationObject*> disp_pre_rec_GetQueryPoolResults;
        std::vector<ValidationObject*> disp_post_rec_GetQueryPoolResults;
        std::vector<ValidationObject*> disp_pre_val_DestroyBuffer;
        std::vector<ValidationObject*> disp_pre_rec_DestroyBuffer;
        std::vector<ValidationObject*> disp_post_rec_DestroyBuffer;
        std::vector<ValidationObject*> disp_pre_val_CreateBufferView;
        std::vector<ValidationObject*> disp_pre_rec_CreateBufferView;
        std::vector<ValidationObject*> disp_post_rec_CreateBufferView;
        std::vector<ValidationObject*> disp_pre_val_DestroyBufferView;
        std::vector<ValidationObject*> disp_pre_rec_DestroyBufferView;
        std::vector<ValidationObject*> disp_post_rec_DestroyBufferView;
        std::vector<ValidationObject*> disp_pre_val_CreateImage;
        std::vector<ValidationObject*> disp_pre_rec_CreateImage;
        std::vector<ValidationObject*> disp_post_rec_CreateImage;
        std::vector<ValidationObject*> disp_pre_val_DestroyImage;
        std::vector<ValidationObject*> disp_pre_rec_DestroyImage;
        std::vector<ValidationObject*> disp_post_rec_DestroyImage;
        std::vector<ValidationObject*> disp_pre_val_GetImageSubresourceLayout;
        std::vector<ValidationObject*> disp_pre_rec_GetImageSubresourceLayout;
        std::vector<ValidationObject*> disp_post_rec_GetImageSubresourceLayout;
        std::vector<ValidationObject*> disp_pre_val_CreateImageView;
        std::vector<ValidationObject*> disp_pre_rec_CreateImageView;
        std::vector<ValidationObject*> disp_post_rec_CreateImageView;
        std::vector<ValidationObject*> disp_pre_val_DestroyImageView;
        std::vector<ValidationObject*> disp_pre_rec_DestroyImageView;
        std::vector<ValidationObject*> disp_post_rec_DestroyImageView;
        std::vector<ValidationObject*> disp_pre_val_DestroyShaderModule;
        std::vector<ValidationObject*> disp_pre_rec_DestroyShaderModule;
        std::vector<ValidationObject*> disp_post_rec_DestroyShaderModule;
        std::vector<ValidationObject*> disp_pre_val_CreatePipelineCache;
        std::vector<ValidationObject*> disp_pre_rec_CreatePipelineCache;
        std::vector<ValidationObject*> disp_post_rec_CreatePipelineCache;
        std::vector<ValidationObject*> disp_pre_val_DestroyPipelineCache;
        std::vector<ValidationObject*> disp_pre_rec_DestroyPipelineCache;
        std::vector<ValidationObject*> disp_post_rec_DestroyPipelineCache;
        std::vector<ValidationObject*> disp_pre_val_GetPipelineCacheData;
        std::vector<ValidationObject*> disp_pre_rec_GetPipelineCacheData;
        std::vector<ValidationObject*> disp_post_rec_GetPipelineCacheData;
        std::vector<ValidationObject*> disp_pre_val_MergePipelineCaches;
        std::vector<ValidationObject*> disp_pre_rec_MergePipelineCaches;
        std::vector<ValidationObject*> disp_post_rec_MergePipelineCaches;
        std::vector<ValidationObject*> disp_pre_val_DestroyPipeline;
        std::vector<ValidationObject*> disp_pre_rec_DestroyPipeline;
        std::vector<ValidationObject*> disp_post_rec_DestroyPipeline;
        std::vector<ValidationObject*> disp_pre_val_DestroyPipelineLayout;
        std::vector<ValidationObject*> disp_pre_rec_DestroyPipelineLayout;
        std::vector<ValidationObject*> disp_post_rec_DestroyPipelineLayout;
        std::vector<ValidationObject*> disp_pre_val_CreateSampler;
        std::vector<ValidationObject*> disp_pre_rec_CreateSampler;
        std::vector<ValidationObject*> disp_post_rec_CreateSampler;
        std::vector<ValidationObject*> disp_pre_val_DestroySampler;
        std::vector<ValidationObject*> disp_pre_rec_DestroySampler;
        std::vector<ValidationObject*> disp_post_rec_DestroySampler;
        std::vector<ValidationObject*> disp_pre_val_CreateDescriptorSetLayout;
        std::vector<ValidationObject*> disp_pre_rec_CreateDescriptorSetLayout;
        std::vector<ValidationObject*> disp_post_rec_CreateDescriptorSetLayout;
        std::vector<ValidationObject*> disp_pre_val_DestroyDescriptorSetLayout;
        std::vector<ValidationObject*> disp_pre_rec_DestroyDescriptorSetLayout;
        std::vector<ValidationObject*> disp_post_rec_DestroyDescriptorSetLayout;
        std::vector<ValidationObject*> disp_pre_val_CreateDescriptorPool;
        std::vector<ValidationObject*> disp_pre_rec_CreateDescriptorPool;
        std::vector<ValidationObject*> disp_post_rec_CreateDescriptorPool;
        std::vector<ValidationObject*> disp_pre_val_DestroyDescriptorPool;
        std::vector<ValidationObject*> disp_pre_rec_DestroyDescriptorPool;
        std::vector<ValidationObject*> disp_post_rec_DestroyDescriptorPool;
        std::vector<ValidationObject*> disp_pre_val_ResetDescriptorPool;
        std::vector<ValidationObject*> disp_pre_rec_ResetDescriptorPool;
        std::vector<ValidationObject*> disp_post_rec_ResetDescriptorPool;
        std::vector<ValidationObject*> disp_pre_val_FreeDescriptorSets;
        std::vector<ValidationObject*> disp_pre_rec_FreeDescriptorSets;
        std::vector<ValidationObject*> disp_post_rec_FreeDescriptorSets;
        std::vector<ValidationObject*> disp_pre_val_UpdateDescriptorSets;
        std::vector<ValidationObject*> disp_pre_rec_UpdateDescriptorSets;
        std::vector<ValidationObject*> disp_post_rec_UpdateDescriptorSets;
        std::vector<ValidationObject*> disp_pre_val_CreateFramebuffer;
        std::vector<ValidationObject*> disp_pre_rec_CreateFramebuffer;
        std::vector<ValidationObject*> disp_post_rec_CreateFramebuffer;
        std::vector<ValidationObject*> disp_pre_val_DestroyFramebuffer;
        std::vector<ValidationObject*> disp_pre_rec_DestroyFramebuffer;
        std::vector<ValidationObject*> disp_post_rec_DestroyFramebuffer;
        std::vector<ValidationObject*> disp_pre_val_CreateRenderPass;
        std::vector<ValidationObject*> disp_pre_rec_CreateRenderPass;
        std::vector<ValidationObject*> disp_post_rec_CreateRenderPass;
        std::vector<ValidationObject*> disp_pre_val_DestroyRenderPass;
        std::vector<ValidationObject*> disp_pre_rec_DestroyRenderPass;
        std::vector<ValidationObject*> disp_post_rec_DestroyRenderPass;
        std::vector<ValidationObject*> disp_pre_val_GetRenderAreaGranularity;
        std::vector<ValidationObject*> disp_pre_rec_GetRenderAreaGranularity;
        std::vector<ValidationObject*> disp_post_rec_GetRenderAreaGranularity;
        std::vector<ValidationObject*> disp_pre_val_CreateCommandPool;
        std::vector<ValidationObject*> disp_pre_rec_CreateCommandPool;
        std::vector<ValidationObject*> disp_post_rec_CreateCommandPool;
        std::vector<ValidationObject*> disp_pre_val_DestroyCommandPool;
        std::vector<ValidationObject*> disp_pre_rec_DestroyCommandPool;
        std::vector<ValidationObject*> disp_post_rec_DestroyCommandPool;
        std::vector<ValidationObject*> disp_pre_val_ResetCommandPool;
        std::vector<ValidationObject*> disp_pre_rec_ResetCommandPool;
        std::vector<ValidationObject*> disp_post_rec_ResetCommandPool;
        std::vector<ValidationObject*> disp_pre_val_AllocateCommandBuffers;
        std::vector<ValidationObject*> disp_pre_rec_AllocateCommandBuffers;
        std::vector<ValidationObject*> disp_post_rec_AllocateCommandBuffers;
        std::vector<ValidationObject*> disp_pre_val_FreeCommandBuffers;
        std::vector<ValidationObject*> disp_pre_rec_FreeCommandBuffers;
        std::vector<ValidationObject*> disp_post_rec_FreeCommandBuffers;
        std::vector<ValidationObject*> disp_pre_val_BeginCommandBuffer;
        std::vector<ValidationObject*> disp_pre_rec_BeginCommandBuffer;
        std::vector<ValidationObject*> disp_post_rec_BeginCommandBuffer;
        std::vector<ValidationObject*> disp_pre_val_EndCommandBuffer;
        std::vector<ValidationObject*> disp_pre_rec_EndCommandBuffer;
        std::vector<ValidationObject*> disp_post_rec_EndCommandBuffer;
        std::vector<ValidationObject*> disp_pre_val_ResetCommandBuffer;
        std::vector<ValidationObject*> disp_pre_rec_ResetCommandBuffer;
        std::vector<ValidationObject*> disp_post_rec_ResetCommandBuffer;
        std::vector<ValidationObject*> disp_pre_val_CmdBindPipeline;
        std::vector<ValidationObject*> disp_pre_rec_CmdBindPipeline;
        std::vector<ValidationObject*> disp_post_rec_CmdBindPipeline;
        std::vector<ValidationObject*> disp_pre_val_CmdSetViewport;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetViewport;
        std::vector<ValidationObject*> disp_post_rec_CmdSetViewport;
        std::vector<ValidationObject*> disp_pre_val_CmdSetScissor;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetScissor;
        std::vector<ValidationObject*> disp_post_rec_CmdSetScissor;
        std::vector<ValidationObject*> disp_pre_val_CmdSetLineWidth;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetLineWidth;
        std::vector<ValidationObject*> disp_post_rec_CmdSetLineWidth;
        std::vector<ValidationObject*> disp_pre_val_CmdSetDepthBias;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetDepthBias;
        std::vector<ValidationObject*> disp_post_rec_CmdSetDepthBias;
        std::vector<ValidationObject*> disp_pre_val_CmdSetBlendConstants;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetBlendConstants;
        std::vector<ValidationObject*> disp_post_rec_CmdSetBlendConstants;
        std::vector<ValidationObject*> disp_pre_val_CmdSetDepthBounds;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetDepthBounds;
        std::vector<ValidationObject*> disp_post_rec_CmdSetDepthBounds;
        std::vector<ValidationObject*> disp_pre_val_CmdSetStencilCompareMask;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetStencilCompareMask;
        std::vector<ValidationObject*> disp_post_rec_CmdSetStencilCompareMask;
        std::vector<ValidationObject*> disp_pre_val_CmdSetStencilWriteMask;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetStencilWriteMask;
        std::vector<ValidationObject*> disp_post_rec_CmdSetStencilWriteMask;
        std::vector<ValidationObject*> disp_pre_val_CmdSetStencilReference;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetStencilReference;
        std::vector<ValidationObject*> disp_post_rec_CmdSetStencilReference;
        std::vector<ValidationObject*> disp_pre_val_CmdBindDescriptorSets;
        std::vector<ValidationObject*> disp_pre_rec_CmdBindDescriptorSets;
        std::vector<ValidationObject*> disp_post_rec_CmdBindDescriptorSets;
        std::vector<ValidationObject*> disp_pre_val_CmdBindIndexBuffer;
        std::vector<ValidationObject*> disp_pre_rec_CmdBindIndexBuffer;
        std::vector<ValidationObject*> disp_post_rec_CmdBindIndexBuffer;
        std::vector<ValidationObject*> disp_pre_val_CmdBindVertexBuffers;
        std::vector<ValidationObject*> disp_pre_rec_CmdBindVertexBuffers;
        std::vector<ValidationObject*> disp_post_rec_CmdBindVertexBuffers;
        std::vector<ValidationObject*> disp_pre_val_CmdDraw;
        std::vector<ValidationObject*> disp_pre_rec_CmdDraw;
        std::vector<ValidationObject*> disp_post_rec_CmdDraw;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndexed;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndexed;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndexed;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndirect;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndirect;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndirect;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndexedIndirect;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndexedIndirect;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndexedIndirect;
        std::vector<ValidationObject*> disp_pre_val_CmdDispatch;
        std::vector<ValidationObject*> disp_pre_rec_CmdDispatch;
        std::vector<ValidationObject*> disp_post_rec_CmdDispatch;
        std::vector<ValidationObject*> disp_pre_val_CmdDispatchIndirect;
        std::vector<ValidationObject*> disp_pre_rec_CmdDispatchIndirect;
        std::vector<ValidationObject*> disp_post_rec_CmdDispatchIndirect;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyBuffer;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyBuffer;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyBuffer;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyImage;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyImage;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyImage;
        std::vector<ValidationObject*> disp_pre_val_CmdBlitImage;
        std::vector<ValidationObject*> disp_pre_rec_CmdBlitImage;
        std::vector<ValidationObject*> disp_post_rec_CmdBlitImage;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyBufferToImage;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyBufferToImage;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyBufferToImage;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyImageToBuffer;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyImageToBuffer;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyImageToBuffer;
        std::vector<ValidationObject*> disp_pre_val_CmdUpdateBuffer;
        std::vector<ValidationObject*> disp_pre_rec_CmdUpdateBuffer;
        std::vector<ValidationObject*> disp_post_rec_CmdUpdateBuffer;
        std::vector<ValidationObject*> disp_pre_val_CmdFillBuffer;
        std::vector<ValidationObject*> disp_pre_rec_CmdFillBuffer;
        std::vector<ValidationObject*> disp_post_rec_CmdFillBuffer;
        std::vector<ValidationObject*> disp_pre_val_CmdClearColorImage;
        std::vector<ValidationObject*> disp_pre_rec_CmdClearColorImage;
        std::vector<ValidationObject*> disp_post_rec_CmdClearColorImage;
        std::vector<ValidationObject*> disp_pre_val_CmdClearDepthStencilImage;
        std::vector<ValidationObject*> disp_pre_rec_CmdClearDepthStencilImage;
        std::vector<ValidationObject*> disp_post_rec_CmdClearDepthStencilImage;
        std::vector<ValidationObject*> disp_pre_val_CmdClearAttachments;
        std::vector<ValidationObject*> disp_pre_rec_CmdClearAttachments;
        std::vector<ValidationObject*> disp_post_rec_CmdClearAttachments;
        std::vector<ValidationObject*> disp_pre_val_CmdResolveImage;
        std::vector<ValidationObject*> disp_pre_rec_CmdResolveImage;
        std::vector<ValidationObject*> disp_post_rec_CmdResolveImage;
        std::vector<ValidationObject*> disp_pre_val_CmdSetEvent;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetEvent;
        std::vector<ValidationObject*> disp_post_rec_CmdSetEvent;
        std::vector<ValidationObject*> disp_pre_val_CmdResetEvent;
        std::vector<ValidationObject*> disp_pre_rec_CmdResetEvent;
        std::vector<ValidationObject*> disp_post_rec_CmdResetEvent;
        std::vector<ValidationObject*> disp_pre_val_CmdWaitEvents;
        std::vector<ValidationObject*> disp_pre_rec_CmdWaitEvents;
        std::vector<ValidationObject*> disp_post_rec_CmdWaitEvents;
        std::vector<ValidationObject*> disp_pre_val_CmdPipelineBarrier;
        std::vector<ValidationObject*> disp_pre_rec_CmdPipelineBarrier;
        std::vector<ValidationObject*> disp_post_rec_CmdPipelineBarrier;
        std::vector<ValidationObject*> disp_pre_val_CmdBeginQuery;
        std::vector<ValidationObject*> disp_pre_rec_CmdBeginQuery;
        std::vector<ValidationObject*> disp_post_rec_CmdBeginQuery;
        std::vector<ValidationObject*> disp_pre_val_CmdEndQuery;
        std::vector<ValidationObject*> disp_pre_rec_CmdEndQuery;
        std::vector<ValidationObject*> disp_post_rec_CmdEndQuery;
        std::vector<ValidationObject*> disp_pre_val_CmdResetQueryPool;
        std::vector<ValidationObject*> disp_pre_rec_CmdResetQueryPool;
        std::vector<ValidationObject*> disp_post_rec_CmdResetQueryPool;
        std::vector<ValidationObject*> disp_pre_val_CmdWriteTimestamp;
        std::vector<ValidationObject*> disp_pre_rec_CmdWriteTimestamp;
        std::vector<ValidationObject*> disp_post_rec_CmdWriteTimestamp;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyQueryPoolResults;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyQueryPoolResults;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyQueryPoolResults;
        std::vector<ValidationObject*> disp_pre_val_CmdPushConstants;
        std::vector<ValidationObject*> disp_pre_rec_CmdPushConstants;
        std::vector<ValidationObject*> disp_post_rec_CmdPushConstants;
        std::vector<ValidationObject*> disp_pre_val_CmdBeginRenderPass;
        std::vector<ValidationObject*> disp_pre_rec_CmdBeginRenderPass;
        std::vector<ValidationObject*> disp_post_rec_CmdBeginRenderPass;
        std::vector<ValidationObject*> disp_pre_val_CmdNextSubpass;
        std::vector<ValidationObject*> disp_pre_rec_CmdNextSubpass;
        std::vector<ValidationObject*> disp_post_rec_CmdNextSubpass;
        std::vector<ValidationObject*> disp_pre_val_CmdEndRenderPass;
        std::vector<ValidationObject*> disp_pre_rec_CmdEndRenderPass;
        std::vector<ValidationObject*> disp_post_rec_CmdEndRenderPass;
        std::vector<ValidationObject*> disp_pre_val_CmdExecuteCommands;
        std::vector<ValidationObject*> disp_pre_rec_CmdExecuteCommands;
        std::vector<ValidationObject*> disp_post_rec_CmdExecuteCommands;
        std::vector<ValidationObject*> disp_pre_val_BindBufferMemory2;
        std::vector<ValidationObject*> disp_pre_rec_BindBufferMemory2;
        std::vector<ValidationObject*> disp_post_rec_BindBufferMemory2;
        std::vector<ValidationObject*> disp_pre_val_BindImageMemory2;
        std::vector<ValidationObject*> disp_pre_rec_BindImageMemory2;
        std::vector<ValidationObject*> disp_post_rec_BindImageMemory2;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceGroupPeerMemoryFeatures;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceGroupPeerMemoryFeatures;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceGroupPeerMemoryFeatures;
        std::vector<ValidationObject*> disp_pre_val_CmdSetDeviceMask;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetDeviceMask;
        std::vector<ValidationObject*> disp_post_rec_CmdSetDeviceMask;
        std::vector<ValidationObject*> disp_pre_val_CmdDispatchBase;
        std::vector<ValidationObject*> disp_pre_rec_CmdDispatchBase;
        std::vector<ValidationObject*> disp_post_rec_CmdDispatchBase;
        std::vector<ValidationObject*> disp_pre_val_GetImageMemoryRequirements2;
        std::vector<ValidationObject*> disp_pre_rec_GetImageMemoryRequirements2;
        std::vector<ValidationObject*> disp_post_rec_GetImageMemoryRequirements2;
        std::vector<ValidationObject*> disp_pre_val_GetBufferMemoryRequirements2;
        std::vector<ValidationObject*> disp_pre_rec_GetBufferMemoryRequirements2;
        std::vector<ValidationObject*> disp_post_rec_GetBufferMemoryRequirements2;
        std::vector<ValidationObject*> disp_pre_val_GetImageSparseMemoryRequirements2;
        std::vector<ValidationObject*> disp_pre_rec_GetImageSparseMemoryRequirements2;
        std::vector<ValidationObject*> disp_post_rec_GetImageSparseMemoryRequirements2;
        std::vector<ValidationObject*> disp_pre_val_TrimCommandPool;
        std::vector<ValidationObject*> disp_pre_rec_TrimCommandPool;
        std::vector<ValidationObject*> disp_post_rec_TrimCommandPool;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceQueue2;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceQueue2;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceQueue2;
        std::vector<ValidationObject*> disp_pre_val_CreateSamplerYcbcrConversion;
        std::vector<ValidationObject*> disp_pre_rec_CreateSamplerYcbcrConversion;
        std::vector<ValidationObject*> disp_post_rec_CreateSamplerYcbcrConversion;
        std::vector<ValidationObject*> disp_pre_val_DestroySamplerYcbcrConversion;
        std::vector<ValidationObject*> disp_pre_rec_DestroySamplerYcbcrConversion;
        std::vector<ValidationObject*> disp_post_rec_DestroySamplerYcbcrConversion;
        std::vector<ValidationObject*> disp_pre_val_CreateDescriptorUpdateTemplate;
        std::vector<ValidationObject*> disp_pre_rec_CreateDescriptorUpdateTemplate;
        std::vector<ValidationObject*> disp_post_rec_CreateDescriptorUpdateTemplate;
        std::vector<ValidationObject*> disp_pre_val_DestroyDescriptorUpdateTemplate;
        std::vector<ValidationObject*> disp_pre_rec_DestroyDescriptorUpdateTemplate;
        std::vector<ValidationObject*> disp_post_rec_DestroyDescriptorUpdateTemplate;
        std::vector<ValidationObject*> disp_pre_val_UpdateDescriptorSetWithTemplate;
        std::vector<ValidationObject*> disp_pre_rec_UpdateDescriptorSetWithTemplate;
        std::vector<ValidationObject*> disp_post_rec_UpdateDescriptorSetWithTemplate;
        std::vector<ValidationObject*> disp_pre_val_GetDescriptorSetLayoutSupport;
        std::vector<ValidationObject*> disp_pre_rec_GetDescriptorSetLayoutSupport;
        std::vector<ValidationObject*> disp_post_rec_GetDescriptorSetLayoutSupport;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndirectCount;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndirectCount;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndirectCount;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndexedIndirectCount;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndexedIndirectCount;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndexedIndirectCount;
        std::vector<ValidationObject*> disp_pre_val_CreateRenderPass2;
        std::vector<ValidationObject*> disp_pre_rec_CreateRenderPass2;
        std::vector<ValidationObject*> disp_post_rec_CreateRenderPass2;
        std::vector<ValidationObject*> disp_pre_val_CmdBeginRenderPass2;
        std::vector<ValidationObject*> disp_pre_rec_CmdBeginRenderPass2;
        std::vector<ValidationObject*> disp_post_rec_CmdBeginRenderPass2;
        std::vector<ValidationObject*> disp_pre_val_CmdNextSubpass2;
        std::vector<ValidationObject*> disp_pre_rec_CmdNextSubpass2;
        std::vector<ValidationObject*> disp_post_rec_CmdNextSubpass2;
        std::vector<ValidationObject*> disp_pre_val_CmdEndRenderPass2;
        std::vector<ValidationObject*> disp_pre_rec_CmdEndRenderPass2;
        std::vector<ValidationObject*> disp_post_rec_CmdEndRenderPass2;
        std::vector<ValidationObject*> disp_pre_val_ResetQueryPool;
        std::vector<ValidationObject*> disp_pre_rec_ResetQueryPool;
        std::vector<ValidationObject*> disp_post_rec_ResetQueryPool;
        std::vector<ValidationObject*> disp_pre_val_GetSemaphoreCounterValue;
        std::vector<ValidationObject*> disp_pre_rec_GetSemaphoreCounterValue;
        std::vector<ValidationObject*> disp_post_rec_GetSemaphoreCounterValue;
        std::vector<ValidationObject*> disp_pre_val_WaitSemaphores;
        std::vector<ValidationObject*> disp_pre_rec_WaitSemaphores;
        std::vector<ValidationObject*> disp_post_rec_WaitSemaphores;
        std::vector<ValidationObject*> disp_pre_val_SignalSemaphore;
        std::vector<ValidationObject*> disp_pre_rec_SignalSemaphore;
        std::vector<ValidationObject*> disp_post_rec_SignalSemaphore;
        std::vector<ValidationObject*> disp_pre_val_GetBufferDeviceAddress;
        std::vector<ValidationObject*> disp_pre_rec_GetBufferDeviceAddress;
        std::vector<ValidationObject*> disp_post_rec_GetBufferDeviceAddress;
        std::vector<ValidationObject*> disp_pre_val_GetBufferOpaqueCaptureAddress;
        std::vector<ValidationObject*> disp_pre_rec_GetBufferOpaqueCaptureAddress;
        std::vector<ValidationObject*> disp_post_rec_GetBufferOpaqueCaptureAddress;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceMemoryOpaqueCaptureAddress;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceMemoryOpaqueCaptureAddress;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceMemoryOpaqueCaptureAddress;
        std::vector<ValidationObject*> disp_pre_val_CreateSwapchainKHR;
        std::vector<ValidationObject*> disp_pre_rec_CreateSwapchainKHR;
        std::vector<ValidationObject*> disp_post_rec_CreateSwapchainKHR;
        std::vector<ValidationObject*> disp_pre_val_DestroySwapchainKHR;
        std::vector<ValidationObject*> disp_pre_rec_DestroySwapchainKHR;
        std::vector<ValidationObject*> disp_post_rec_DestroySwapchainKHR;
        std::vector<ValidationObject*> disp_pre_val_GetSwapchainImagesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetSwapchainImagesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetSwapchainImagesKHR;
        std::vector<ValidationObject*> disp_pre_val_AcquireNextImageKHR;
        std::vector<ValidationObject*> disp_pre_rec_AcquireNextImageKHR;
        std::vector<ValidationObject*> disp_post_rec_AcquireNextImageKHR;
        std::vector<ValidationObject*> disp_pre_val_QueuePresentKHR;
        std::vector<ValidationObject*> disp_pre_rec_QueuePresentKHR;
        std::vector<ValidationObject*> disp_post_rec_QueuePresentKHR;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceGroupPresentCapabilitiesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceGroupPresentCapabilitiesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceGroupPresentCapabilitiesKHR;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceGroupSurfacePresentModesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceGroupSurfacePresentModesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceGroupSurfacePresentModesKHR;
        std::vector<ValidationObject*> disp_pre_val_AcquireNextImage2KHR;
        std::vector<ValidationObject*> disp_pre_rec_AcquireNextImage2KHR;
        std::vector<ValidationObject*> disp_post_rec_AcquireNextImage2KHR;
        std::vector<ValidationObject*> disp_pre_val_CreateSharedSwapchainsKHR;
        std::vector<ValidationObject*> disp_pre_rec_CreateSharedSwapchainsKHR;
        std::vector<ValidationObject*> disp_post_rec_CreateSharedSwapchainsKHR;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceGroupPeerMemoryFeaturesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceGroupPeerMemoryFeaturesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceGroupPeerMemoryFeaturesKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdSetDeviceMaskKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetDeviceMaskKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdSetDeviceMaskKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdDispatchBaseKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdDispatchBaseKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdDispatchBaseKHR;
        std::vector<ValidationObject*> disp_pre_val_TrimCommandPoolKHR;
        std::vector<ValidationObject*> disp_pre_rec_TrimCommandPoolKHR;
        std::vector<ValidationObject*> disp_post_rec_TrimCommandPoolKHR;
        std::vector<ValidationObject*> disp_pre_val_GetMemoryWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetMemoryWin32HandleKHR;
        std::vector<ValidationObject*> disp_post_rec_GetMemoryWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_val_GetMemoryWin32HandlePropertiesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetMemoryWin32HandlePropertiesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetMemoryWin32HandlePropertiesKHR;
        std::vector<ValidationObject*> disp_pre_val_GetMemoryFdKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetMemoryFdKHR;
        std::vector<ValidationObject*> disp_post_rec_GetMemoryFdKHR;
        std::vector<ValidationObject*> disp_pre_val_GetMemoryFdPropertiesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetMemoryFdPropertiesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetMemoryFdPropertiesKHR;
        std::vector<ValidationObject*> disp_pre_val_ImportSemaphoreWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_rec_ImportSemaphoreWin32HandleKHR;
        std::vector<ValidationObject*> disp_post_rec_ImportSemaphoreWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_val_GetSemaphoreWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetSemaphoreWin32HandleKHR;
        std::vector<ValidationObject*> disp_post_rec_GetSemaphoreWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_val_ImportSemaphoreFdKHR;
        std::vector<ValidationObject*> disp_pre_rec_ImportSemaphoreFdKHR;
        std::vector<ValidationObject*> disp_post_rec_ImportSemaphoreFdKHR;
        std::vector<ValidationObject*> disp_pre_val_GetSemaphoreFdKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetSemaphoreFdKHR;
        std::vector<ValidationObject*> disp_post_rec_GetSemaphoreFdKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdPushDescriptorSetKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdPushDescriptorSetKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdPushDescriptorSetKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdPushDescriptorSetWithTemplateKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdPushDescriptorSetWithTemplateKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdPushDescriptorSetWithTemplateKHR;
        std::vector<ValidationObject*> disp_pre_val_CreateDescriptorUpdateTemplateKHR;
        std::vector<ValidationObject*> disp_pre_rec_CreateDescriptorUpdateTemplateKHR;
        std::vector<ValidationObject*> disp_post_rec_CreateDescriptorUpdateTemplateKHR;
        std::vector<ValidationObject*> disp_pre_val_DestroyDescriptorUpdateTemplateKHR;
        std::vector<ValidationObject*> disp_pre_rec_DestroyDescriptorUpdateTemplateKHR;
        std::vector<ValidationObject*> disp_post_rec_DestroyDescriptorUpdateTemplateKHR;
        std::vector<ValidationObject*> disp_pre_val_UpdateDescriptorSetWithTemplateKHR;
        std::vector<ValidationObject*> disp_pre_rec_UpdateDescriptorSetWithTemplateKHR;
        std::vector<ValidationObject*> disp_post_rec_UpdateDescriptorSetWithTemplateKHR;
        std::vector<ValidationObject*> disp_pre_val_CreateRenderPass2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CreateRenderPass2KHR;
        std::vector<ValidationObject*> disp_post_rec_CreateRenderPass2KHR;
        std::vector<ValidationObject*> disp_pre_val_CmdBeginRenderPass2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdBeginRenderPass2KHR;
        std::vector<ValidationObject*> disp_post_rec_CmdBeginRenderPass2KHR;
        std::vector<ValidationObject*> disp_pre_val_CmdNextSubpass2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdNextSubpass2KHR;
        std::vector<ValidationObject*> disp_post_rec_CmdNextSubpass2KHR;
        std::vector<ValidationObject*> disp_pre_val_CmdEndRenderPass2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdEndRenderPass2KHR;
        std::vector<ValidationObject*> disp_post_rec_CmdEndRenderPass2KHR;
        std::vector<ValidationObject*> disp_pre_val_GetSwapchainStatusKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetSwapchainStatusKHR;
        std::vector<ValidationObject*> disp_post_rec_GetSwapchainStatusKHR;
        std::vector<ValidationObject*> disp_pre_val_ImportFenceWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_rec_ImportFenceWin32HandleKHR;
        std::vector<ValidationObject*> disp_post_rec_ImportFenceWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_val_GetFenceWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetFenceWin32HandleKHR;
        std::vector<ValidationObject*> disp_post_rec_GetFenceWin32HandleKHR;
        std::vector<ValidationObject*> disp_pre_val_ImportFenceFdKHR;
        std::vector<ValidationObject*> disp_pre_rec_ImportFenceFdKHR;
        std::vector<ValidationObject*> disp_post_rec_ImportFenceFdKHR;
        std::vector<ValidationObject*> disp_pre_val_GetFenceFdKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetFenceFdKHR;
        std::vector<ValidationObject*> disp_post_rec_GetFenceFdKHR;
        std::vector<ValidationObject*> disp_pre_val_AcquireProfilingLockKHR;
        std::vector<ValidationObject*> disp_pre_rec_AcquireProfilingLockKHR;
        std::vector<ValidationObject*> disp_post_rec_AcquireProfilingLockKHR;
        std::vector<ValidationObject*> disp_pre_val_ReleaseProfilingLockKHR;
        std::vector<ValidationObject*> disp_pre_rec_ReleaseProfilingLockKHR;
        std::vector<ValidationObject*> disp_post_rec_ReleaseProfilingLockKHR;
        std::vector<ValidationObject*> disp_pre_val_GetImageMemoryRequirements2KHR;
        std::vector<ValidationObject*> disp_pre_rec_GetImageMemoryRequirements2KHR;
        std::vector<ValidationObject*> disp_post_rec_GetImageMemoryRequirements2KHR;
        std::vector<ValidationObject*> disp_pre_val_GetBufferMemoryRequirements2KHR;
        std::vector<ValidationObject*> disp_pre_rec_GetBufferMemoryRequirements2KHR;
        std::vector<ValidationObject*> disp_post_rec_GetBufferMemoryRequirements2KHR;
        std::vector<ValidationObject*> disp_pre_val_GetImageSparseMemoryRequirements2KHR;
        std::vector<ValidationObject*> disp_pre_rec_GetImageSparseMemoryRequirements2KHR;
        std::vector<ValidationObject*> disp_post_rec_GetImageSparseMemoryRequirements2KHR;
        std::vector<ValidationObject*> disp_pre_val_CreateSamplerYcbcrConversionKHR;
        std::vector<ValidationObject*> disp_pre_rec_CreateSamplerYcbcrConversionKHR;
        std::vector<ValidationObject*> disp_post_rec_CreateSamplerYcbcrConversionKHR;
        std::vector<ValidationObject*> disp_pre_val_DestroySamplerYcbcrConversionKHR;
        std::vector<ValidationObject*> disp_pre_rec_DestroySamplerYcbcrConversionKHR;
        std::vector<ValidationObject*> disp_post_rec_DestroySamplerYcbcrConversionKHR;
        std::vector<ValidationObject*> disp_pre_val_BindBufferMemory2KHR;
        std::vector<ValidationObject*> disp_pre_rec_BindBufferMemory2KHR;
        std::vector<ValidationObject*> disp_post_rec_BindBufferMemory2KHR;
        std::vector<ValidationObject*> disp_pre_val_BindImageMemory2KHR;
        std::vector<ValidationObject*> disp_pre_rec_BindImageMemory2KHR;
        std::vector<ValidationObject*> disp_post_rec_BindImageMemory2KHR;
        std::vector<ValidationObject*> disp_pre_val_GetDescriptorSetLayoutSupportKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetDescriptorSetLayoutSupportKHR;
        std::vector<ValidationObject*> disp_post_rec_GetDescriptorSetLayoutSupportKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndirectCountKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndirectCountKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndirectCountKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndexedIndirectCountKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndexedIndirectCountKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndexedIndirectCountKHR;
        std::vector<ValidationObject*> disp_pre_val_GetSemaphoreCounterValueKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetSemaphoreCounterValueKHR;
        std::vector<ValidationObject*> disp_post_rec_GetSemaphoreCounterValueKHR;
        std::vector<ValidationObject*> disp_pre_val_WaitSemaphoresKHR;
        std::vector<ValidationObject*> disp_pre_rec_WaitSemaphoresKHR;
        std::vector<ValidationObject*> disp_post_rec_WaitSemaphoresKHR;
        std::vector<ValidationObject*> disp_pre_val_SignalSemaphoreKHR;
        std::vector<ValidationObject*> disp_pre_rec_SignalSemaphoreKHR;
        std::vector<ValidationObject*> disp_post_rec_SignalSemaphoreKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdSetFragmentShadingRateKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetFragmentShadingRateKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdSetFragmentShadingRateKHR;
        std::vector<ValidationObject*> disp_pre_val_GetBufferDeviceAddressKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetBufferDeviceAddressKHR;
        std::vector<ValidationObject*> disp_post_rec_GetBufferDeviceAddressKHR;
        std::vector<ValidationObject*> disp_pre_val_GetBufferOpaqueCaptureAddressKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetBufferOpaqueCaptureAddressKHR;
        std::vector<ValidationObject*> disp_post_rec_GetBufferOpaqueCaptureAddressKHR;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceMemoryOpaqueCaptureAddressKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceMemoryOpaqueCaptureAddressKHR;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceMemoryOpaqueCaptureAddressKHR;
        std::vector<ValidationObject*> disp_pre_val_CreateDeferredOperationKHR;
        std::vector<ValidationObject*> disp_pre_rec_CreateDeferredOperationKHR;
        std::vector<ValidationObject*> disp_post_rec_CreateDeferredOperationKHR;
        std::vector<ValidationObject*> disp_pre_val_DestroyDeferredOperationKHR;
        std::vector<ValidationObject*> disp_pre_rec_DestroyDeferredOperationKHR;
        std::vector<ValidationObject*> disp_post_rec_DestroyDeferredOperationKHR;
        std::vector<ValidationObject*> disp_pre_val_GetDeferredOperationMaxConcurrencyKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetDeferredOperationMaxConcurrencyKHR;
        std::vector<ValidationObject*> disp_post_rec_GetDeferredOperationMaxConcurrencyKHR;
        std::vector<ValidationObject*> disp_pre_val_GetDeferredOperationResultKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetDeferredOperationResultKHR;
        std::vector<ValidationObject*> disp_post_rec_GetDeferredOperationResultKHR;
        std::vector<ValidationObject*> disp_pre_val_DeferredOperationJoinKHR;
        std::vector<ValidationObject*> disp_pre_rec_DeferredOperationJoinKHR;
        std::vector<ValidationObject*> disp_post_rec_DeferredOperationJoinKHR;
        std::vector<ValidationObject*> disp_pre_val_GetPipelineExecutablePropertiesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetPipelineExecutablePropertiesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetPipelineExecutablePropertiesKHR;
        std::vector<ValidationObject*> disp_pre_val_GetPipelineExecutableStatisticsKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetPipelineExecutableStatisticsKHR;
        std::vector<ValidationObject*> disp_post_rec_GetPipelineExecutableStatisticsKHR;
        std::vector<ValidationObject*> disp_pre_val_GetPipelineExecutableInternalRepresentationsKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetPipelineExecutableInternalRepresentationsKHR;
        std::vector<ValidationObject*> disp_post_rec_GetPipelineExecutableInternalRepresentationsKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyBuffer2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyBuffer2KHR;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyBuffer2KHR;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyImage2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyImage2KHR;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyImage2KHR;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyBufferToImage2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyBufferToImage2KHR;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyBufferToImage2KHR;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyImageToBuffer2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyImageToBuffer2KHR;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyImageToBuffer2KHR;
        std::vector<ValidationObject*> disp_pre_val_CmdBlitImage2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdBlitImage2KHR;
        std::vector<ValidationObject*> disp_post_rec_CmdBlitImage2KHR;
        std::vector<ValidationObject*> disp_pre_val_CmdResolveImage2KHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdResolveImage2KHR;
        std::vector<ValidationObject*> disp_post_rec_CmdResolveImage2KHR;
        std::vector<ValidationObject*> disp_pre_val_DebugMarkerSetObjectTagEXT;
        std::vector<ValidationObject*> disp_pre_rec_DebugMarkerSetObjectTagEXT;
        std::vector<ValidationObject*> disp_post_rec_DebugMarkerSetObjectTagEXT;
        std::vector<ValidationObject*> disp_pre_val_DebugMarkerSetObjectNameEXT;
        std::vector<ValidationObject*> disp_pre_rec_DebugMarkerSetObjectNameEXT;
        std::vector<ValidationObject*> disp_post_rec_DebugMarkerSetObjectNameEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdDebugMarkerBeginEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdDebugMarkerBeginEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdDebugMarkerBeginEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdDebugMarkerEndEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdDebugMarkerEndEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdDebugMarkerEndEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdDebugMarkerInsertEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdDebugMarkerInsertEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdDebugMarkerInsertEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdBindTransformFeedbackBuffersEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdBindTransformFeedbackBuffersEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdBindTransformFeedbackBuffersEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdBeginTransformFeedbackEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdBeginTransformFeedbackEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdBeginTransformFeedbackEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdEndTransformFeedbackEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdEndTransformFeedbackEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdEndTransformFeedbackEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdBeginQueryIndexedEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdBeginQueryIndexedEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdBeginQueryIndexedEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdEndQueryIndexedEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdEndQueryIndexedEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdEndQueryIndexedEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndirectByteCountEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndirectByteCountEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndirectByteCountEXT;
        std::vector<ValidationObject*> disp_pre_val_GetImageViewHandleNVX;
        std::vector<ValidationObject*> disp_pre_rec_GetImageViewHandleNVX;
        std::vector<ValidationObject*> disp_post_rec_GetImageViewHandleNVX;
        std::vector<ValidationObject*> disp_pre_val_GetImageViewAddressNVX;
        std::vector<ValidationObject*> disp_pre_rec_GetImageViewAddressNVX;
        std::vector<ValidationObject*> disp_post_rec_GetImageViewAddressNVX;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndirectCountAMD;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndirectCountAMD;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndirectCountAMD;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawIndexedIndirectCountAMD;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawIndexedIndirectCountAMD;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawIndexedIndirectCountAMD;
        std::vector<ValidationObject*> disp_pre_val_GetShaderInfoAMD;
        std::vector<ValidationObject*> disp_pre_rec_GetShaderInfoAMD;
        std::vector<ValidationObject*> disp_post_rec_GetShaderInfoAMD;
        std::vector<ValidationObject*> disp_pre_val_GetMemoryWin32HandleNV;
        std::vector<ValidationObject*> disp_pre_rec_GetMemoryWin32HandleNV;
        std::vector<ValidationObject*> disp_post_rec_GetMemoryWin32HandleNV;
        std::vector<ValidationObject*> disp_pre_val_CmdBeginConditionalRenderingEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdBeginConditionalRenderingEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdBeginConditionalRenderingEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdEndConditionalRenderingEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdEndConditionalRenderingEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdEndConditionalRenderingEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetViewportWScalingNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetViewportWScalingNV;
        std::vector<ValidationObject*> disp_post_rec_CmdSetViewportWScalingNV;
        std::vector<ValidationObject*> disp_pre_val_DisplayPowerControlEXT;
        std::vector<ValidationObject*> disp_pre_rec_DisplayPowerControlEXT;
        std::vector<ValidationObject*> disp_post_rec_DisplayPowerControlEXT;
        std::vector<ValidationObject*> disp_pre_val_RegisterDeviceEventEXT;
        std::vector<ValidationObject*> disp_pre_rec_RegisterDeviceEventEXT;
        std::vector<ValidationObject*> disp_post_rec_RegisterDeviceEventEXT;
        std::vector<ValidationObject*> disp_pre_val_RegisterDisplayEventEXT;
        std::vector<ValidationObject*> disp_pre_rec_RegisterDisplayEventEXT;
        std::vector<ValidationObject*> disp_post_rec_RegisterDisplayEventEXT;
        std::vector<ValidationObject*> disp_pre_val_GetSwapchainCounterEXT;
        std::vector<ValidationObject*> disp_pre_rec_GetSwapchainCounterEXT;
        std::vector<ValidationObject*> disp_post_rec_GetSwapchainCounterEXT;
        std::vector<ValidationObject*> disp_pre_val_GetRefreshCycleDurationGOOGLE;
        std::vector<ValidationObject*> disp_pre_rec_GetRefreshCycleDurationGOOGLE;
        std::vector<ValidationObject*> disp_post_rec_GetRefreshCycleDurationGOOGLE;
        std::vector<ValidationObject*> disp_pre_val_GetPastPresentationTimingGOOGLE;
        std::vector<ValidationObject*> disp_pre_rec_GetPastPresentationTimingGOOGLE;
        std::vector<ValidationObject*> disp_post_rec_GetPastPresentationTimingGOOGLE;
        std::vector<ValidationObject*> disp_pre_val_CmdSetDiscardRectangleEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetDiscardRectangleEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetDiscardRectangleEXT;
        std::vector<ValidationObject*> disp_pre_val_SetHdrMetadataEXT;
        std::vector<ValidationObject*> disp_pre_rec_SetHdrMetadataEXT;
        std::vector<ValidationObject*> disp_post_rec_SetHdrMetadataEXT;
        std::vector<ValidationObject*> disp_pre_val_SetDebugUtilsObjectNameEXT;
        std::vector<ValidationObject*> disp_pre_rec_SetDebugUtilsObjectNameEXT;
        std::vector<ValidationObject*> disp_post_rec_SetDebugUtilsObjectNameEXT;
        std::vector<ValidationObject*> disp_pre_val_SetDebugUtilsObjectTagEXT;
        std::vector<ValidationObject*> disp_pre_rec_SetDebugUtilsObjectTagEXT;
        std::vector<ValidationObject*> disp_post_rec_SetDebugUtilsObjectTagEXT;
        std::vector<ValidationObject*> disp_pre_val_QueueBeginDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_rec_QueueBeginDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_post_rec_QueueBeginDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_val_QueueEndDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_rec_QueueEndDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_post_rec_QueueEndDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_val_QueueInsertDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_rec_QueueInsertDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_post_rec_QueueInsertDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdBeginDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdBeginDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdBeginDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdEndDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdEndDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdEndDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdInsertDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdInsertDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdInsertDebugUtilsLabelEXT;
        std::vector<ValidationObject*> disp_pre_val_GetAndroidHardwareBufferPropertiesANDROID;
        std::vector<ValidationObject*> disp_pre_rec_GetAndroidHardwareBufferPropertiesANDROID;
        std::vector<ValidationObject*> disp_post_rec_GetAndroidHardwareBufferPropertiesANDROID;
        std::vector<ValidationObject*> disp_pre_val_GetMemoryAndroidHardwareBufferANDROID;
        std::vector<ValidationObject*> disp_pre_rec_GetMemoryAndroidHardwareBufferANDROID;
        std::vector<ValidationObject*> disp_post_rec_GetMemoryAndroidHardwareBufferANDROID;
        std::vector<ValidationObject*> disp_pre_val_CmdSetSampleLocationsEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetSampleLocationsEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetSampleLocationsEXT;
        std::vector<ValidationObject*> disp_pre_val_GetImageDrmFormatModifierPropertiesEXT;
        std::vector<ValidationObject*> disp_pre_rec_GetImageDrmFormatModifierPropertiesEXT;
        std::vector<ValidationObject*> disp_post_rec_GetImageDrmFormatModifierPropertiesEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdBindShadingRateImageNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdBindShadingRateImageNV;
        std::vector<ValidationObject*> disp_post_rec_CmdBindShadingRateImageNV;
        std::vector<ValidationObject*> disp_pre_val_CmdSetViewportShadingRatePaletteNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetViewportShadingRatePaletteNV;
        std::vector<ValidationObject*> disp_post_rec_CmdSetViewportShadingRatePaletteNV;
        std::vector<ValidationObject*> disp_pre_val_CmdSetCoarseSampleOrderNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetCoarseSampleOrderNV;
        std::vector<ValidationObject*> disp_post_rec_CmdSetCoarseSampleOrderNV;
        std::vector<ValidationObject*> disp_pre_val_CreateAccelerationStructureNV;
        std::vector<ValidationObject*> disp_pre_rec_CreateAccelerationStructureNV;
        std::vector<ValidationObject*> disp_post_rec_CreateAccelerationStructureNV;
        std::vector<ValidationObject*> disp_pre_val_DestroyAccelerationStructureNV;
        std::vector<ValidationObject*> disp_pre_rec_DestroyAccelerationStructureNV;
        std::vector<ValidationObject*> disp_post_rec_DestroyAccelerationStructureNV;
        std::vector<ValidationObject*> disp_pre_val_GetAccelerationStructureMemoryRequirementsNV;
        std::vector<ValidationObject*> disp_pre_rec_GetAccelerationStructureMemoryRequirementsNV;
        std::vector<ValidationObject*> disp_post_rec_GetAccelerationStructureMemoryRequirementsNV;
        std::vector<ValidationObject*> disp_pre_val_BindAccelerationStructureMemoryNV;
        std::vector<ValidationObject*> disp_pre_rec_BindAccelerationStructureMemoryNV;
        std::vector<ValidationObject*> disp_post_rec_BindAccelerationStructureMemoryNV;
        std::vector<ValidationObject*> disp_pre_val_CmdBuildAccelerationStructureNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdBuildAccelerationStructureNV;
        std::vector<ValidationObject*> disp_post_rec_CmdBuildAccelerationStructureNV;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyAccelerationStructureNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyAccelerationStructureNV;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyAccelerationStructureNV;
        std::vector<ValidationObject*> disp_pre_val_CmdTraceRaysNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdTraceRaysNV;
        std::vector<ValidationObject*> disp_post_rec_CmdTraceRaysNV;
        std::vector<ValidationObject*> disp_pre_val_GetRayTracingShaderGroupHandlesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetRayTracingShaderGroupHandlesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetRayTracingShaderGroupHandlesKHR;
        std::vector<ValidationObject*> disp_pre_val_GetRayTracingShaderGroupHandlesNV;
        std::vector<ValidationObject*> disp_pre_rec_GetRayTracingShaderGroupHandlesNV;
        std::vector<ValidationObject*> disp_post_rec_GetRayTracingShaderGroupHandlesNV;
        std::vector<ValidationObject*> disp_pre_val_GetAccelerationStructureHandleNV;
        std::vector<ValidationObject*> disp_pre_rec_GetAccelerationStructureHandleNV;
        std::vector<ValidationObject*> disp_post_rec_GetAccelerationStructureHandleNV;
        std::vector<ValidationObject*> disp_pre_val_CmdWriteAccelerationStructuresPropertiesNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdWriteAccelerationStructuresPropertiesNV;
        std::vector<ValidationObject*> disp_post_rec_CmdWriteAccelerationStructuresPropertiesNV;
        std::vector<ValidationObject*> disp_pre_val_CompileDeferredNV;
        std::vector<ValidationObject*> disp_pre_rec_CompileDeferredNV;
        std::vector<ValidationObject*> disp_post_rec_CompileDeferredNV;
        std::vector<ValidationObject*> disp_pre_val_GetMemoryHostPointerPropertiesEXT;
        std::vector<ValidationObject*> disp_pre_rec_GetMemoryHostPointerPropertiesEXT;
        std::vector<ValidationObject*> disp_post_rec_GetMemoryHostPointerPropertiesEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdWriteBufferMarkerAMD;
        std::vector<ValidationObject*> disp_pre_rec_CmdWriteBufferMarkerAMD;
        std::vector<ValidationObject*> disp_post_rec_CmdWriteBufferMarkerAMD;
        std::vector<ValidationObject*> disp_pre_val_GetCalibratedTimestampsEXT;
        std::vector<ValidationObject*> disp_pre_rec_GetCalibratedTimestampsEXT;
        std::vector<ValidationObject*> disp_post_rec_GetCalibratedTimestampsEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawMeshTasksNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawMeshTasksNV;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawMeshTasksNV;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawMeshTasksIndirectNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawMeshTasksIndirectNV;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawMeshTasksIndirectNV;
        std::vector<ValidationObject*> disp_pre_val_CmdDrawMeshTasksIndirectCountNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdDrawMeshTasksIndirectCountNV;
        std::vector<ValidationObject*> disp_post_rec_CmdDrawMeshTasksIndirectCountNV;
        std::vector<ValidationObject*> disp_pre_val_CmdSetExclusiveScissorNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetExclusiveScissorNV;
        std::vector<ValidationObject*> disp_post_rec_CmdSetExclusiveScissorNV;
        std::vector<ValidationObject*> disp_pre_val_CmdSetCheckpointNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetCheckpointNV;
        std::vector<ValidationObject*> disp_post_rec_CmdSetCheckpointNV;
        std::vector<ValidationObject*> disp_pre_val_GetQueueCheckpointDataNV;
        std::vector<ValidationObject*> disp_pre_rec_GetQueueCheckpointDataNV;
        std::vector<ValidationObject*> disp_post_rec_GetQueueCheckpointDataNV;
        std::vector<ValidationObject*> disp_pre_val_InitializePerformanceApiINTEL;
        std::vector<ValidationObject*> disp_pre_rec_InitializePerformanceApiINTEL;
        std::vector<ValidationObject*> disp_post_rec_InitializePerformanceApiINTEL;
        std::vector<ValidationObject*> disp_pre_val_UninitializePerformanceApiINTEL;
        std::vector<ValidationObject*> disp_pre_rec_UninitializePerformanceApiINTEL;
        std::vector<ValidationObject*> disp_post_rec_UninitializePerformanceApiINTEL;
        std::vector<ValidationObject*> disp_pre_val_CmdSetPerformanceMarkerINTEL;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetPerformanceMarkerINTEL;
        std::vector<ValidationObject*> disp_post_rec_CmdSetPerformanceMarkerINTEL;
        std::vector<ValidationObject*> disp_pre_val_CmdSetPerformanceStreamMarkerINTEL;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetPerformanceStreamMarkerINTEL;
        std::vector<ValidationObject*> disp_post_rec_CmdSetPerformanceStreamMarkerINTEL;
        std::vector<ValidationObject*> disp_pre_val_CmdSetPerformanceOverrideINTEL;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetPerformanceOverrideINTEL;
        std::vector<ValidationObject*> disp_post_rec_CmdSetPerformanceOverrideINTEL;
        std::vector<ValidationObject*> disp_pre_val_AcquirePerformanceConfigurationINTEL;
        std::vector<ValidationObject*> disp_pre_rec_AcquirePerformanceConfigurationINTEL;
        std::vector<ValidationObject*> disp_post_rec_AcquirePerformanceConfigurationINTEL;
        std::vector<ValidationObject*> disp_pre_val_ReleasePerformanceConfigurationINTEL;
        std::vector<ValidationObject*> disp_pre_rec_ReleasePerformanceConfigurationINTEL;
        std::vector<ValidationObject*> disp_post_rec_ReleasePerformanceConfigurationINTEL;
        std::vector<ValidationObject*> disp_pre_val_QueueSetPerformanceConfigurationINTEL;
        std::vector<ValidationObject*> disp_pre_rec_QueueSetPerformanceConfigurationINTEL;
        std::vector<ValidationObject*> disp_post_rec_QueueSetPerformanceConfigurationINTEL;
        std::vector<ValidationObject*> disp_pre_val_GetPerformanceParameterINTEL;
        std::vector<ValidationObject*> disp_pre_rec_GetPerformanceParameterINTEL;
        std::vector<ValidationObject*> disp_post_rec_GetPerformanceParameterINTEL;
        std::vector<ValidationObject*> disp_pre_val_SetLocalDimmingAMD;
        std::vector<ValidationObject*> disp_pre_rec_SetLocalDimmingAMD;
        std::vector<ValidationObject*> disp_post_rec_SetLocalDimmingAMD;
        std::vector<ValidationObject*> disp_pre_val_GetBufferDeviceAddressEXT;
        std::vector<ValidationObject*> disp_pre_rec_GetBufferDeviceAddressEXT;
        std::vector<ValidationObject*> disp_post_rec_GetBufferDeviceAddressEXT;
        std::vector<ValidationObject*> disp_pre_val_AcquireFullScreenExclusiveModeEXT;
        std::vector<ValidationObject*> disp_pre_rec_AcquireFullScreenExclusiveModeEXT;
        std::vector<ValidationObject*> disp_post_rec_AcquireFullScreenExclusiveModeEXT;
        std::vector<ValidationObject*> disp_pre_val_ReleaseFullScreenExclusiveModeEXT;
        std::vector<ValidationObject*> disp_pre_rec_ReleaseFullScreenExclusiveModeEXT;
        std::vector<ValidationObject*> disp_post_rec_ReleaseFullScreenExclusiveModeEXT;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceGroupSurfacePresentModes2EXT;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceGroupSurfacePresentModes2EXT;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceGroupSurfacePresentModes2EXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetLineStippleEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetLineStippleEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetLineStippleEXT;
        std::vector<ValidationObject*> disp_pre_val_ResetQueryPoolEXT;
        std::vector<ValidationObject*> disp_pre_rec_ResetQueryPoolEXT;
        std::vector<ValidationObject*> disp_post_rec_ResetQueryPoolEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetCullModeEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetCullModeEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetCullModeEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetFrontFaceEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetFrontFaceEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetFrontFaceEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetPrimitiveTopologyEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetPrimitiveTopologyEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetPrimitiveTopologyEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetViewportWithCountEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetViewportWithCountEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetViewportWithCountEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetScissorWithCountEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetScissorWithCountEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetScissorWithCountEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdBindVertexBuffers2EXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdBindVertexBuffers2EXT;
        std::vector<ValidationObject*> disp_post_rec_CmdBindVertexBuffers2EXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetDepthTestEnableEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetDepthTestEnableEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetDepthTestEnableEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetDepthWriteEnableEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetDepthWriteEnableEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetDepthWriteEnableEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetDepthCompareOpEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetDepthCompareOpEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetDepthCompareOpEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetDepthBoundsTestEnableEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetDepthBoundsTestEnableEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetDepthBoundsTestEnableEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetStencilTestEnableEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetStencilTestEnableEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetStencilTestEnableEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetStencilOpEXT;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetStencilOpEXT;
        std::vector<ValidationObject*> disp_post_rec_CmdSetStencilOpEXT;
        std::vector<ValidationObject*> disp_pre_val_GetGeneratedCommandsMemoryRequirementsNV;
        std::vector<ValidationObject*> disp_pre_rec_GetGeneratedCommandsMemoryRequirementsNV;
        std::vector<ValidationObject*> disp_post_rec_GetGeneratedCommandsMemoryRequirementsNV;
        std::vector<ValidationObject*> disp_pre_val_CmdPreprocessGeneratedCommandsNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdPreprocessGeneratedCommandsNV;
        std::vector<ValidationObject*> disp_post_rec_CmdPreprocessGeneratedCommandsNV;
        std::vector<ValidationObject*> disp_pre_val_CmdExecuteGeneratedCommandsNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdExecuteGeneratedCommandsNV;
        std::vector<ValidationObject*> disp_post_rec_CmdExecuteGeneratedCommandsNV;
        std::vector<ValidationObject*> disp_pre_val_CmdBindPipelineShaderGroupNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdBindPipelineShaderGroupNV;
        std::vector<ValidationObject*> disp_post_rec_CmdBindPipelineShaderGroupNV;
        std::vector<ValidationObject*> disp_pre_val_CreateIndirectCommandsLayoutNV;
        std::vector<ValidationObject*> disp_pre_rec_CreateIndirectCommandsLayoutNV;
        std::vector<ValidationObject*> disp_post_rec_CreateIndirectCommandsLayoutNV;
        std::vector<ValidationObject*> disp_pre_val_DestroyIndirectCommandsLayoutNV;
        std::vector<ValidationObject*> disp_pre_rec_DestroyIndirectCommandsLayoutNV;
        std::vector<ValidationObject*> disp_post_rec_DestroyIndirectCommandsLayoutNV;
        std::vector<ValidationObject*> disp_pre_val_CreatePrivateDataSlotEXT;
        std::vector<ValidationObject*> disp_pre_rec_CreatePrivateDataSlotEXT;
        std::vector<ValidationObject*> disp_post_rec_CreatePrivateDataSlotEXT;
        std::vector<ValidationObject*> disp_pre_val_DestroyPrivateDataSlotEXT;
        std::vector<ValidationObject*> disp_pre_rec_DestroyPrivateDataSlotEXT;
        std::vector<ValidationObject*> disp_post_rec_DestroyPrivateDataSlotEXT;
        std::vector<ValidationObject*> disp_pre_val_SetPrivateDataEXT;
        std::vector<ValidationObject*> disp_pre_rec_SetPrivateDataEXT;
        std::vector<ValidationObject*> disp_post_rec_SetPrivateDataEXT;
        std::vector<ValidationObject*> disp_pre_val_GetPrivateDataEXT;
        std::vector<ValidationObject*> disp_pre_rec_GetPrivateDataEXT;
        std::vector<ValidationObject*> disp_post_rec_GetPrivateDataEXT;
        std::vector<ValidationObject*> disp_pre_val_CmdSetFragmentShadingRateEnumNV;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetFragmentShadingRateEnumNV;
        std::vector<ValidationObject*> disp_post_rec_CmdSetFragmentShadingRateEnumNV;
        std::vector<ValidationObject*> disp_pre_val_CreateAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_rec_CreateAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_post_rec_CreateAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_val_DestroyAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_rec_DestroyAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_post_rec_DestroyAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdBuildAccelerationStructuresKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdBuildAccelerationStructuresKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdBuildAccelerationStructuresKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdBuildAccelerationStructuresIndirectKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdBuildAccelerationStructuresIndirectKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdBuildAccelerationStructuresIndirectKHR;
        std::vector<ValidationObject*> disp_pre_val_BuildAccelerationStructuresKHR;
        std::vector<ValidationObject*> disp_pre_rec_BuildAccelerationStructuresKHR;
        std::vector<ValidationObject*> disp_post_rec_BuildAccelerationStructuresKHR;
        std::vector<ValidationObject*> disp_pre_val_CopyAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_rec_CopyAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_post_rec_CopyAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_val_CopyAccelerationStructureToMemoryKHR;
        std::vector<ValidationObject*> disp_pre_rec_CopyAccelerationStructureToMemoryKHR;
        std::vector<ValidationObject*> disp_post_rec_CopyAccelerationStructureToMemoryKHR;
        std::vector<ValidationObject*> disp_pre_val_CopyMemoryToAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_rec_CopyMemoryToAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_post_rec_CopyMemoryToAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_val_WriteAccelerationStructuresPropertiesKHR;
        std::vector<ValidationObject*> disp_pre_rec_WriteAccelerationStructuresPropertiesKHR;
        std::vector<ValidationObject*> disp_post_rec_WriteAccelerationStructuresPropertiesKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyAccelerationStructureToMemoryKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyAccelerationStructureToMemoryKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyAccelerationStructureToMemoryKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdCopyMemoryToAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdCopyMemoryToAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdCopyMemoryToAccelerationStructureKHR;
        std::vector<ValidationObject*> disp_pre_val_GetAccelerationStructureDeviceAddressKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetAccelerationStructureDeviceAddressKHR;
        std::vector<ValidationObject*> disp_post_rec_GetAccelerationStructureDeviceAddressKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdWriteAccelerationStructuresPropertiesKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdWriteAccelerationStructuresPropertiesKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdWriteAccelerationStructuresPropertiesKHR;
        std::vector<ValidationObject*> disp_pre_val_GetDeviceAccelerationStructureCompatibilityKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetDeviceAccelerationStructureCompatibilityKHR;
        std::vector<ValidationObject*> disp_post_rec_GetDeviceAccelerationStructureCompatibilityKHR;
        std::vector<ValidationObject*> disp_pre_val_GetAccelerationStructureBuildSizesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetAccelerationStructureBuildSizesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetAccelerationStructureBuildSizesKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdTraceRaysKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdTraceRaysKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdTraceRaysKHR;
        std::vector<ValidationObject*> disp_pre_val_GetRayTracingCaptureReplayShaderGroupHandlesKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetRayTracingCaptureReplayShaderGroupHandlesKHR;
        std::vector<ValidationObject*> disp_post_rec_GetRayTracingCaptureReplayShaderGroupHandlesKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdTraceRaysIndirectKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdTraceRaysIndirectKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdTraceRaysIndirectKHR;
        std::vector<ValidationObject*> disp_pre_val_GetRayTracingShaderGroupStackSizeKHR;
        std::vector<ValidationObject*> disp_pre_rec_GetRayTracingShaderGroupStackSizeKHR;
        std::vector<ValidationObject*> disp_post_rec_GetRayTracingShaderGroupStackSizeKHR;
        std::vector<ValidationObject*> disp_pre_val_CmdSetRayTracingPipelineStackSizeKHR;
        std::vector<ValidationObject*> disp_pre_rec_CmdSetRayTracingPipelineStackSizeKHR;
        std::vector<ValidationObject*> disp_post_rec_CmdSetRayTracingPipelineStackSizeKHR;
