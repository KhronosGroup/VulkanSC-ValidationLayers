...
class CoreChecks : public ValidationStateTracker {
  public:
    ...
    bool ValidateQueuedQFOTransferBarriers(const CMD_BUFFER_STATE* cb_state,
    ...
    void RecordTransitionImageLayout(CMD_BUFFER_STATE* cb_state, const IMAGE_STATE* image_state, const ImgBarrier& img_barrier,
                                     bool is_release_op);
    void RecordBarriers(const char* func_name, CMD_BUFFER_STATE* cb_state, uint32_t bufferBarrierCount,
                        const VkBufferMemoryBarrier* pBufferMemBarriers, uint32_t imageMemBarrierCount,
                        const VkImageMemoryBarrier* pImageMemBarriers);
    void RecordBarriers(const char* func_name, CMD_BUFFER_STATE* cb_state, const VkDependencyInfoKHR& dep_info);
