...
#else
        skip |= LogError(VkRenderPass(0), vuid, "Warning: Unable to validate subpass graphics flags. This is an expected error that will be resolved with the full vksc layer build");
#endif
