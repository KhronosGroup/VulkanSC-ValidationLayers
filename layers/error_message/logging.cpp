...
#ifdef VULKANSC
            const char *spec_url_base = "https://www.khronos.org/registry/VulkanSC/specs/1.0-extensions/html/vkspec.html";
#else
...
#ifdef VULKANSC
            oss << "The Vulkan SC spec states: " << spec_text << " (" << spec_url_base << "#" << vuid_text << ")";
#else
