...
void InitCore(const char *api_name) {
    ...
    GetCommandPoolMemoryConsumption = reinterpret_cast<PFN_vkGetCommandPoolMemoryConsumption>(get_proc_address(lib_handle, "vkGetCommandPoolMemoryConsumption"));
    GetFaultData = reinterpret_cast<PFN_vkGetFaultData>(get_proc_address(lib_handle, "vkGetFaultData"));
}
...
void InitDeviceExtension(VkInstance instance, VkDevice device, const char* extension_name) {
    static const vvl::unordered_map<std::string, std::function<void(VkInstance, VkDevice)>> initializers = {
        ...
        {
            "VK_KHR_object_refresh", [](VkInstance instance, VkDevice device) {
                CmdRefreshObjectsKHR = reinterpret_cast<PFN_vkCmdRefreshObjectsKHR>(GetDeviceProcAddr(device, "vkCmdRefreshObjectsKHR"));
                GetPhysicalDeviceRefreshableObjectTypesKHR = reinterpret_cast<PFN_vkGetPhysicalDeviceRefreshableObjectTypesKHR>(GetInstanceProcAddr(instance, "vkGetPhysicalDeviceRefreshableObjectTypesKHR"));
            }
        },
        {
...
#ifdef VK_USE_PLATFORM_SCI
        {
            "VK_NV_external_sci_sync", [](VkInstance instance, VkDevice device) {
                GetFenceSciSyncFenceNV = reinterpret_cast<PFN_vkGetFenceSciSyncFenceNV>(GetDeviceProcAddr(device, "vkGetFenceSciSyncFenceNV"));
                GetFenceSciSyncObjNV = reinterpret_cast<PFN_vkGetFenceSciSyncObjNV>(GetDeviceProcAddr(device, "vkGetFenceSciSyncObjNV"));
                ImportFenceSciSyncFenceNV = reinterpret_cast<PFN_vkImportFenceSciSyncFenceNV>(GetDeviceProcAddr(device, "vkImportFenceSciSyncFenceNV"));
                ImportFenceSciSyncObjNV = reinterpret_cast<PFN_vkImportFenceSciSyncObjNV>(GetDeviceProcAddr(device, "vkImportFenceSciSyncObjNV"));
                GetSemaphoreSciSyncObjNV = reinterpret_cast<PFN_vkGetSemaphoreSciSyncObjNV>(GetDeviceProcAddr(device, "vkGetSemaphoreSciSyncObjNV"));
                ImportSemaphoreSciSyncObjNV = reinterpret_cast<PFN_vkImportSemaphoreSciSyncObjNV>(GetDeviceProcAddr(device, "vkImportSemaphoreSciSyncObjNV"));
                GetPhysicalDeviceSciSyncAttributesNV = reinterpret_cast<PFN_vkGetPhysicalDeviceSciSyncAttributesNV>(GetInstanceProcAddr(instance, "vkGetPhysicalDeviceSciSyncAttributesNV"));
            }
        },
        {
            "VK_NV_external_memory_sci_buf", [](VkInstance instance, VkDevice device) {
                GetMemorySciBufNV = reinterpret_cast<PFN_vkGetMemorySciBufNV>(GetDeviceProcAddr(device, "vkGetMemorySciBufNV"));
                GetPhysicalDeviceExternalMemorySciBufPropertiesNV = reinterpret_cast<PFN_vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV>(GetInstanceProcAddr(instance, "vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV"));
                GetPhysicalDeviceSciBufAttributesNV = reinterpret_cast<PFN_vkGetPhysicalDeviceSciBufAttributesNV>(GetInstanceProcAddr(instance, "vkGetPhysicalDeviceSciBufAttributesNV"));
            }
        },
#endif  // VK_USE_PLATFORM_SCI
        {
...
#ifdef VK_USE_PLATFORM_SCI
        {
            "VK_NV_external_sci_sync2", [](VkInstance instance, VkDevice device) {
                CreateSemaphoreSciSyncPoolNV = reinterpret_cast<PFN_vkCreateSemaphoreSciSyncPoolNV>(GetDeviceProcAddr(device, "vkCreateSemaphoreSciSyncPoolNV"));
                DestroySemaphoreSciSyncPoolNV = reinterpret_cast<PFN_vkDestroySemaphoreSciSyncPoolNV>(GetDeviceProcAddr(device, "vkDestroySemaphoreSciSyncPoolNV"));
                GetFenceSciSyncFenceNV = reinterpret_cast<PFN_vkGetFenceSciSyncFenceNV>(GetDeviceProcAddr(device, "vkGetFenceSciSyncFenceNV"));
                GetFenceSciSyncObjNV = reinterpret_cast<PFN_vkGetFenceSciSyncObjNV>(GetDeviceProcAddr(device, "vkGetFenceSciSyncObjNV"));
                ImportFenceSciSyncFenceNV = reinterpret_cast<PFN_vkImportFenceSciSyncFenceNV>(GetDeviceProcAddr(device, "vkImportFenceSciSyncFenceNV"));
                ImportFenceSciSyncObjNV = reinterpret_cast<PFN_vkImportFenceSciSyncObjNV>(GetDeviceProcAddr(device, "vkImportFenceSciSyncObjNV"));
...
void ResetAllExtensions() {
    ...
    CmdRefreshObjectsKHR = nullptr;
    GetPhysicalDeviceRefreshableObjectTypesKHR = nullptr;
...
#ifdef VK_USE_PLATFORM_SCI
    GetFenceSciSyncFenceNV = nullptr;
    GetFenceSciSyncObjNV = nullptr;
    ImportFenceSciSyncFenceNV = nullptr;
    ImportFenceSciSyncObjNV = nullptr;
    GetPhysicalDeviceSciSyncAttributesNV = nullptr;
    GetSemaphoreSciSyncObjNV = nullptr;
    ImportSemaphoreSciSyncObjNV = nullptr;
    GetMemorySciBufNV = nullptr;
    GetPhysicalDeviceExternalMemorySciBufPropertiesNV = nullptr;
    GetPhysicalDeviceSciBufAttributesNV = nullptr;
#endif  // VK_USE_PLATFORM_SCI
...
#ifdef VK_USE_PLATFORM_SCI
    CreateSemaphoreSciSyncPoolNV = nullptr;
    DestroySemaphoreSciSyncPoolNV = nullptr;
#endif  // VK_USE_PLATFORM_SCI
