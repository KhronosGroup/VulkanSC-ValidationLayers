...
void PreCallRecordGetFaultData(VkDevice device, VkFaultQueryBehavior faultQueryBehavior, VkBool32* pUnrecordedFaults,
                               uint32_t* pFaultCount, VkFaultData* pFaults) override;
...
void PreCallRecordGetFenceSciSyncFenceNV(VkDevice device, const VkFenceGetSciSyncInfoNV* pGetSciSyncHandleInfo,
...
#ifdef VK_USE_PLATFORM_SCI
void PreCallRecordGetFenceSciSyncObjNV(VkDevice device, const VkFenceGetSciSyncInfoNV* pGetSciSyncHandleInfo,
                                       void* pHandle) override;
...
#endif  // VK_USE_PLATFORM_SCI
#ifdef VK_USE_PLATFORM_SCI
void PreCallRecordGetSemaphoreSciSyncObjNV(VkDevice device, const VkSemaphoreGetSciSyncInfoNV* pGetSciSyncInfo,
                                           void* pHandle) override;
...
#endif  // VK_USE_PLATFORM_SCI
#ifdef VK_USE_PLATFORM_SCI
void PreCallRecordImportSemaphoreSciSyncObjNV(VkDevice device,
