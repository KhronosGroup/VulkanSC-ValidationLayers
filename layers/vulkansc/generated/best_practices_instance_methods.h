...
void PostCallRecordGetPhysicalDeviceQueueFamilyDataGraphEngineOperationPropertiesARM(
...
void PostCallRecordEnumeratePhysicalDeviceShaderInstrumentationMetricsARM(
