...
static VKAPI_ATTR VkResult VKAPI_CALL StubGetPhysicalDeviceRefreshableObjectTypesKHR(VkPhysicalDevice physicalDevice,
...
static VKAPI_ATTR VkResult VKAPI_CALL StubGetFenceSciSyncFenceNV(VkDevice device,
...
#ifdef VK_USE_PLATFORM_SCI
static VKAPI_ATTR VkResult VKAPI_CALL StubCreateSemaphoreSciSyncPoolNV(VkDevice device,
...
const vvl::unordered_map<std::string, small_vector<std::string, 2, size_t>> api_extension_map{
    ...
    {"vkGetFenceSciSyncFenceNV", {"VK_NV_external_sci_sync", "VK_NV_external_sci_sync2"}},
    {"vkGetFenceSciSyncObjNV", {"VK_NV_external_sci_sync", "VK_NV_external_sci_sync2"}},
    {"vkImportFenceSciSyncFenceNV", {"VK_NV_external_sci_sync", "VK_NV_external_sci_sync2"}},
