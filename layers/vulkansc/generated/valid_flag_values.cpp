...
vvl::Extensions stateless::Context::IsValidFlagValue(vvl::FlagBitmask flag_bitmask, VkFlags value, bool instance_function) const {
    switch (flag_bitmask) {
        ...
        case vvl::FlagBitmask::VkExternalMemoryHandleTypeFlagBits:
            ...
            if (value & (VK_EXTERNAL_MEMORY_HANDLE_TYPE_SCI_BUF_BIT_NV)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_external_memory_sci_buf)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_external_memory_sci_buf))) {
                    return {vvl::Extension::_VK_NV_external_memory_sci_buf};
                }
            }
        ...
        case vvl::FlagBitmask::VkExternalFenceHandleTypeFlagBits:
            if (value & (VK_EXTERNAL_FENCE_HANDLE_TYPE_SCI_SYNC_OBJ_BIT_NV | VK_EXTERNAL_FENCE_HANDLE_TYPE_SCI_SYNC_FENCE_BIT_NV)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_external_sci_sync) &&
                     !IsExtSupported(extensions.vk_nv_external_sci_sync2)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_external_sci_sync) &&
                     !IsExtEnabled(extensions.vk_nv_external_sci_sync2))) {
                    return {vvl::Extension::_VK_NV_external_sci_sync, vvl::Extension::_VK_NV_external_sci_sync2};
                }
            }
            return {};
        case vvl::FlagBitmask::VkExternalSemaphoreHandleTypeFlagBits:
            ...
            if (value & (VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_SCI_SYNC_OBJ_BIT_NV)) {
                if ((instance_function && !IsExtSupported(extensions.vk_nv_external_sci_sync)) ||
                    (!instance_function && !IsExtEnabled(extensions.vk_nv_external_sci_sync))) {
                    return {vvl::Extension::_VK_NV_external_sci_sync};
                }
            }
            return {};
