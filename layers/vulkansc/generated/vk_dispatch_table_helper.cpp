...
static VKAPI_ATTR void VKAPI_CALL StubCmdRefreshObjectsKHR(VkCommandBuffer, const VkRefreshObjectListKHR*) {}
static VKAPI_ATTR VkResult VKAPI_CALL StubGetPhysicalDeviceRefreshableObjectTypesKHR(VkPhysicalDevice, uint32_t*, VkObjectType*) {
    return VK_SUCCESS;
}
...
static VKAPI_ATTR VkResult VKAPI_CALL StubGetFenceSciSyncFenceNV(VkDevice, const VkFenceGetSciSyncInfoNV*, void*) {
    return VK_SUCCESS;
}
static VKAPI_ATTR VkResult VKAPI_CALL StubGetFenceSciSyncObjNV(VkDevice, const VkFenceGetSciSyncInfoNV*, void*) {
    return VK_SUCCESS;
}
static VKAPI_ATTR VkResult VKAPI_CALL StubImportFenceSciSyncFenceNV(VkDevice, const VkImportFenceSciSyncInfoNV*) {
    return VK_SUCCESS;
}
static VKAPI_ATTR VkResult VKAPI_CALL StubImportFenceSciSyncObjNV(VkDevice, const VkImportFenceSciSyncInfoNV*) {
    return VK_SUCCESS;
}
static VKAPI_ATTR VkResult VKAPI_CALL StubGetPhysicalDeviceSciSyncAttributesNV(VkPhysicalDevice, const VkSciSyncAttributesInfoNV*,
                                                                               NvSciSyncAttrList) {
    return VK_SUCCESS;
}
static VKAPI_ATTR VkResult VKAPI_CALL StubGetSemaphoreSciSyncObjNV(VkDevice, const VkSemaphoreGetSciSyncInfoNV*, void*) {
    return VK_SUCCESS;
}
static VKAPI_ATTR VkResult VKAPI_CALL StubImportSemaphoreSciSyncObjNV(VkDevice, const VkImportSemaphoreSciSyncInfoNV*) {
    return VK_SUCCESS;
}
static VKAPI_ATTR VkResult VKAPI_CALL StubGetMemorySciBufNV(VkDevice, const VkMemoryGetSciBufInfoNV*, NvSciBufObj*) {
    return VK_SUCCESS;
}
static VKAPI_ATTR VkResult VKAPI_CALL StubGetPhysicalDeviceExternalMemorySciBufPropertiesNV(VkPhysicalDevice,
                                                                                            VkExternalMemoryHandleTypeFlagBits,
                                                                                            NvSciBufObj,
                                                                                            VkMemorySciBufPropertiesNV*) {
    return VK_SUCCESS;
}
static VKAPI_ATTR VkResult VKAPI_CALL StubGetPhysicalDeviceSciBufAttributesNV(VkPhysicalDevice, NvSciBufAttrList) {
    return VK_SUCCESS;
}
...
#ifdef VK_USE_PLATFORM_SCI
static VKAPI_ATTR VkResult VKAPI_CALL StubCreateSemaphoreSciSyncPoolNV(VkDevice, const VkSemaphoreSciSyncPoolCreateInfoNV*,
                                                                       const VkAllocationCallbacks*, VkSemaphoreSciSyncPoolNV*) {
    return VK_SUCCESS;
}
static VKAPI_ATTR void VKAPI_CALL StubDestroySemaphoreSciSyncPoolNV(VkDevice, VkSemaphoreSciSyncPoolNV,
                                                                    const VkAllocationCallbacks*) {}
#endif  // VK_USE_PLATFORM_SCI
...
const auto& GetApiExtensionMap() {
    static const vvl::unordered_map<std::string, small_vector<vvl::Extension, 2, size_t>> api_extension_map{
        ...
        {"vkCmdRefreshObjectsKHR", {vvl::Extension::_VK_KHR_object_refresh}},
        ...
        {"vkGetFenceSciSyncFenceNV", {vvl::Extension::_VK_NV_external_sci_sync, vvl::Extension::_VK_NV_external_sci_sync2}},
        {"vkGetFenceSciSyncObjNV", {vvl::Extension::_VK_NV_external_sci_sync, vvl::Extension::_VK_NV_external_sci_sync2}},
        {"vkImportFenceSciSyncFenceNV", {vvl::Extension::_VK_NV_external_sci_sync, vvl::Extension::_VK_NV_external_sci_sync2}},
        {"vkImportFenceSciSyncObjNV", {vvl::Extension::_VK_NV_external_sci_sync, vvl::Extension::_VK_NV_external_sci_sync2}},
        {"vkGetSemaphoreSciSyncObjNV", {vvl::Extension::_VK_NV_external_sci_sync}},
        {"vkImportSemaphoreSciSyncObjNV", {vvl::Extension::_VK_NV_external_sci_sync}},
        {"vkGetMemorySciBufNV", {vvl::Extension::_VK_NV_external_memory_sci_buf}},
        ...
        {"vkCreateSemaphoreSciSyncPoolNV", {vvl::Extension::_VK_NV_external_sci_sync2}},
        {"vkDestroySemaphoreSciSyncPoolNV", {vvl::Extension::_VK_NV_external_sci_sync2}},
...
void layer_init_device_dispatch_table(VkDevice device, VkLayerDispatchTable* table, PFN_vkGetDeviceProcAddr gpa) {
    ...
    if (table->CmdRefreshObjectsKHR == nullptr) {
        table->CmdRefreshObjectsKHR = (PFN_vkCmdRefreshObjectsKHR)StubCmdRefreshObjectsKHR;
    }
...
void layer_init_instance_dispatch_table(VkInstance instance, VkLayerInstanceDispatchTable* table, PFN_vkGetInstanceProcAddr gpa) {
    ...
    if (table->GetPhysicalDeviceRefreshableObjectTypesKHR == nullptr) {
        table->GetPhysicalDeviceRefreshableObjectTypesKHR =
            (PFN_vkGetPhysicalDeviceRefreshableObjectTypesKHR)StubGetPhysicalDeviceRefreshableObjectTypesKHR;
    }
    ...
    if (table->GetPhysicalDeviceSciSyncAttributesNV == nullptr) {
        table->GetPhysicalDeviceSciSyncAttributesNV =
    ...
    if (table->GetPhysicalDeviceSciBufAttributesNV == nullptr) {
        table->GetPhysicalDeviceSciBufAttributesNV =
            (PFN_vkGetPhysicalDeviceSciBufAttributesNV)StubGetPhysicalDeviceSciBufAttributesNV;
    }
#endif  // VK_USE_PLATFORM_SCI
#ifdef VK_USE_PLATFORM_SCREEN_QNX
