...
vvl::Extension GetExtension(std::string extension) {
    static const vvl::unordered_map<std::string, vvl::Extension> extension_map{
        ...
        {"VK_KHR_object_refresh", vvl::Extension::_VK_KHR_object_refresh},
        ...
        {"VK_NV_private_vendor_info", vvl::Extension::_VK_NV_private_vendor_info},
        ...
        {"VK_NV_external_sci_sync", vvl::Extension::_VK_NV_external_sci_sync},
        {"VK_NV_external_memory_sci_buf", vvl::Extension::_VK_NV_external_memory_sci_buf},
        ...
        {"VK_EXT_application_parameters", vvl::Extension::_VK_EXT_application_parameters},
        ...
        {"VK_NV_external_sci_sync2", vvl::Extension::_VK_NV_external_sci_sync2},
