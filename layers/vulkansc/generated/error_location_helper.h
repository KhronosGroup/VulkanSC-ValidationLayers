...
enum class Extension {
    ...
    _VK_ARM_data_graph,
    _VK_ARM_data_graph_instruction_set_tosa,
    _VK_ARM_data_graph_neural_accelerator_statistics,
    _VK_ARM_data_graph_optical_flow,
    _VK_ARM_format_pack,
    ...
    _VK_ARM_shader_instrumentation,
    _VK_ARM_tensor_controls,
    _VK_ARM_tensors,
    _VK_EXT_4444_formats,
    _VK_EXT_acquire_drm_display,
    _VK_EXT_acquire_xlib_display,
    _VK_EXT_application_parameters,
    ...
    _VK_EXT_multisampled_render_to_swapchain,
    ...
    _VK_EXT_primitive_restart_index,
    ...
    _VK_EXT_shader_ocp_microscaling_types,
    _VK_EXT_shader_replicated_composites,
    _VK_EXT_shader_split_barrier,
    ...
    _VK_KHR_device_address_commands,
    _VK_KHR_device_fault,
    ...
    _VK_KHR_map_memory2,
    _VK_KHR_multiview,
    _VK_KHR_object_refresh,
    _VK_KHR_opacity_micromap,
    ...
    _VK_KHR_video_encode_feedback2,
    ...
    _VK_NV_cooperative_matrix_decode_vector,
    ...
    _VK_NV_external_memory_sci_buf,
    _VK_NV_external_memory_win32,
    _VK_NV_external_sci_sync,
    _VK_NV_external_sci_sync2,
    ...
    _VK_QCOM_shader_multiple_wait_queues,
