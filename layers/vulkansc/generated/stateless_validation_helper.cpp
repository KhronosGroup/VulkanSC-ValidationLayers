...
bool StatelessValidation::ValidatePnextStructContents(const char *api_name, const ParameterName &parameter_name,
    ...
    switch(header->sType) {
        ...
        // No Validation code for VkPhysicalDeviceVulkanSC10Properties structure members  -- Covers VUID-VkPhysicalDeviceVulkanSC10Properties-sType-sType
        ...
        // No Validation code for VkCommandPoolMemoryReservationCreateInfo structure members  -- Covers VUID-VkCommandPoolMemoryReservationCreateInfo-sType-sType
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCREEN_BUFFER_FEATURES_QNX: { // Covers VUID-VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX-sType-sType
            if (is_const_param) {
                ...
                skip |= ValidateBool32("VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX", "screenBufferImport", structure->screenBufferImport);
            }
        } break;
#endif // VK_USE_PLATFORM_SCREEN_QNX
        default:
...
bool StatelessValidation::PreCallValidateCreateSamplerYcbcrConversion(
    ...
    if (pCreateInfo != nullptr)
    {
        ...
        skip |= ValidateStructPnext("vkCreateSamplerYcbcrConversion", "pCreateInfo->pNext", "VkExternalFormatQNX", pCreateInfo->pNext, allowed_structs_VkSamplerYcbcrConversionCreateInfo.size(), allowed_structs_VkSamplerYcbcrConversionCreateInfo.data(), GeneratedVulkanHeaderVersion, "VUID-VkSamplerYcbcrConversionCreateInfo-pNext-pNext", "VUID-VkSamplerYcbcrConversionCreateInfo-sType-unique", false, true);
...
bool StatelessValidation::PreCallValidateGetDeviceImageSparseMemoryRequirements(
    ...
    if (pInfo != nullptr)
    {
        ...
        if (pInfo->pCreateInfo != nullptr)
        {
            ...
            skip |= ValidateStructPnext("vkGetDeviceImageSparseMemoryRequirements", "pInfo->pCreateInfo->pNext", "VkExternalFormatQNX, VkExternalMemoryImageCreateInfo, VkImageDrmFormatModifierExplicitCreateInfoEXT, VkImageDrmFormatModifierListCreateInfoEXT, VkImageFormatListCreateInfo, VkImageStencilUsageCreateInfo, VkImageSwapchainCreateInfoKHR", pInfo->pCreateInfo->pNext, allowed_structs_VkImageCreateInfo.size(), allowed_structs_VkImageCreateInfo.data(), GeneratedVulkanHeaderVersion, "VUID-VkImageCreateInfo-pNext-pNext", "VUID-VkImageCreateInfo-sType-unique", false, true);
    ...
    skip |= ValidateArray("vkGetDeviceImageSparseMemoryRequirements", "pSparseMemoryRequirementCount", "pSparseMemoryRequirements", pSparseMemoryRequirementCount, &pSparseMemoryRequirements, true, false, false, kVUIDUndefined, kVUIDUndefined);
    return skip;
}
...
bool StatelessValidation::PreCallValidateCmdWriteBufferMarker2AMD(
    ...
    skip |= ValidateFlags("vkCmdWriteBufferMarker2AMD", "stage", "VkPipelineStageFlagBits2", AllVkPipelineStageFlagBits2, stage, kOptionalFlags, kVUIDUndefined);
...
bool StatelessValidation::PreCallValidateGetQueueCheckpointData2NV(
    ...
    skip |= ValidateStructTypeArray("vkGetQueueCheckpointData2NV", "pCheckpointDataCount", "pCheckpointData", "VK_STRUCTURE_TYPE_CHECKPOINT_DATA_2_NV", pCheckpointDataCount, pCheckpointData, VK_STRUCTURE_TYPE_CHECKPOINT_DATA_2_NV, true, false, false, kVUIDUndefined, kVUIDUndefined, kVUIDUndefined);
    if (pCheckpointData != nullptr)
    {
        ...
        {
            skip |= ValidateStructPnext("vkGetQueueCheckpointData2NV", ParameterName("pCheckpointData[%i].pNext", ParameterName::IndexVector{ pCheckpointDataIndex }), nullptr, pCheckpointData[pCheckpointDataIndex].pNext, 0, nullptr, GeneratedVulkanHeaderVersion, kVUIDUndefined, kVUIDUndefined, false, false);
        }
    }
    return skip;
}
...
bool StatelessValidation::PreCallValidateCmdSetCullModeEXT(
    ...
    VkCullModeFlags                             cullMode) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetCullModeEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetFrontFaceEXT(
    ...
    VkFrontFace                                 frontFace) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetFrontFaceEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetPrimitiveTopologyEXT(
    ...
    VkPrimitiveTopology                         primitiveTopology) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetPrimitiveTopologyEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetViewportWithCountEXT(
    ...
    const VkViewport*                           pViewports) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetViewportWithCountEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetScissorWithCountEXT(
    ...
    const VkRect2D*                             pScissors) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetScissorWithCountEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdBindVertexBuffers2EXT(
    ...
    const VkDeviceSize*                         pStrides) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdBindVertexBuffers2EXT", "VK_EXT_extended_dynamic_state");
    // No xml-driven validation
...
bool StatelessValidation::PreCallValidateCmdSetDepthTestEnableEXT(
    ...
    VkBool32                                    depthTestEnable) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetDepthTestEnableEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetDepthWriteEnableEXT(
    ...
    VkBool32                                    depthWriteEnable) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetDepthWriteEnableEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetDepthCompareOpEXT(
    ...
    VkCompareOp                                 depthCompareOp) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetDepthCompareOpEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetDepthBoundsTestEnableEXT(
    ...
    VkBool32                                    depthBoundsTestEnable) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetDepthBoundsTestEnableEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetStencilTestEnableEXT(
    ...
    VkBool32                                    stencilTestEnable) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetStencilTestEnableEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetStencilOpEXT(
    ...
    VkCompareOp                                 compareOp) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state)) skip |= OutputExtensionError("vkCmdSetStencilOpEXT", "VK_EXT_extended_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetVertexInputEXT(
    ...
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_vertex_input_dynamic_state)) skip |= OutputExtensionError("vkCmdSetVertexInputEXT", "VK_EXT_vertex_input_dynamic_state");
...
bool StatelessValidation::PreCallValidateCmdSetPatchControlPointsEXT(
    ...
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state2)) skip |= OutputExtensionError("vkCmdSetPatchControlPointsEXT", "VK_EXT_extended_dynamic_state2");
    // No xml-driven validation
    return skip;
}
...
bool StatelessValidation::PreCallValidateCmdSetRasterizerDiscardEnableEXT(
    ...
    VkBool32                                    rasterizerDiscardEnable) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state2)) skip |= OutputExtensionError("vkCmdSetRasterizerDiscardEnableEXT", "VK_EXT_extended_dynamic_state2");
...
bool StatelessValidation::PreCallValidateCmdSetDepthBiasEnableEXT(
    ...
    VkBool32                                    depthBiasEnable) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state2)) skip |= OutputExtensionError("vkCmdSetDepthBiasEnableEXT", "VK_EXT_extended_dynamic_state2");
...
bool StatelessValidation::PreCallValidateCmdSetLogicOpEXT(
    ...
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state2)) skip |= OutputExtensionError("vkCmdSetLogicOpEXT", "VK_EXT_extended_dynamic_state2");
...
bool StatelessValidation::PreCallValidateCmdSetPrimitiveRestartEnableEXT(
    ...
    VkBool32                                    primitiveRestartEnable) const {
    bool skip = false;
    if (!IsExtEnabled(device_extensions.vk_ext_extended_dynamic_state2)) skip |= OutputExtensionError("vkCmdSetPrimitiveRestartEnableEXT", "VK_EXT_extended_dynamic_state2");
