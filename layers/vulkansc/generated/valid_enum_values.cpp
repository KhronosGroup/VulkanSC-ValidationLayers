...
ValidValue stateless::Context::IsValidEnumValue(VkObjectType value) const {
    switch (value) {
        ...
        case VK_OBJECT_TYPE_SEMAPHORE_SCI_SYNC_POOL_NV:
            return IsExtEnabled(extensions.vk_nv_external_sci_sync2) ? ValidValue::Valid : ValidValue::NoExtension;
...
template <>
ValidValue stateless::Context::IsValidEnumValue(VkFaultQueryBehavior value) const {
    switch (value) {
...
template <>
ValidValue stateless::Context::IsValidEnumValue(VkPipelineMatchControl value) const {
    switch (value) {
...
template <>
ValidValue stateless::Context::IsValidEnumValue(VkPipelineCacheValidationVersion value) const {
    switch (value) {
...
template <>
ValidValue stateless::Context::IsValidEnumValue(VkSciSyncClientTypeNV value) const {
    switch (value) {
...
#ifdef VK_USE_PLATFORM_SCI
template <>
ValidValue stateless::Context::IsValidEnumValue(VkSciSyncPrimitiveTypeNV value) const {
    switch (value) {
...
template <>
vvl::Extensions stateless::Context::GetEnumExtensions(VkFaultQueryBehavior value) const {
    return {};
}
template <>
const char* stateless::Context::DescribeEnum(VkFaultQueryBehavior value) const {
    return nullptr;
}

template <>
vvl::Extensions stateless::Context::GetEnumExtensions(VkPipelineMatchControl value) const {
    return {};
}
template <>
const char* stateless::Context::DescribeEnum(VkPipelineMatchControl value) const {
    return nullptr;
}

template <>
vvl::Extensions stateless::Context::GetEnumExtensions(VkPipelineCacheValidationVersion value) const {
    return {};
}
template <>
const char* stateless::Context::DescribeEnum(VkPipelineCacheValidationVersion value) const {
    return nullptr;
}
...
#ifdef VK_USE_PLATFORM_SCI
template <>
vvl::Extensions stateless::Context::GetEnumExtensions(VkSciSyncClientTypeNV value) const {
    return {};
}
template <>
const char* stateless::Context::DescribeEnum(VkSciSyncClientTypeNV value) const {
    return nullptr;
}
#endif  // VK_USE_PLATFORM_SCI
...
#ifdef VK_USE_PLATFORM_SCI
template <>
vvl::Extensions stateless::Context::GetEnumExtensions(VkSciSyncPrimitiveTypeNV value) const {
    return {};
}
template <>
const char* stateless::Context::DescribeEnum(VkSciSyncPrimitiveTypeNV value) const {
    return nullptr;
}
#endif  // VK_USE_PLATFORM_SCI
