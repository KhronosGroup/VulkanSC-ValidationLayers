...
const char* String(Func func) {
    ...
    {"vkCreateSemaphoreSciSyncPoolNV", 31},
    ...
    {"vkDestroySemaphoreSciSyncPoolNV", 32},
    ...
    {"vkGetFaultData", 15},
    {"vkGetFenceFdKHR", 16},
    {"vkGetFenceSciSyncFenceNV", 25},
    {"vkGetFenceSciSyncObjNV", 23},
    {"vkGetFenceStatus", 17},
    ...
    {"vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV", 52},
    ...
    {"vkGetPhysicalDeviceRefreshableObjectTypesKHR", 45},
    {"vkGetPhysicalDeviceSciBufAttributesNV", 38},
    {"vkGetPhysicalDeviceSciSyncAttributesNV", 39},
    ...
    {"vkImportFenceSciSyncFenceNV", 28},
    {"vkImportFenceSciSyncObjNV", 26},
    {"vkImportFenceWin32HandleKHR", 28},
    {"vkImportSemaphoreFdKHR", 23},
    {"vkImportSemaphoreSciSyncObjNV", 30},
...
const char* String(Struct structure) {
    ...
    {"VkCommandPoolMemoryConsumption", 31},
    {"VkCommandPoolMemoryReservationCreateInfo", 41},
    ...
    {"VkDeviceObjectReservationCreateInfo", 36},
    ...
    {"VkExportSemaphoreSciSyncInfoNV", 31},
    ...
    {"VkFaultCallbackInfo", 20},
    {"VkFaultData", 12},
    {"VkFenceCreateInfo", 18},
    {"VkFenceGetFdInfoKHR", 20},
    {"VkFenceGetSciSyncInfoNV", 24},
    ...
    {"VkImportSemaphoreSciSyncInfoNV", 31},
    ...
    {"VkPerformanceQueryReservationInfoKHR", 37},
    ...
    {"VkPhysicalDeviceExternalMemorySciBufFeaturesNV", 47},
    {"VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX", 54},
    {"VkPhysicalDeviceExternalSciSync2FeaturesNV", 43},
    {"VkPhysicalDeviceExternalSciSyncFeaturesNV", 42},
    ...
    {"VkPhysicalDeviceVulkanSC10Features", 35},
    {"VkPhysicalDeviceVulkanSC10Properties", 37},
    ...
    {"VkPipelineCacheHeaderVersionSafetyCriticalOne", 46},
    {"VkPipelineCacheSafetyCriticalIndexEntry", 40},
    {"VkPipelineCacheStageValidationIndexEntry", 41},
    ...
    {"VkPipelineOfflineCreateInfo", 28},
    {"VkPipelinePoolSize", 19},
    ...
    {"VkRefreshObjectKHR", 19},
    {"VkRefreshObjectListKHR", 23},
    ...
    {"VkSemaphoreGetSciSyncInfoNV", 28},
    {"VkSemaphoreGetWin32HandleInfoKHR", 33},
    {"VkSemaphoreGetZirconHandleInfoFUCHSIA", 38},
    {"VkSemaphoreSciSyncCreateInfoNV", 31},
    {"VkSemaphoreSciSyncPoolCreateInfoNV", 35},
...
const char* String(Field field) {
    ...
    {"attachment", 11},
    {"attachmentCount", 16},
    {"attachmentDescriptionRequestCount", 34},
    ...
    {"bufferOffset", 13},
    {"bufferRequestCount", 19},
    {"bufferRowLength", 16},
    {"bufferView", 11},
    {"bufferViewRequestCount", 23},
    ...
    {"combinerOps", 12},
    {"commandBuffer", 14},
    {"commandBufferAllocated", 23},
    {"commandBufferCount", 19},
    {"commandBufferInfoCount", 23},
    {"commandBufferInheritance", 25},
    {"commandBufferRequestCount", 26},
    {"commandBufferSimultaneousUse", 29},
    {"commandCount", 13},
    {"commandPool", 12},
    {"commandPoolAllocated", 21},
    {"commandPoolMaxCommandBuffers", 29},
    {"commandPoolMultipleCommandBuffersRecording", 43},
    {"commandPoolRequestCount", 24},
    {"commandPoolReservedSize", 24},
    {"commandPoolResetCommandBuffer", 30},
    {"compactedSize", 14},
    {"compareEnable", 14},
    {"compareMask", 12},
    {"compareOp", 10},
    ...
    {"computePipelineRequestCount", 28},
    ...
    {"descriptorPoolRequestCount", 27},
    {"descriptorSet", 14},
    {"descriptorSetCount", 19},
    {"descriptorSetHostMapping", 25},
    {"descriptorSetLayout", 20},
    {"descriptorSetLayoutBindingLimit", 32},
    {"descriptorSetLayoutBindingRequestCount", 39},
    {"descriptorSetLayoutRequestCount", 32},
    {"descriptorSetRequestCount", 26},
    {"descriptorSize", 15},
    {"descriptorType", 15},
    ...
    {"deviceMemoryRequestCount", 25},
    {"deviceName", 11},
    {"deviceNoDynamicHostAllocations", 31},
    {"deviceNodeMask", 15},
    {"deviceRelativeId", 17},
    ...
    {"graphicsPipelineRequestCount", 29},
    {"gridDimX", 9},
    {"gridDimY", 9},
    {"gridDimZ", 9},
    {"group", 6},
    ...
    {"imageViewRequestCount", 22},
    {"imageViewType", 14},
    {"imagelessFramebuffer", 21},
    {"images", 7},
    {"implementationData", 19},
    ...
    {"layeredAPI", 11},
    {"layeredApiCount", 16},
    {"layeredImageViewRequestCount", 29},
    ...
    {"maxCommandBufferSize", 21},
    {"maxCommandPoolCommandBuffers", 29},
    ...
    {"maxDescriptorSetLayoutBindings", 31},
    ...
    {"maxImageExtent", 15},
    {"maxImageViewArrayLayers", 24},
    {"maxImageViewMipLevels", 22},
    {"maxImmutableSamplersPerDescriptorSetLayout", 43},
    ...
    {"maxLayeredImageViewMipLevels", 29},
    {"maxLevel", 9},
    {"maxLevelIdc", 12},
    {"maxLod", 7},
    {"maxLuminance", 13},
    ...
    {"maxRenderPassDependencies", 26},
    {"maxRenderPassStripes", 21},
    {"maxRenderPassSubpasses", 23},
    ...
    {"maxSubLayerCount", 17},
    {"maxSubgroupSize", 16},
    {"maxSubpassInputAttachments", 27},
    {"maxSubpassPreserveAttachments", 30},
    ...
    {"pImportFenceSciSyncInfo", 24},
    {"pImportFenceWin32HandleInfo", 28},
    {"pImportSemaphoreFdInfo", 23},
    {"pImportSemaphoreSciSyncInfo", 28},
    ...
    {"pReferenceSlots", 16},
    {"pRefreshObjects", 16},
    {"pRefreshableObjectTypeCount", 28},
    {"pRefreshableObjectTypes", 24},
    {"pRegions", 9},
    {"pReleaseInfo", 13},
    {"pReleaseKeys", 13},
    {"pReleaseSyncs", 14},
    ...
    {"pipelineCache", 14},
    {"pipelineCacheCreateInfoCount", 29},
    {"pipelineCacheRequestCount", 26},
    ...
    {"pipelineIndexCount", 19},
    {"pipelineIndexOffset", 20},
    {"pipelineIndexStride", 20},
    {"pipelineLayout", 15},
    {"pipelineLayoutRequestCount", 27},
    {"pipelineLibraryGroupHandles", 28},
    {"pipelineMemorySize", 19},
    {"pipelineOpacityMicromap", 24},
    {"pipelinePoolSizeCount", 22},
    ...
    {"rectangleCount", 15},
    {"rectangularLines", 17},
    {"recycleDescriptorSetMemory", 27},
    {"recyclePipelineMemory", 22},
    {"reductionMode", 14},
    {"reference", 10},
    ...
    {"screenUsage", 12},
    {"secondaryCommandBufferNullOrImagelessFramebuffer", 49},
    {"selectableCubicWeights", 23},
    {"semaphore", 10},
    {"semaphoreCount", 15},
    {"semaphorePool", 14},
    {"semaphoreRequestCount", 22},
    {"semaphoreSciSyncPoolRequestCount", 33},
    {"semaphoreType", 14},
    ...
    {"subpass", 8},
    {"subpassCount", 13},
    {"subpassDescriptionRequestCount", 31},
    {"subpassIndex", 13},
    ...
    {"surfaceCounters", 16},
    {"surfaceFormat", 14},
    {"surfaceRequestCount", 20},
    {"swapBufferTimestamp", 20},
    {"swapChain", 10},
    {"swapchain", 10},
    {"swapchainCount", 15},
    {"swapchainMaintenance1", 22},
    {"swapchainRequestCount", 22},
    {"sx", 3},
    {"sy", 3},
    {"synchronization2", 17},
...
const char* String(Enum value) {
    ...
    {"VkPipelineCacheValidationVersion", 33},
    {"VkPipelineExecutableStatisticFormatKHR", 39},
    {"VkPipelineMatchControl", 23},
    ...
    {"VkSciSyncClientTypeNV", 22},
    {"VkSciSyncPrimitiveTypeNV", 25},
    {"VkScopeKHR", 11},
    {"VkSemaphoreType", 16},
...
const char* String(Extension extension) {
    ...
    {"VK_EXT_application_parameters", 30},
    ...
    {"VK_NV_external_memory_sci_buf", 30},
    {"VK_NV_external_memory_win32", 28},
    {"VK_NV_external_sci_sync", 24},
    {"VK_NV_external_sci_sync2", 25},
...
bool IsFieldPointer(Field field) {
    ...
    case Field::pGetSciBufInfo:
    case Field::pGetSciSyncHandleInfo:
    case Field::pGetSciSyncInfo:
    ...
    case Field::pImportFenceSciSyncInfo:
    case Field::pImportFenceWin32HandleInfo:
    case Field::pImportSemaphoreFdInfo:
    case Field::pImportSemaphoreSciSyncInfo:
    ...
    case Field::pMemorySciBufProperties:
    ...
    case Field::pPipelineCacheCreateInfos:
    ...
    case Field::pRefreshObjects:
    case Field::pRefreshableObjectTypeCount:
    case Field::pRefreshableObjectTypes:
    case Field::pRegions:
    ...
    case Field::pSampler:
    case Field::pSciSyncAttributesInfo:
    case Field::pScissors:
    case Field::pSemaphore:
    case Field::pSemaphorePool:
...
Struct StypeToStruct(VkStructureType stype) {
    ...
    case VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_RESERVATION_INFO_KHR:
       return Struct::VkPerformanceQueryReservationInfoKHR;
    ...
    case VK_STRUCTURE_TYPE_REFRESH_OBJECT_LIST_KHR:
       return Struct::VkRefreshObjectListKHR;
    ...
    case VK_STRUCTURE_TYPE_APPLICATION_PARAMETERS_EXT:
       return Struct::VkApplicationParametersEXT;
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_2_FEATURES_NV:
       return Struct::VkPhysicalDeviceExternalSciSync2FeaturesNV;
    case VK_STRUCTURE_TYPE_SEMAPHORE_SCI_SYNC_POOL_CREATE_INFO_NV:
       return Struct::VkSemaphoreSciSyncPoolCreateInfoNV;
    case VK_STRUCTURE_TYPE_SEMAPHORE_SCI_SYNC_CREATE_INFO_NV:
       return Struct::VkSemaphoreSciSyncCreateInfoNV;
    case VK_STRUCTURE_TYPE_DEVICE_SEMAPHORE_SCI_SYNC_POOL_RESERVATION_CREATE_INFO_NV:
       return Struct::VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV;
