...
enum SyncStageAccessIndex {
    ...
    SYNC_COPY_TRANSFER_READ = 73,
    SYNC_COPY_TRANSFER_WRITE = 74,
    SYNC_RESOLVE_TRANSFER_READ = 75,
    SYNC_RESOLVE_TRANSFER_WRITE = 76,
    SYNC_BLIT_TRANSFER_READ = 77,
    SYNC_BLIT_TRANSFER_WRITE = 78,
    SYNC_CLEAR_TRANSFER_WRITE = 79,
    SYNC_INDEX_INPUT_INDEX_READ = 80,
    SYNC_VERTEX_ATTRIBUTE_INPUT_VERTEX_ATTRIBUTE_READ = 81,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_ACQUIRE_READ_SYNCVAL = 82,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_PRESENTED_SYNCVAL = 83,
    SYNC_IMAGE_LAYOUT_TRANSITION = 84,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 85,
};
