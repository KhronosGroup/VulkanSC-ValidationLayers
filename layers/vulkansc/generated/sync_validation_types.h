...
static const VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_PRESENT_ENGINE_BIT_SYNCVAL = 0x0000008000000000ULL;
static const VkAccessFlagBits2 VK_ACCESS_2_PRESENT_ACQUIRE_READ_BIT_SYNCVAL = 0x0000000800000000ULL;
static const VkAccessFlagBits2 VK_ACCESS_2_PRESENT_PRESENTED_BIT_SYNCVAL = 0x0000001000000000ULL;
...
enum SyncStageAccessIndex {
    ...
    SYNC_VERTEX_SHADER_SHADER_SAMPLED_READ = 4,
    SYNC_VERTEX_SHADER_SHADER_STORAGE_READ = 5,
    SYNC_VERTEX_SHADER_SHADER_STORAGE_WRITE = 6,
    SYNC_VERTEX_SHADER_UNIFORM_READ = 7,
    SYNC_TESSELLATION_CONTROL_SHADER_ACCELERATION_STRUCTURE_READ = 8,
    ...
    SYNC_TESSELLATION_EVALUATION_SHADER_ACCELERATION_STRUCTURE_READ = 13,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_SAMPLED_READ = 14,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_STORAGE_READ = 15,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_STORAGE_WRITE = 16,
    SYNC_TESSELLATION_EVALUATION_SHADER_UNIFORM_READ = 17,
    SYNC_GEOMETRY_SHADER_ACCELERATION_STRUCTURE_READ = 18,
    SYNC_GEOMETRY_SHADER_SHADER_SAMPLED_READ = 19,
    SYNC_GEOMETRY_SHADER_SHADER_STORAGE_READ = 20,
    SYNC_GEOMETRY_SHADER_SHADER_STORAGE_WRITE = 21,
    SYNC_GEOMETRY_SHADER_UNIFORM_READ = 22,
    SYNC_FRAGMENT_SHADER_ACCELERATION_STRUCTURE_READ = 23,
    SYNC_FRAGMENT_SHADER_COLOR_ATTACHMENT_READ = 24,
    SYNC_FRAGMENT_SHADER_DEPTH_STENCIL_ATTACHMENT_READ = 25,
    SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ = 26,
    SYNC_FRAGMENT_SHADER_SHADER_SAMPLED_READ = 27,
    SYNC_FRAGMENT_SHADER_SHADER_STORAGE_READ = 28,
    SYNC_FRAGMENT_SHADER_SHADER_STORAGE_WRITE = 29,
    SYNC_FRAGMENT_SHADER_UNIFORM_READ = 30,
    SYNC_EARLY_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 31,
    SYNC_EARLY_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 32,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 33,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 34,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ = 35,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ_NONCOHERENT_EXT = 36,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_WRITE = 37,
    SYNC_COMPUTE_SHADER_ACCELERATION_STRUCTURE_READ = 38,
    SYNC_COMPUTE_SHADER_SHADER_SAMPLED_READ = 39,
    SYNC_COMPUTE_SHADER_SHADER_STORAGE_READ = 40,
    SYNC_COMPUTE_SHADER_SHADER_STORAGE_WRITE = 41,
    SYNC_COMPUTE_SHADER_UNIFORM_READ = 42,
    SYNC_HOST_HOST_READ = 43,
    SYNC_HOST_HOST_WRITE = 44,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_READ_NV = 45,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_WRITE_NV = 46,
    SYNC_CONDITIONAL_RENDERING_EXT_CONDITIONAL_RENDERING_READ_EXT = 47,
    SYNC_TASK_SHADER_EXT_ACCELERATION_STRUCTURE_READ = 48,
    SYNC_TASK_SHADER_EXT_SHADER_SAMPLED_READ = 49,
    SYNC_TASK_SHADER_EXT_SHADER_STORAGE_READ = 50,
    SYNC_TASK_SHADER_EXT_SHADER_STORAGE_WRITE = 51,
    SYNC_TASK_SHADER_EXT_UNIFORM_READ = 52,
    SYNC_MESH_SHADER_EXT_ACCELERATION_STRUCTURE_READ = 53,
    SYNC_MESH_SHADER_EXT_SHADER_SAMPLED_READ = 54,
    SYNC_MESH_SHADER_EXT_SHADER_STORAGE_READ = 55,
    SYNC_MESH_SHADER_EXT_SHADER_STORAGE_WRITE = 56,
    SYNC_MESH_SHADER_EXT_UNIFORM_READ = 57,
    SYNC_RAY_TRACING_SHADER_ACCELERATION_STRUCTURE_READ = 58,
    SYNC_RAY_TRACING_SHADER_SHADER_SAMPLED_READ = 59,
    SYNC_RAY_TRACING_SHADER_SHADER_STORAGE_READ = 60,
    SYNC_RAY_TRACING_SHADER_SHADER_STORAGE_WRITE = 61,
    SYNC_RAY_TRACING_SHADER_UNIFORM_READ = 62,
    SYNC_FRAGMENT_SHADING_RATE_ATTACHMENT_FRAGMENT_SHADING_RATE_ATTACHMENT_READ = 63,
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_FRAGMENT_DENSITY_MAP_READ_EXT = 64,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_READ_EXT = 65,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT = 66,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_WRITE_EXT = 67,
    SYNC_ACCELERATION_STRUCTURE_BUILD_ACCELERATION_STRUCTURE_READ = 68,
    SYNC_ACCELERATION_STRUCTURE_BUILD_ACCELERATION_STRUCTURE_WRITE = 69,
    SYNC_ACCELERATION_STRUCTURE_BUILD_INDIRECT_COMMAND_READ = 70,
    SYNC_ACCELERATION_STRUCTURE_BUILD_SHADER_STORAGE_READ = 71,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_READ = 72,
    SYNC_ACCELERATION_STRUCTURE_BUILD_TRANSFER_WRITE = 73,
    SYNC_COPY_TRANSFER_READ = 74,
    SYNC_COPY_TRANSFER_WRITE = 75,
    SYNC_RESOLVE_TRANSFER_READ = 76,
    SYNC_RESOLVE_TRANSFER_WRITE = 77,
    SYNC_BLIT_TRANSFER_READ = 78,
    SYNC_BLIT_TRANSFER_WRITE = 79,
    SYNC_CLEAR_TRANSFER_WRITE = 80,
    SYNC_INDEX_INPUT_INDEX_READ = 81,
    SYNC_VERTEX_ATTRIBUTE_INPUT_VERTEX_ATTRIBUTE_READ = 82,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_ACQUIRE_READ_SYNCVAL = 83,
    SYNC_PRESENT_ENGINE_SYNCVAL_PRESENT_PRESENTED_SYNCVAL = 84,
    SYNC_IMAGE_LAYOUT_TRANSITION = 85,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 86,
};
