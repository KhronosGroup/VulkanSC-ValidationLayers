    ...
    for (const VkBaseInStructure *current = static_cast<const VkBaseInStructure *>(create_info.pNext); current != nullptr;
        ...
        switch (current->sType) {
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCI_BUF_FEATURES_NV: {
                ...
                if (enabling->sciBufExport && !supported.sciBufExport) {
                    ss << "VkPhysicalDeviceExternalMemorySciBufFeaturesNV::sciBufExport is not supported\n";
                }
                break;
            }
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_2_FEATURES_NV: {
                ...
                if (enabling->sciSyncSemaphore2 && !supported.sciSyncSemaphore2) {
                    ss << "VkPhysicalDeviceExternalSciSync2FeaturesNV::sciSyncSemaphore2 is not supported\n";
                }
                if (enabling->sciSyncImport && !supported.sciSyncImport) {
                    ss << "VkPhysicalDeviceExternalSciSync2FeaturesNV::sciSyncImport is not supported\n";
                }
                if (enabling->sciSyncExport && !supported.sciSyncExport) {
                    ss << "VkPhysicalDeviceExternalSciSync2FeaturesNV::sciSyncExport is not supported\n";
                }
                break;
            }
#endif  // VK_USE_PLATFORM_SCI
            ...
            case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_FEATURES_NV: {
                ...
                if (enabling->sciSyncSemaphore && !supported.sciSyncSemaphore) {
                    ss << "VkPhysicalDeviceExternalSciSyncFeaturesNV::sciSyncSemaphore is not supported\n";
                }
                if (enabling->sciSyncImport && !supported.sciSyncImport) {
                    ss << "VkPhysicalDeviceExternalSciSyncFeaturesNV::sciSyncImport is not supported\n";
                }
                if (enabling->sciSyncExport && !supported.sciSyncExport) {
                    ss << "VkPhysicalDeviceExternalSciSyncFeaturesNV::sciSyncExport is not supported\n";
                }
                break;
            }
#endif  // VK_USE_PLATFORM_SCI
