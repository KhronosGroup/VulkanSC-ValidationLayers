        ...
        static const InfoMap info_map = {
            ...
            {vvl::Extension::_VK_KHR_video_encode_queue,
             Info(&DeviceExtensions::vk_khr_video_encode_queue,
                  {{{&DeviceExtensions::vk_khr_video_queue, VK_KHR_VIDEO_QUEUE_EXTENSION_NAME},
                    {&DeviceExtensions::vk_khr_synchronization2, VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME}}})},
            {vvl::Extension::_VK_KHR_object_refresh, Info(&DeviceExtensions::vk_khr_object_refresh, {})},
            ...
            {vvl::Extension::_VK_NV_corner_sampled_image,
             Info(&DeviceExtensions::vk_nv_corner_sampled_image, {{{&DeviceExtensions::vk_khr_get_physical_device_properties2,
                                                                    VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME}}})},
            {vvl::Extension::_VK_NV_private_vendor_info, Info(&DeviceExtensions::vk_nv_private_vendor_info, {})},
            ...
            {vvl::Extension::_VK_NV_external_sci_sync,
             Info(&DeviceExtensions::vk_nv_external_sci_sync, {{{&DeviceExtensions::vk_feature_version_1_1, "VK_VERSION_1_1"}}})},
            {vvl::Extension::_VK_NV_external_memory_sci_buf,
             Info(&DeviceExtensions::vk_nv_external_memory_sci_buf,
                  {{{&DeviceExtensions::vk_feature_version_1_1, "VK_VERSION_1_1"}}})},
            ...
            {vvl::Extension::_VK_QCOM_multiview_per_view_viewports,
             Info(&DeviceExtensions::vk_qcom_multiview_per_view_viewports,
                  {{{&DeviceExtensions::vk_khr_get_physical_device_properties2,
                     VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME}}})},
#ifdef VK_USE_PLATFORM_SCI
            {vvl::Extension::_VK_NV_external_sci_sync2,
             Info(&DeviceExtensions::vk_nv_external_sci_sync2, {{{&DeviceExtensions::vk_feature_version_1_1, "VK_VERSION_1_1"}}})},
#endif  // VK_USE_PLATFORM_SCI
...
constexpr bool IsDeviceExtension(vvl::Extension extension) {
    switch (extension) {
        ...
        case vvl::Extension::_VK_NV_private_vendor_info:
        ...
        case vvl::Extension::_VK_NV_external_sci_sync:
        case vvl::Extension::_VK_NV_external_memory_sci_buf:
        ...
        case vvl::Extension::_VK_NV_external_sci_sync2:
