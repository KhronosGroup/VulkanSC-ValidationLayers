...
struct InstanceExtensions {
    ...
    ExtEnabled vk_ext_application_parameters{kNotSupported};
...
struct DeviceExtensions : public InstanceExtensions {
    ...
    ExtEnabled vk_nv_private_vendor_info{kNotSupported};
    ...
    ExtEnabled vk_nv_external_sci_sync{kNotSupported};
    ExtEnabled vk_nv_external_memory_sci_buf{kNotSupported};
    ...
    ExtEnabled vk_nv_external_sci_sync2{kNotSupported};
