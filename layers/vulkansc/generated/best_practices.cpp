...
void BestPractices::PostCallRecordCreateDevice(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_OUT_OF_HOST_MEMORY,VK_ERROR_OUT_OF_DEVICE_MEMORY,VK_ERROR_INITIALIZATION_FAILED,VK_ERROR_EXTENSION_NOT_PRESENT,VK_ERROR_FEATURE_NOT_PRESENT,VK_ERROR_TOO_MANY_OBJECTS,VK_ERROR_DEVICE_LOST,VK_ERROR_INVALID_PIPELINE_CACHE_DATA};
...
void BestPractices::PostCallRecordCreatePipelineCache(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_OUT_OF_HOST_MEMORY,VK_ERROR_OUT_OF_DEVICE_MEMORY,VK_ERROR_INVALID_PIPELINE_CACHE_DATA};
...
void BestPractices::PostCallRecordCreateGraphicsPipelines(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_OUT_OF_HOST_MEMORY,VK_ERROR_OUT_OF_DEVICE_MEMORY,VK_ERROR_NO_PIPELINE_MATCH,VK_ERROR_OUT_OF_POOL_MEMORY};
...
void BestPractices::PostCallRecordGetPhysicalDeviceRefreshableObjectTypesKHR(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array success_codes = {VK_INCOMPLETE};
        ValidateReturnCodes("vkGetPhysicalDeviceRefreshableObjectTypesKHR", result, {}, success_codes);
    }
}
...
void BestPractices::PostCallRecordGetFenceSciSyncFenceNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INVALID_EXTERNAL_HANDLE,VK_ERROR_NOT_PERMITTED_EXT};
        ValidateReturnCodes("vkGetFenceSciSyncFenceNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordGetFenceSciSyncObjNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INVALID_EXTERNAL_HANDLE,VK_ERROR_NOT_PERMITTED_EXT};
        ValidateReturnCodes("vkGetFenceSciSyncObjNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordImportFenceSciSyncFenceNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INVALID_EXTERNAL_HANDLE,VK_ERROR_NOT_PERMITTED_EXT};
        ValidateReturnCodes("vkImportFenceSciSyncFenceNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordImportFenceSciSyncObjNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INVALID_EXTERNAL_HANDLE,VK_ERROR_NOT_PERMITTED_EXT};
        ValidateReturnCodes("vkImportFenceSciSyncObjNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordGetPhysicalDeviceSciSyncAttributesNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INITIALIZATION_FAILED};
        ValidateReturnCodes("vkGetPhysicalDeviceSciSyncAttributesNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordGetSemaphoreSciSyncObjNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INVALID_EXTERNAL_HANDLE,VK_ERROR_NOT_PERMITTED_EXT};
        ValidateReturnCodes("vkGetSemaphoreSciSyncObjNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordImportSemaphoreSciSyncObjNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INVALID_EXTERNAL_HANDLE,VK_ERROR_NOT_PERMITTED_EXT,VK_ERROR_OUT_OF_HOST_MEMORY};
        ValidateReturnCodes("vkImportSemaphoreSciSyncObjNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordGetMemorySciBufNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INITIALIZATION_FAILED};
        ValidateReturnCodes("vkGetMemorySciBufNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordGetPhysicalDeviceExternalMemorySciBufPropertiesNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INITIALIZATION_FAILED,VK_ERROR_INVALID_EXTERNAL_HANDLE};
        ValidateReturnCodes("vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordGetPhysicalDeviceSciBufAttributesNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_OUT_OF_HOST_MEMORY,VK_ERROR_INITIALIZATION_FAILED};
        ValidateReturnCodes("vkGetPhysicalDeviceSciBufAttributesNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordCreateSemaphoreSciSyncPoolNV(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_INITIALIZATION_FAILED,VK_ERROR_OUT_OF_HOST_MEMORY};
        ValidateReturnCodes("vkCreateSemaphoreSciSyncPoolNV", result, error_codes, {});
    }
}
...
void BestPractices::PostCallRecordCreateRayTracingPipelinesKHR(
    ...
    if (result != VK_SUCCESS) {
        constexpr std::array error_codes = {VK_ERROR_OUT_OF_HOST_MEMORY,VK_ERROR_OUT_OF_DEVICE_MEMORY,VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS,VK_ERROR_NO_PIPELINE_MATCH,VK_ERROR_OUT_OF_POOL_MEMORY};
