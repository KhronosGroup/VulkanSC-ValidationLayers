...
void BestPractices::PostCallRecordCreateDevice(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkCreateDevice", result); // VK_ERROR_OUT_OF_HOST_MEMORY, VK_ERROR_OUT_OF_DEVICE_MEMORY, VK_ERROR_INITIALIZATION_FAILED, VK_ERROR_EXTENSION_NOT_PRESENT, VK_ERROR_FEATURE_NOT_PRESENT, VK_ERROR_TOO_MANY_OBJECTS, VK_ERROR_DEVICE_LOST, VK_ERROR_INVALID_PIPELINE_CACHE_DATA
    }
}
...
void BestPractices::PostCallRecordCreatePipelineCache(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkCreatePipelineCache", result); // VK_ERROR_OUT_OF_HOST_MEMORY, VK_ERROR_OUT_OF_DEVICE_MEMORY, VK_ERROR_INVALID_PIPELINE_CACHE_DATA
    }
}
...
void BestPractices::PostCallRecordCreateGraphicsPipelines(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkCreateGraphicsPipelines", result); // VK_ERROR_OUT_OF_HOST_MEMORY, VK_ERROR_OUT_OF_DEVICE_MEMORY, VK_ERROR_NO_PIPELINE_MATCH, VK_ERROR_OUT_OF_POOL_MEMORY
    }
}
...
void BestPractices::PostCallRecordCreateComputePipelines(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkCreateComputePipelines", result); // VK_ERROR_OUT_OF_HOST_MEMORY, VK_ERROR_OUT_OF_DEVICE_MEMORY, VK_ERROR_NO_PIPELINE_MATCH, VK_ERROR_OUT_OF_POOL_MEMORY
    }
}
...
void BestPractices::PostCallRecordGetFaultData(
    ...
    if (result > VK_SUCCESS) {
        LogPositiveSuccessCode("vkGetFaultData", result); // VK_INCOMPLETE
        return;
    }
    if (result < VK_SUCCESS) {
        LogErrorCode("vkGetFaultData", result); // VK_ERROR_OUT_OF_HOST_MEMORY, VK_ERROR_OUT_OF_DEVICE_MEMORY
    }
}
...
void BestPractices::PostCallRecordGetPhysicalDeviceRefreshableObjectTypesKHR(
    ...
    if (result > VK_SUCCESS) {
        LogPositiveSuccessCode("vkGetPhysicalDeviceRefreshableObjectTypesKHR", result); // VK_INCOMPLETE
        return;
    }
}
...
void BestPractices::PostCallRecordCreateRayTracingPipelinesNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkCreateRayTracingPipelinesNV", result); // VK_ERROR_OUT_OF_HOST_MEMORY, VK_ERROR_OUT_OF_DEVICE_MEMORY, VK_ERROR_NO_PIPELINE_MATCH, VK_ERROR_OUT_OF_POOL_MEMORY
    }
}
...
void BestPractices::PostCallRecordGetFenceSciSyncFenceNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkGetFenceSciSyncFenceNV", result); // VK_ERROR_INVALID_EXTERNAL_HANDLE, VK_ERROR_NOT_PERMITTED_EXT
    }
}
...
void BestPractices::PostCallRecordGetFenceSciSyncObjNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkGetFenceSciSyncObjNV", result); // VK_ERROR_INVALID_EXTERNAL_HANDLE, VK_ERROR_NOT_PERMITTED_EXT
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordImportFenceSciSyncFenceNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkImportFenceSciSyncFenceNV", result); // VK_ERROR_INVALID_EXTERNAL_HANDLE, VK_ERROR_NOT_PERMITTED_EXT
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordImportFenceSciSyncObjNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkImportFenceSciSyncObjNV", result); // VK_ERROR_INVALID_EXTERNAL_HANDLE, VK_ERROR_NOT_PERMITTED_EXT
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordGetPhysicalDeviceSciSyncAttributesNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkGetPhysicalDeviceSciSyncAttributesNV", result); // VK_ERROR_INITIALIZATION_FAILED
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordGetSemaphoreSciSyncObjNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkGetSemaphoreSciSyncObjNV", result); // VK_ERROR_INVALID_EXTERNAL_HANDLE, VK_ERROR_NOT_PERMITTED_EXT
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordImportSemaphoreSciSyncObjNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkImportSemaphoreSciSyncObjNV", result); // VK_ERROR_INVALID_EXTERNAL_HANDLE, VK_ERROR_NOT_PERMITTED_EXT, VK_ERROR_OUT_OF_HOST_MEMORY
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordGetMemorySciBufNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkGetMemorySciBufNV", result); // VK_ERROR_INITIALIZATION_FAILED
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordGetPhysicalDeviceExternalMemorySciBufPropertiesNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV", result); // VK_ERROR_INITIALIZATION_FAILED, VK_ERROR_INVALID_EXTERNAL_HANDLE
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordGetPhysicalDeviceSciBufAttributesNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkGetPhysicalDeviceSciBufAttributesNV", result); // VK_ERROR_OUT_OF_HOST_MEMORY, VK_ERROR_INITIALIZATION_FAILED
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordCreateSemaphoreSciSyncPoolNV(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkCreateSemaphoreSciSyncPoolNV", result); // VK_ERROR_INITIALIZATION_FAILED, VK_ERROR_OUT_OF_HOST_MEMORY
    }
}
#endif // VK_USE_PLATFORM_SCI
...
void BestPractices::PostCallRecordCreateRayTracingPipelinesKHR(
    ...
    if (result < VK_SUCCESS) {
        LogErrorCode("vkCreateRayTracingPipelinesKHR", result); // VK_ERROR_OUT_OF_HOST_MEMORY, VK_ERROR_OUT_OF_DEVICE_MEMORY, VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS, VK_ERROR_NO_PIPELINE_MATCH, VK_ERROR_OUT_OF_POOL_MEMORY
    }
}
