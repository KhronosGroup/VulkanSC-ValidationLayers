...
void BestPractices::PostCallRecordGetFaultData(VkDevice device, VkFaultQueryBehavior faultQueryBehavior,
                                               ...
                                               const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordGetFaultData(device, faultQueryBehavior, pUnrecordedFaults, pFaultCount, pFaults,
                                                       record_obj);
...
void BestPractices::PostCallRecordGetPhysicalDeviceRefreshableObjectTypesKHR(VkPhysicalDevice physicalDevice,
                                                                             uint32_t* pRefreshableObjectTypeCount,
                                                                             VkObjectType* pRefreshableObjectTypes,
                                                                             const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordGetPhysicalDeviceRefreshableObjectTypesKHR(physicalDevice, pRefreshableObjectTypeCount,
...
void BestPractices::PostCallRecordGetFenceSciSyncFenceNV(VkDevice device, const VkFenceGetSciSyncInfoNV* pGetSciSyncHandleInfo,
    ...
    ValidationStateTracker::PostCallRecordGetFenceSciSyncFenceNV(device, pGetSciSyncHandleInfo, pHandle, record_obj);
...
void BestPractices::PostCallRecordGetFenceSciSyncObjNV(VkDevice device, const VkFenceGetSciSyncInfoNV* pGetSciSyncHandleInfo,
                                                       void* pHandle, const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordGetFenceSciSyncObjNV(device, pGetSciSyncHandleInfo, pHandle, record_obj);
...
void BestPractices::PostCallRecordImportFenceSciSyncFenceNV(VkDevice device,
                                                            ...
                                                            const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordImportFenceSciSyncFenceNV(device, pImportFenceSciSyncInfo, record_obj);
...
void BestPractices::PostCallRecordImportFenceSciSyncObjNV(VkDevice device,
                                                          const VkImportFenceSciSyncInfoNV* pImportFenceSciSyncInfo,
                                                          const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordImportFenceSciSyncObjNV(device, pImportFenceSciSyncInfo, record_obj);
...
void BestPractices::PostCallRecordGetPhysicalDeviceSciSyncAttributesNV(VkPhysicalDevice physicalDevice,
                                                                       const VkSciSyncAttributesInfoNV* pSciSyncAttributesInfo,
                                                                       NvSciSyncAttrList pAttributes,
                                                                       const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordGetPhysicalDeviceSciSyncAttributesNV(physicalDevice, pSciSyncAttributesInfo, pAttributes,
                                                                               record_obj);
...
void BestPractices::PostCallRecordGetSemaphoreSciSyncObjNV(VkDevice device, const VkSemaphoreGetSciSyncInfoNV* pGetSciSyncInfo,
                                                           void* pHandle, const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordGetSemaphoreSciSyncObjNV(device, pGetSciSyncInfo, pHandle, record_obj);
...
void BestPractices::PostCallRecordImportSemaphoreSciSyncObjNV(VkDevice device,
                                                              ...
                                                              const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordImportSemaphoreSciSyncObjNV(device, pImportSemaphoreSciSyncInfo, record_obj);
...
void BestPractices::PostCallRecordGetMemorySciBufNV(VkDevice device, const VkMemoryGetSciBufInfoNV* pGetSciBufInfo,
    ...
    ValidationStateTracker::PostCallRecordGetMemorySciBufNV(device, pGetSciBufInfo, pHandle, record_obj);
...
void BestPractices::PostCallRecordGetPhysicalDeviceExternalMemorySciBufPropertiesNV(
    ...
    ValidationStateTracker::PostCallRecordGetPhysicalDeviceExternalMemorySciBufPropertiesNV(physicalDevice, handleType, handle,
...
void BestPractices::PostCallRecordGetPhysicalDeviceSciBufAttributesNV(VkPhysicalDevice physicalDevice, NvSciBufAttrList pAttributes,
                                                                      const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordGetPhysicalDeviceSciBufAttributesNV(physicalDevice, pAttributes, record_obj);
...
#ifdef VK_USE_PLATFORM_SCI
void BestPractices::PostCallRecordCreateSemaphoreSciSyncPoolNV(VkDevice device,
                                                               const VkSemaphoreSciSyncPoolCreateInfoNV* pCreateInfo,
                                                               const VkAllocationCallbacks* pAllocator,
                                                               VkSemaphoreSciSyncPoolNV* pSemaphorePool,
                                                               const RecordObject& record_obj) {
    ValidationStateTracker::PostCallRecordCreateSemaphoreSciSyncPoolNV(device, pCreateInfo, pAllocator, pSemaphorePool, record_obj);
