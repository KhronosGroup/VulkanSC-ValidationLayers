        ...
        for edition in all_editions_list:
            ...
            for raw_term in raw_terms:
                ...
                def isDefined(feature, edition):
                    ...
                    elif isScVersion(feature): return True
...
def main(argv):
    ...
    if args.api == 'vulkansc':
        layer_source_files.extend(glob.glob(os.path.join(repo_relative('layers/vulkansc/core_checks/'), '*.cpp')))
        test_source_files = glob.glob(os.path.join(repo_relative('tests/vulkansc/converted'), '*.cpp'))
        test_source_files.extend(glob.glob(os.path.join(repo_relative('tests/vulkansc/negative'), '*.cpp')))
