...
class APISpecific:
    ...
    def getValidationLayerList(targetApiName: str) -> list[dict[str, str]]:
        match targetApiName:
            ...
            # Vulkan SC specific validation layer list
            case 'vulkansc':
                return [
                    {
                    ...
                    },
                    {
                        ...
                        'device': 'vvl::sc::DeviceState',
                        'instance': 'vvl::sc::InstanceState',
