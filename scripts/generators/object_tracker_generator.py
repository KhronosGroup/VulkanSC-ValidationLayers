...
class APISpecific:
    ...
    def getUndestroyedObjectVUID(targetApiName: str, scope: str) -> str:
        match targetApiName:
            ...
            # Vulkan SC specific undestroyed object VUIDs
            case 'vulkansc':
                per_scope = {
    ...
    def IsImplicitlyDestroyed(targetApiName: str, handleType: str) -> bool:
        match targetApiName:
            ...
            # Vulkan SC specific implicitly destroyed handle types
            case 'vulkansc':
    ...
    def AreAllocVUIDsEnabled(targetApiName: str) -> bool:
        match targetApiName:
            ...
            # Vulkan SC does not have allocation callback related VUIDs
            case 'vulkansc':
                return False
