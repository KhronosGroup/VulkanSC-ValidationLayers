...
class APISpecific:
    ...
    def genManualConstants(targetApiName: str) -> list[str]:
        match targetApiName:
            ...
            # Vulkan SC specific manual constant generation
            case 'vulkansc':
                return [
                    # These constants have to be included because the validation layers have hard-coded references
                    # to them, but they don't exist in Vulkan SC
                    ...
                    'const VkGraphicsPipelineLibraryFlagsEXT AllVkGraphicsPipelineLibraryFlagBitsEXT = 0;\n',
