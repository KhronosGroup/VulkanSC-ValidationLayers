...
def VerifyCommitMessageFormat(commit):
    ...
    if retval != 0:
        ...
        CPrint('HELP_MSG', "https://github.com/KhronosGroup/VulkanSC-ValidationLayers/blob/main/CONTRIBUTING.md#coding-conventions-and-formatting")
    return retval
...
def main():
    ...
    if args.fetch_main:
        ...
        subprocess.check_call(['git', 'fetch', 'https://github.com/KhronosGroup/VulkanSC-ValidationLayers.git', 'sc_main'])
